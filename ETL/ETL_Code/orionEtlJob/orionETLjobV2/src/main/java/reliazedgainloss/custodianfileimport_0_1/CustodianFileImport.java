...
package reliazedgainloss.custodianfileimport_0_1;
...
/**
 * Job: CustodianFileImport Purpose: Custodian File Import<br>
 * Description: Custodian File Import <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class CustodianFileImport implements TalendJob {
	...
	private final String jobName = "CustodianFileImport";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CustodianFileImport.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CustodianFileImport.this, new Object[] {
	...
	public static class outtobulkStruct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_CustodianFileImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_CustodianFileImport = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_CustodianFileImport.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_CustodianFileImport.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_CustodianFileImport = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_CustodianFileImport = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_CustodianFileImport,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_CustodianFileImport) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.io.File file_tMysqlOutputBulkExec_1_tMOB = new java.io.File(
						context.pathforlocal + "custodian_" + context.firmId
								+ "_" + context.date);
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = context.localpath
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.localpath + context.custodianpath,
								"US-ASCII", "\t", "\n", false, 1, 0, -1, -1,
								false);
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row1.Name = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row1.Code = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 4;

							row1.MasterAccountNumber = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.MasterAccountNumber = row1.MasterAccountNumber;
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								outtobulk_tmp.Code = row1.Code;
								outtobulk_tmp.MasterAccountNumber = row1.MasterAccountNumber;
							...
							if (outtobulk != null) {
								...
								if (outtobulk.Name != null) {
									...
									row_tMysqlOutputBulkExec_1_tMOB[2] = outtobulk.Name;

								}

								if (outtobulk.Code != null) {

									row_tMysqlOutputBulkExec_1_tMOB[3] = outtobulk.Code;

								}

								if (outtobulk.MasterAccountNumber != null) {

									row_tMysqlOutputBulkExec_1_tMOB[4] = outtobulk.MasterAccountNumber;
						...
						if (row2 != null) {
							...
							{ // start of Var scope
								...
								input_rejected_count_tmp.fileName = "CustodianFile  "
										+ (context.localpath + context.custodianpath);
								input_rejected_count_tmp.component = "tinputfileDelimted";
								input_rejected_count_tmp.process = "Custodian Local to Staging";
					...
					if (!((Object) (context.localpath + context.custodianpath) instanceof java.io.InputStream)) {
				...
				String tableName_tMysqlOutputBulkExec_1_tMBE = "custodian_"
				...
				while (rsTable_tMysqlOutputBulkExec_1_tMBE.next()) {
					...
					if (table_tMysqlOutputBulkExec_1_tMBE
							.equalsIgnoreCase("custodian_" + context.firmId
									+ "_" + context.date)) {
				...
				String file_tMysqlOutputBulkExec_1_tMBE = context.pathforlocal
						+ "custodian_" + context.firmId + "_" + context.date;
				...
				String bulkSQL_tMysqlOutputBulkExec_1_tMBE = "LOAD DATA LOCAL INFILE '"
						...
						+ lines_separator_tMysqlOutputBulkExec_1_tMBE
								.replaceAll("\\\\", "\\\\\\\\")
						+ "' (`OrionFirmId`,`ExternalId`,`Name`,`Code`,`MasterAccountNumber`)";
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				context.rowCountTSV = ((Integer) globalMap
						.get("tFileInputDelimited_2_NB_LINE"));
	...
	public static void main(String[] args) {
		final CustodianFileImport CustodianFileImportClass = new CustodianFileImport();

		int exitCode = CustodianFileImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CustodianFileImport.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/custodianfileimport_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : CustodianFileImport");
		}
...
/************************************************************************************************
 * 179128 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:33:56 PM IST
 ************************************************************************************************/
