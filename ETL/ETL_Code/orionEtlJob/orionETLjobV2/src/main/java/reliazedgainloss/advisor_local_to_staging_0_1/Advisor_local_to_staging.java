...
package reliazedgainloss.advisor_local_to_staging_0_1;
...
/**
 * Job: Advisor_local_to_staging Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class Advisor_local_to_staging implements TalendJob {
	...
	private final String jobName = "Advisor_local_to_staging";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Advisor_local_to_staging.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Advisor_local_to_staging.this,
	...
	public void tAmazonMysqlConnection_1_error(Exception exception,
		...
		tAmazonMysqlConnection_1_onSubJobError(exception, errorComponent,
				globalMap);
	}
	...
	public void tAmazonMysqlConnection_1_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tAmazonMysqlConnection_1Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		globalMap.put("tAmazonMysqlConnection_1_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				/**
				 * [tAmazonMysqlConnection_1 begin ] start
				 */

				ok_Hash.put("tAmazonMysqlConnection_1", false);
				start_Hash.put("tAmazonMysqlConnection_1",
						System.currentTimeMillis());

				currentComponent = "tAmazonMysqlConnection_1";

				int tos_count_tAmazonMysqlConnection_1 = 0;

				String proprtties_tAmazonMysqlConnection_1 = "noDatetimeStringSync=true";
				if (proprtties_tAmazonMysqlConnection_1 == null
						|| proprtties_tAmazonMysqlConnection_1.trim().length() == 0) {
					proprtties_tAmazonMysqlConnection_1 += "rewriteBatchedStatements=true";
				} else if (proprtties_tAmazonMysqlConnection_1 != null
						&& !proprtties_tAmazonMysqlConnection_1
								.contains("rewriteBatchedStatements")) {
					proprtties_tAmazonMysqlConnection_1 += "&rewriteBatchedStatements=true";
				}

				String url_tAmazonMysqlConnection_1 = "jdbc:mysql://"
						+ context.host + ":" + context.port + "/"
						+ context.stagingdb + "?"
						+ proprtties_tAmazonMysqlConnection_1;

				String dbUser_tAmazonMysqlConnection_1 = context.username;

				final String decryptedPassword_tAmazonMysqlConnection_1 = context.password;
				String dbPwd_tAmazonMysqlConnection_1 = decryptedPassword_tAmazonMysqlConnection_1;

				java.sql.Connection conn_tAmazonMysqlConnection_1 = null;

				String driverClass_tAmazonMysqlConnection_1 = "org.gjt.mm.mysql.Driver";
				java.lang.Class.forName(driverClass_tAmazonMysqlConnection_1);

				conn_tAmazonMysqlConnection_1 = java.sql.DriverManager
						.getConnection(url_tAmazonMysqlConnection_1,
								dbUser_tAmazonMysqlConnection_1,
								dbPwd_tAmazonMysqlConnection_1);

				globalMap.put("conn_tAmazonMysqlConnection_1",
						conn_tAmazonMysqlConnection_1);
				if (null != conn_tAmazonMysqlConnection_1) {

					conn_tAmazonMysqlConnection_1.setAutoCommit(false);
				}

				globalMap.put("conn_tAmazonMysqlConnection_1",
						conn_tAmazonMysqlConnection_1);

				globalMap.put("db_tAmazonMysqlConnection_1", context.stagingdb);

				/**
				 * [tAmazonMysqlConnection_1 begin ] stop
				 */

				/**
				 * [tAmazonMysqlConnection_1 main ] start
				 */

				currentComponent = "tAmazonMysqlConnection_1";

				tos_count_tAmazonMysqlConnection_1++;

				/**
				 * [tAmazonMysqlConnection_1 main ] stop
				 */

				/**
				 * [tAmazonMysqlConnection_1 end ] start
				 */

				currentComponent = "tAmazonMysqlConnection_1";

				ok_Hash.put("tAmazonMysqlConnection_1", true);
				end_Hash.put("tAmazonMysqlConnection_1",
						System.currentTimeMillis());

				/**
				 * [tAmazonMysqlConnection_1 end ] stop
				 */
			}// end the resume
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tAmazonMysqlConnection_1:OnSubjobOk",
			...
			try {
				...
				/**
				 * [tAmazonMysqlConnection_1 finally ] start
				 */

				currentComponent = "tAmazonMysqlConnection_1";

				/**
				 * [tAmazonMysqlConnection_1 finally ] stop
				 */
			} catch (java.lang.Exception e) {
				// ignore
			} catch (java.lang.Error error) {
		...
		globalMap.put("tAmazonMysqlConnection_1_SUBPROCESS_STATE", 1);
	}

	public static class bulkoutStruct implements
			routines.system.IPersistableRow<bulkoutStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_Advisor_local_to_staging = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_Advisor_local_to_staging = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_Advisor_local_to_staging.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_Advisor_local_to_staging.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_Advisor_local_to_staging = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_Advisor_local_to_staging = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_Advisor_local_to_staging,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_Advisor_local_to_staging) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.io.File file_tMysqlOutputBulkExec_1_tMOB = new java.io.File(
						context.pathforlocal + "advisor_" + context.firmId
								+ "_" + context.date);
				...
				String tableName_tAmazonMysqlOutput_3 = "logsreject";
				...
				if (dbProperties_tAmazonMysqlOutput_3 == null
					...
					url_tAmazonMysqlOutput_3 = "jdbc:mysql://" + context.host
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.localpath + context.filepath_advisor,
								"ISO-8859-15", "\t", "\n", true, 1, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.AdvisorNumber = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.BrokerDealer = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row3.AdvisorNumber = row1.AdvisorNumber;

							row3.BrokerDealer = row1.BrokerDealer;
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								bulkout_tmp.OrionFirmId = row1.OrionFirmId;
								bulkout_tmp.ExternalId = row1.ExternalId;
								bulkout_tmp.AdvisorNumber = row1.AdvisorNumber;
								bulkout_tmp.BrokerDealer = row1.BrokerDealer;
								bulkout_tmp.AdvisorName = row1.AdvisorName;
								bulkout = bulkout_tmp;
								// ###############################
							...
							if (bulkout != null) {
								...
								if (bulkout.AdvisorNumber != null) {

									row_tMysqlOutputBulkExec_1_tMOB[2] = bulkout.AdvisorNumber;

								}

								if (bulkout.BrokerDealer != null) {

									row_tMysqlOutputBulkExec_1_tMOB[3] = bulkout.BrokerDealer;

								}

								if (bulkout.AdvisorName != null) {

									row_tMysqlOutputBulkExec_1_tMOB[4] = bulkout.AdvisorName;
						...
						if (row3 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'out2'
								out2_tmp.errorCode = row3.errorCode;
								out2_tmp.errorMessage = row3.errorMessage;
								out2_tmp.firmName = Var.firmname;
								out2_tmp.fileName = "AdvisorFile  "
										+ (context.localpath + context.filepath_advisor);
								out2_tmp.component = "tinputfileDelimted";
								out2_tmp.process = "Advisor Local to Staging";
								out2 = out2_tmp;
								// ###############################
							...
							if (out2 != null) {
								...
								if (out2.errorCode == null) {
									pstmt_tAmazonMysqlOutput_3.setNull(1,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tAmazonMysqlOutput_3.setString(1,
											out2.errorCode);
								}

								if (out2.errorMessage == null) {
									pstmt_tAmazonMysqlOutput_3.setNull(2,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tAmazonMysqlOutput_3.setString(2,
											out2.errorMessage);
								}

								if (out2.firmName == null) {
								...
								if (out2.fileName == null) {
									pstmt_tAmazonMysqlOutput_3.setNull(4,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tAmazonMysqlOutput_3.setString(4,
											out2.fileName);
								}

								if (out2.component == null) {
					...
					if (!((Object) (context.localpath + context.filepath_advisor) instanceof java.io.InputStream)) {
				...
				String tableName_tMysqlOutputBulkExec_1_tMBE = "advisor_"
				...
				while (rsTable_tMysqlOutputBulkExec_1_tMBE.next()) {
					...
					if (table_tMysqlOutputBulkExec_1_tMBE
							.equalsIgnoreCase("advisor_" + context.firmId + "_"
									+ context.date)) {
				...
				String file_tMysqlOutputBulkExec_1_tMBE = context.pathforlocal
						+ "advisor_" + context.firmId + "_" + context.date;
				...
				String bulkSQL_tMysqlOutputBulkExec_1_tMBE = "LOAD DATA LOCAL INFILE '"
						...
						+ lines_separator_tMysqlOutputBulkExec_1_tMBE
								.replaceAll("\\\\", "\\\\\\\\")
						+ "' (`OrionFirmId`,`ExternalId`,`AdvisorNumber`,`BrokerDealer`,`AdvisorName`)";
	...
	public static void main(String[] args) {
		final Advisor_local_to_staging Advisor_local_to_stagingClass = new Advisor_local_to_staging();

		int exitCode = Advisor_local_to_stagingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Advisor_local_to_staging.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/advisor_local_to_staging_0_1/contexts/"
		...
		try {
			errorCode = null;
			tAmazonMysqlConnection_1Process(globalMap);
			if (!"failure".equals(status)) {
				status = "end";
			}
		} catch (TalendException e_tAmazonMysqlConnection_1) {
			globalMap.put("tAmazonMysqlConnection_1_SUBPROCESS_STATE", -1);

			e_tAmazonMysqlConnection_1.printStackTrace();
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Advisor_local_to_staging");
		}
	...
	private void closeSqlDbConnections() {
		try {
			Object obj_conn;
			obj_conn = globalMap.remove("conn_tAmazonMysqlConnection_1");
			if (null != obj_conn) {
	...
	private java.util.Map<String, Object> getSharedConnections4REST() {
		...
		connections.put("conn_tAmazonMysqlConnection_1",
				globalMap.get("conn_tAmazonMysqlConnection_1"));
...
/************************************************************************************************
 * 184747 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:33:55 PM IST
 ************************************************************************************************/
