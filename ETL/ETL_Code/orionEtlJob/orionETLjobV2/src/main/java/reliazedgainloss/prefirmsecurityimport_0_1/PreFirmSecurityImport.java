...
package reliazedgainloss.prefirmsecurityimport_0_1;
...
/**
 * Job: PreFirmSecurityImport Purpose: Pre Firm Security Import<br>
 * Description: Pre Firm Security Import <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class PreFirmSecurityImport implements TalendJob {
	...
	private final String jobName = "PreFirmSecurityImport";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					PreFirmSecurityImport.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(PreFirmSecurityImport.this, new Object[] {
	...
	public static class row_tAmazonAuroraOutput_4_inStruct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport) {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
					...
					{ // start of Var scope
						...
						logCatcherOutput_tmp.moment = row9.moment;
						logCatcherOutput_tmp.project = row9.project;
						logCatcherOutput_tmp.job = row9.job;
						logCatcherOutput_tmp.context = row9.context;
						logCatcherOutput_tmp.priority = row9.priority;
						logCatcherOutput_tmp.type = row9.type;
						logCatcherOutput_tmp.origin = row9.origin;
						logCatcherOutput_tmp.message = row9.message;
						logCatcherOutput_tmp.code = row9.code;
	...
	public void tJavaRow_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// source node:tJavaRow_3 - inputs:(after_tAmazonAuroraInput_2)
				// outputs:(row12,row12) | target node:tAdvancedHash_row12 -
				// inputs:(row12) outputs:()
				// linked node: tMap_8 - inputs:(s,row12)
				// outputs:(out1,mainout,main2,main3)
	...
	public static class firm_subClass_outputStruct implements
			routines.system.IPersistableRow<firm_subClass_outputStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final firm_subClass_outputStruct other = (firm_subClass_outputStruct) obj;
		...
		public void copyDataTo(firm_subClass_outputStruct other) {
		...
		public void copyKeysDataTo(firm_subClass_outputStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(firm_subClass_outputStruct other) {
	...
	public static class firm_asset_class_outputStruct implements
			routines.system.IPersistableRow<firm_asset_class_outputStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final firm_asset_class_outputStruct other = (firm_asset_class_outputStruct) obj;
		...
		public void copyDataTo(firm_asset_class_outputStruct other) {
		...
		public void copyKeysDataTo(firm_asset_class_outputStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(firm_asset_class_outputStruct other) {
	...
	public static class Firm_asset_category_outputStruct implements
			routines.system.IPersistableRow<Firm_asset_category_outputStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final Firm_asset_category_outputStruct other = (Firm_asset_category_outputStruct) obj;
		...
		public void copyDataTo(Firm_asset_category_outputStruct other) {
		...
		public void copyKeysDataTo(Firm_asset_category_outputStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(Firm_asset_category_outputStruct other) {
	...
	public static class main2Struct implements
			routines.system.IPersistableRow<main2Struct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
	...
	public static class main3Struct implements
			routines.system.IPersistableRow<main3Struct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_PreFirmSecurityImport = new byte[0];
	...
	public void tAmazonAuroraInput_2_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_2_inStruct row10 = row_tAmazonAuroraInput_2_in;
				sStruct s = new sStruct();
				out1Struct out1 = new out1Struct();
				mainoutStruct mainout = new mainoutStruct();
				Firm_asset_category_outputStruct Firm_asset_category_output = new Firm_asset_category_outputStruct();
				Firm_asset_category_outputStruct row_tAmazonAuroraOutput_1_in = Firm_asset_category_output;
				main2Struct main2 = new main2Struct();
				firm_asset_class_outputStruct firm_asset_class_output = new firm_asset_class_outputStruct();
				firm_asset_class_outputStruct row_tAmazonAuroraOutput_2_in = firm_asset_class_output;
				main3Struct main3 = new main3Struct();
				firm_subClass_outputStruct firm_subClass_output = new firm_subClass_outputStruct();
				firm_subClass_outputStruct row_tAmazonAuroraOutput_3_in = firm_subClass_output;
				...
				String tableName_tAmazonAuroraOutput_1 = "assetCategory";
				...
				String insert_tAmazonAuroraOutput_1 = "INSERT INTO `"
						+ "assetCategory"
						+ "` (`id`,`name`,`orionEclipseName`,`color`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				// ###############################
				// # Outputs initialization
				Firm_asset_category_outputStruct Firm_asset_category_output_tmp = new Firm_asset_category_outputStruct();
				// ###############################
				...
				String tableName_tAmazonAuroraOutput_2 = "assetClass";
				...
				String insert_tAmazonAuroraOutput_2 = "INSERT INTO `"
						+ "assetClass"
						+ "` (`id`,`name`,`assetCategoryId`,`orionEclipseName`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				// ###############################
				// # Outputs initialization
				firm_asset_class_outputStruct firm_asset_class_output_tmp = new firm_asset_class_outputStruct();
				// ###############################
				...
				String tableName_tAmazonAuroraOutput_3 = "assetSubClass";
				...
				String insert_tAmazonAuroraOutput_3 = "INSERT INTO `"
						+ "assetSubClass"
						+ "` (`id`,`name`,`assetClassId`,`orionEclipseName`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				// ###############################
				// # Outputs initialization
				firm_subClass_outputStruct firm_subClass_output_tmp = new firm_subClass_outputStruct();
				// ###############################
				...
				main3Struct main3_tmp = new main3Struct();
				// ###############################
				...
				String dbquery_tAmazonAuroraInput_2_in = "select distinct OrionFirmId from security_"
				...
				try {
					...
					while (rs_tAmazonAuroraInput_2_in.next()) {
						...
						row10 = row_tAmazonAuroraInput_2_in;
						...
						if (!rejectedInnerJoin_tMap_7) { // G_TM_M_020
							...
							row11HashKey.orionConnectFirmId = row10.OrionFirmId;
						...
						{ // start of Var scope
							...
							// # Output table : 's'
							s_tmp.OrionFirmId = row10.OrionFirmId;
							s_tmp.orionEclipseFirmName = row11.orionEclipseFirmName;
							s = s_tmp;
							// ###############################
						...
						if (s != null) {
							...
							if (!rejectedInnerJoin_tMap_8) { // G_TM_M_020
								...
								row12HashKey.firm = s.orionEclipseFirmName;
							...
							if (tHash_Lookup_row12 != null
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row12' and it contains more one result from keys :  row12.firm = '"
								// + row12HashKey.firm + "'");
							} // G 071
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_8) {
									...
									// # Output table : 'main2'
									main2_tmp.firm = s.OrionFirmId;
									main2 = main2_tmp;

									// # Output table : 'main3'
									main3_tmp.firm = s.OrionFirmId;
									main3 = main3_tmp;
							...
							if (mainout != null) {
								...
								while ((tHash_Lookup_row5 != null && tHash_Lookup_row5
									...
									{ // start of Var scope
										...
										Firm_asset_category_output = null;

										if (!rejectedInnerJoin_tMap_2) {

											// # Output table :
											// 'Firm_asset_category_output'
											Firm_asset_category_output_tmp.id = 0;
											Firm_asset_category_output_tmp.name = row5.assetCategory;
											Firm_asset_category_output_tmp.orionEclipseName = row5.assetCategory;
											Firm_asset_category_output_tmp.color = null;
											Firm_asset_category_output_tmp.isDeleted = false;
											Firm_asset_category_output_tmp.createdDate = TalendDate
													.getCurrentDate();
											Firm_asset_category_output_tmp.createdBy = 1;
											Firm_asset_category_output_tmp.editedDate = null;
											Firm_asset_category_output_tmp.editedBy = 1;
											Firm_asset_category_output = Firm_asset_category_output_tmp;
										} // closing inner join bracket (2)
											// ###############################
									...
									// Start of branch
									// "Firm_asset_category_output"
									if (Firm_asset_category_output != null) {
										...
										row_tAmazonAuroraOutput_1_in = Firm_asset_category_output;
										...
										if (row_tAmazonAuroraOutput_1_in.color == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															4,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_1
													.setString(
															4,
															row_tAmazonAuroraOutput_1_in.color);
										}
							...
							if (main2 != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									row2HashKey.OrionFirmId = main2.firm;
								...
								while ((tHash_Lookup_row2 != null && tHash_Lookup_row2
									...
									if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
										...
										row7HashKey.name = row2.assetCategory;
									...
									if (tHash_Lookup_row7 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.name = '"
										// + row7HashKey.name + "'");
									} // G 071
									...
									{ // start of Var scope
										...
										firm_asset_class_output = null;

										if (!rejectedInnerJoin_tMap_3) {

											// # Output table :
											// 'firm_asset_class_output'
											firm_asset_class_output_tmp.id = 0;
											firm_asset_class_output_tmp.name = row2.assetClass;
											firm_asset_class_output_tmp.assetCategoryId = row7.id;
											firm_asset_class_output_tmp.orionEclipseName = row2.assetClass;
											firm_asset_class_output_tmp.isDeleted = false;
											firm_asset_class_output_tmp.createdDate = TalendDate
													.getCurrentDate();
											firm_asset_class_output_tmp.createdBy = 1;
											firm_asset_class_output_tmp.editedDate = null;
											firm_asset_class_output_tmp.editedBy = 1;
											firm_asset_class_output = firm_asset_class_output_tmp;
										} // closing inner join bracket (2)
											// ###############################
									 ...
									 * [tMap_3 main ] stop
									 */
									// Start of branch "firm_asset_class_output"
									if (firm_asset_class_output != null) {
										...
										row_tAmazonAuroraOutput_2_in = firm_asset_class_output;
										...
										if (row_tAmazonAuroraOutput_2_in.assetCategoryId == null) {
											pstmt_tAmazonAuroraOutput_2
													.setNull(
															3,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_2
													.setInt(3,
															row_tAmazonAuroraOutput_2_in.assetCategoryId);
										}

										if (row_tAmazonAuroraOutput_2_in.orionEclipseName == null) {
											pstmt_tAmazonAuroraOutput_2
													.setNull(
															4,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_2
													.setString(
															4,
															row_tAmazonAuroraOutput_2_in.orionEclipseName);
										}
									...
									} // End of branch "firm_asset_class_output"
							...
							if (main3 != null) {
								...
								if (!rejectedInnerJoin_tMap_4) { // G_TM_M_020
									...
									row1HashKey.OrionFirmId = main3.firm;
								...
								if (tHash_Lookup_row1 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row1' and it contains more one result from keys :  row1.OrionFirmId = '"
									// + row1HashKey.OrionFirmId + "'");
								} // G 071
								...
								if (!rejectedInnerJoin_tMap_4) { // G_TM_M_020
									...
									row8HashKey.name = row1.assetClass;
								...
								if (tHash_Lookup_row8 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.name = '"
									// + row8HashKey.name + "'");
								} // G 071
								...
								{ // start of Var scope
									...
									firm_subClass_output = null;

									// # Output table : 'firm_subClass_output'
									firm_subClass_output_tmp.id = 0;
									firm_subClass_output_tmp.name = row1.subClass;
									firm_subClass_output_tmp.assetClassId = row8.id;
									firm_subClass_output_tmp.orionEclipseName = row1.subClass;
									firm_subClass_output_tmp.isDeleted = false;
									firm_subClass_output_tmp.createdDate = TalendDate
											.getCurrentDate();
									firm_subClass_output_tmp.createdBy = 1;
									firm_subClass_output_tmp.editedDate = TalendDate
											.getCurrentDate();
									firm_subClass_output_tmp.editedBy = 1;
									firm_subClass_output = firm_subClass_output_tmp;
									// ###############################
								 ...
								 * [tMap_4 main ] stop
								 */
								// Start of branch "firm_subClass_output"
								if (firm_subClass_output != null) {
									...
									row_tAmazonAuroraOutput_3_in = firm_subClass_output;
									...
									if (row_tAmazonAuroraOutput_3_in.assetClassId == null) {
										pstmt_tAmazonAuroraOutput_3.setNull(3,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tAmazonAuroraOutput_3
												.setInt(3,
														row_tAmazonAuroraOutput_3_in.assetClassId);
									}

									if (row_tAmazonAuroraOutput_3_in.orionEclipseName == null) {
										...
										pstmt_tAmazonAuroraOutput_3
												.setString(
														4,
														row_tAmazonAuroraOutput_3_in.orionEclipseName);
									}
								...
								} // End of branch "firm_subClass_output"
	...
	public void tAmazonAuroraInput_6_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_7 - inputs:(row10,row11) outputs:(s)
				...
				String dbquery_tAmazonAuroraInput_6_in = "select orionConnectFirmId , orionEclipseFirmName from firm";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_6_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 1) {
							row_tAmazonAuroraInput_6_in.orionConnectFirmId = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(1) != null) {
								row_tAmazonAuroraInput_6_in.orionConnectFirmId = rs_tAmazonAuroraInput_6_in
										.getInt(1);
							} else {
								row_tAmazonAuroraInput_6_in.orionConnectFirmId = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 2) {
							row_tAmazonAuroraInput_6_in.orionEclipseFirmName = null;
						} else {

							row_tAmazonAuroraInput_6_in.orionEclipseFirmName = routines.system.JDBCUtil
						...
						row11_HashRow.orionEclipseFirmName = row11.orionEclipseFirmName;
	...
	public void tAmazonAuroraInput_7_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_3 - inputs:(main2,row7,row2)
				// outputs:(firm_asset_class_output)
				...
				String dbquery_tAmazonAuroraInput_7_in = "select id , name from assetCategory";
	...
	public void tAmazonAuroraInput_8_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_4 - inputs:(main3,row8,row1)
				// outputs:(firm_subClass_output)
				...
				String dbquery_tAmazonAuroraInput_8_in = "select id , name from assetClass";
	...
	public void tAmazonAuroraInput_5_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_5_inStruct row1 = row_tAmazonAuroraInput_5_in;
				...
				// inputs:(row_tAmazonAuroraInput_5_in) outputs:(row1,row1) |
				...
				String dbquery_tAmazonAuroraInput_5_in = "select  distinct assetClass , subClass , OrionFirmId from security_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_5_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 1) {
							row_tAmazonAuroraInput_5_in.assetClass = null;
						} else {

							row_tAmazonAuroraInput_5_in.assetClass = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 1,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 2) {
							row_tAmazonAuroraInput_5_in.subClass = null;
						} else {

							row_tAmazonAuroraInput_5_in.subClass = routines.system.JDBCUtil
						...
						row1 = row_tAmazonAuroraInput_5_in;
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tAmazonAuroraInput_4_in = "select distinct assetCategory , assetClass ,OrionFirmId from security_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_4_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_4_in < 1) {
							row_tAmazonAuroraInput_4_in.assetCategory = null;
						} else {

							row_tAmazonAuroraInput_4_in.assetCategory = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_4_in, 1,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_4_in < 2) {
							row_tAmazonAuroraInput_4_in.assetClass = null;
						} else {

							row_tAmazonAuroraInput_4_in.assetClass = routines.system.JDBCUtil
						...
						row2_HashRow.assetCategory = row2.assetCategory;

						row2_HashRow.assetClass = row2.assetClass;

						row2_HashRow.OrionFirmId = row2.OrionFirmId;
	...
	public void tAmazonAuroraInput_3_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_2 - inputs:(mainout,row5)
				// outputs:(Firm_asset_category_output)
				...
				String dbquery_tAmazonAuroraInput_3_in = "select  distinct  assetCategory, OrionFirmId from security_"
						+ context.firmId
						+ "_"
						+ context.date
						+ " where trim(assetCategory) is not null";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_3_in.next()) {
						...
						row5_HashRow.assetCategory = row5.assetCategory;
	...
	public static void main(String[] args) {
		final PreFirmSecurityImport PreFirmSecurityImportClass = new PreFirmSecurityImport();

		int exitCode = PreFirmSecurityImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = PreFirmSecurityImport.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/prefirmsecurityimport_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : PreFirmSecurityImport");
		}
...
/************************************************************************************************
 * 472391 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:17 PM IST
 ************************************************************************************************/
