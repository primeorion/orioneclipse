...
package reliazedgainloss.firmtransactionimport_0_1;
...
/**
 * Job: FirmTransactionImport Purpose: Firm Transaction Import<br>
 * Description: Firm Transaction Import <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class FirmTransactionImport implements TalendJob {
	...
	private final String jobName = "FirmTransactionImport";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					FirmTransactionImport.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FirmTransactionImport.this, new Object[] {
	...
	public static class row_tAmazonAuroraOutput_3_inStruct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_FirmTransactionImport) {
	...
	public void tJavaRow_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// source node:tJavaRow_3 - inputs:(after_tAmazonAuroraInput_6)
				// outputs:(row9_0,row9_0) | target node:tAdvancedHash_row9_0 -
				// inputs:(row9_0) outputs:()
				// linked node: tMap_7 - inputs:(s,row9_0)
	...
	public void tAmazonAuroraInput_6_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String tableName_tAmazonAuroraOutput_6 = "importError_Transaction";
				...
				String tableName_tAmazonAuroraOutput_1 = "transaction_"
						+ context.currentDate;
				...
				if (whetherExist_tAmazonAuroraOutput_1) {
					java.sql.Statement stmtDrop_tAmazonAuroraOutput_1 = conn_tAmazonAuroraOutput_1
							.createStatement();
					stmtDrop_tAmazonAuroraOutput_1.execute("DROP TABLE `"
							+ tableName_tAmazonAuroraOutput_1 + "`");
					stmtDrop_tAmazonAuroraOutput_1.close();
				}
				...
				stmtCreate_tAmazonAuroraOutput_1
						.execute("CREATE TABLE `"
								+ tableName_tAmazonAuroraOutput_1
								+ "`(`accountId` INT(255)  ,`securityId` INT(10)   not null ,`orionFirmId` INT(10)  ,`externalId` INT(10)   not null ,`tradeDate` DATETIME  not null ,`quantity` FLOAT(22,7)   not null ,`amount` FLOAT(22,7)   not null ,`type` VARCHAR(100)   not null ,`tradeCost` FLOAT(22,2)   not null ,`action` VARCHAR(255)   not null ,`isDeleted` BIT(0)   not null ,`createdDate` DATETIME  not null ,`createdBy` INT(11)   not null ,`editedDate` DATETIME  not null ,`editedBy` INT(11)   not null ,`eclipseTradeOrderId` INT(0)  ,`status` VARCHAR(255)  )");
				stmtCreate_tAmazonAuroraOutput_1.close();

				String insert_tAmazonAuroraOutput_1 = "INSERT INTO `"
						+ "transaction_"
						+ context.currentDate
						+ "` (`accountId`,`securityId`,`orionFirmId`,`externalId`,`tradeDate`,`quantity`,`amount`,`type`,`tradeCost`,`action`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`,`eclipseTradeOrderId`,`status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String tableName_tAmazonAuroraOutput_7 = "noDataFound_Transaction";
				...
				java.sql.DatabaseMetaData dbMetaData_tAmazonAuroraOutput_7 = conn_tAmazonAuroraOutput_7
						.getMetaData();
				java.sql.ResultSet rsTable_tAmazonAuroraOutput_7 = dbMetaData_tAmazonAuroraOutput_7
						.getTables(null, null, null, new String[] { "TABLE" });
				boolean whetherExist_tAmazonAuroraOutput_7 = false;
				while (rsTable_tAmazonAuroraOutput_7.next()) {
					String table_tAmazonAuroraOutput_7 = rsTable_tAmazonAuroraOutput_7
							.getString("TABLE_NAME");
					if (table_tAmazonAuroraOutput_7
							.equalsIgnoreCase("noDataFound_Transaction")) {
						whetherExist_tAmazonAuroraOutput_7 = true;
						break;
					}
				}
				rsTable_tAmazonAuroraOutput_7.close();
				if (!whetherExist_tAmazonAuroraOutput_7) {
					java.sql.Statement stmtCreate_tAmazonAuroraOutput_7 = conn_tAmazonAuroraOutput_7
							.createStatement();
					stmtCreate_tAmazonAuroraOutput_7
							.execute("CREATE TABLE `"
									+ tableName_tAmazonAuroraOutput_7
					...
					stmtCreate_tAmazonAuroraOutput_7.close();
				}
				...
				String dbquery_tAmazonAuroraInput_6_in = "select distinct OrionFirmId from transaction_"
				...
				try {
					...
					while (rs_tAmazonAuroraInput_6_in.next()) {
						...
						row9 = row_tAmazonAuroraInput_6_in;
							...
							if (mainout != null) {
								...
								while ((tHash_Lookup_row1 != null && tHash_Lookup_row1
									...
									if (ErrorReject != null) {
										...
										row_tAmazonAuroraOutput_6_in = ErrorReject;
										...
										if (row_tAmazonAuroraOutput_6_in.symbol == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															5,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															5,
															row_tAmazonAuroraOutput_6_in.symbol);
										}
										...
										if (row_tAmazonAuroraOutput_6_in.amount == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															8,
															java.sql.Types.FLOAT);
										...
										if (row_tAmazonAuroraOutput_6_in.tradeCost == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															11,
															java.sql.Types.FLOAT);
										...
										if (row_tAmazonAuroraOutput_6_in.errorMessage == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															12,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															12,
															row_tAmazonAuroraOutput_6_in.errorMessage);
										}

										if (row_tAmazonAuroraOutput_6_in.errorStackTrace == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															13,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															13,
															row_tAmazonAuroraOutput_6_in.errorStackTrace);
										}
									...
									if (firm_current_transaction_ouput != null) {
										...
										row_tAmazonAuroraOutput_1_in = firm_current_transaction_ouput;
										...
										if (!whetherReject_tAmazonAuroraOutput_1) {
										}
									...
									if (noDataFound_joinReject != null) {
										...
										row_tAmazonAuroraOutput_7_in = noDataFound_joinReject;
										...
										/**
										 * [tAmazonAuroraOutput_7_out main ]
										 * start
										 */
										...
										if (row_tAmazonAuroraOutput_7_in.orionFirmId == null) {
											...
											pstmt_tAmazonAuroraOutput_7
													.setInt(1,
															row_tAmazonAuroraOutput_7_in.orionFirmId);
										}

										if (row_tAmazonAuroraOutput_7_in.externalId == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															2,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_7
													.setInt(2,
															row_tAmazonAuroraOutput_7_in.externalId);
										}
										...
										if (row_tAmazonAuroraOutput_7_in.symbol == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															5,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_7
													.setString(
															5,
															row_tAmazonAuroraOutput_7_in.symbol);
										}

										if (row_tAmazonAuroraOutput_7_in.tradeDate != null) {
											date_tAmazonAuroraOutput_7 = row_tAmazonAuroraOutput_7_in.tradeDate
													.getTime();
										...
										if (row_tAmazonAuroraOutput_7_in.quantity == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															7,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_7
													.setFloat(
															7,
															row_tAmazonAuroraOutput_7_in.quantity);
										}

										if (row_tAmazonAuroraOutput_7_in.amount == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															8,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_7
													.setFloat(
															8,
															row_tAmazonAuroraOutput_7_in.amount);
										}
										...
										if (row_tAmazonAuroraOutput_7_in.action == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															10,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_7
													.setString(
															10,
															row_tAmazonAuroraOutput_7_in.action);
										}

										if (row_tAmazonAuroraOutput_7_in.tradeCost == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															11,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_7
													.setFloat(
															11,
															row_tAmazonAuroraOutput_7_in.tradeCost);
										}

										if (row_tAmazonAuroraOutput_7_in.eclipseTradeOrderId == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															12,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_7
													.setInt(12,
															row_tAmazonAuroraOutput_7_in.eclipseTradeOrderId);
										}

										if (row_tAmazonAuroraOutput_7_in.status == null) {
											pstmt_tAmazonAuroraOutput_7
													.setNull(
															13,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_7
													.setString(
															13,
															row_tAmazonAuroraOutput_7_in.status);
										}
	...
	public static class firm_transaction_ouputStruct implements
			routines.system.IPersistableRow<firm_transaction_ouputStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(firm_transaction_ouputStruct other) {
	...
	public static class after_tAmazonAuroraInput_5Struct implements
			routines.system.IPersistableRow<after_tAmazonAuroraInput_5Struct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmTransactionImport = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(after_tAmazonAuroraInput_5Struct other) {
	...
	public void tAmazonAuroraInput_5_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_5_inStruct row5 = row_tAmazonAuroraInput_5_in;
				firm_transaction_ouputStruct firm_transaction_ouput = new firm_transaction_ouputStruct();
				firm_transaction_ouputStruct row_tAmazonAuroraOutput_2_in = firm_transaction_ouput;
				...
				String tableName_tAmazonAuroraOutput_2 = "transaction";
				...
				String insert_tAmazonAuroraOutput_2 = "INSERT INTO `"
						+ "transaction"
						+ "` (`id`,`accountId`,`securityId`,`orionFirmId`,`externalId`,`orionEclipseFirmId`,`tradeDate`,`quantity`,`amount`,`type`,`tradeCost`,`action`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`,`EclipseTradeOrderId`,`Status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				// ###############################
				// # Outputs initialization
				firm_transaction_ouputStruct firm_transaction_ouput_tmp = new firm_transaction_ouputStruct();
				// ###############################
				...
				String dbquery_tAmazonAuroraInput_5_in = "select * from transaction_"
						+ context.currentDate;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_5_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 1) {
							row_tAmazonAuroraInput_5_in.accountId = null;
						} else {

							row_tAmazonAuroraInput_5_in.accountId = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 1,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 2) {
							row_tAmazonAuroraInput_5_in.securityId = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(2) != null) {
								row_tAmazonAuroraInput_5_in.securityId = rs_tAmazonAuroraInput_5_in
										.getInt(2);
							} else {
								row_tAmazonAuroraInput_5_in.securityId = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 3) {
							...
							if (rs_tAmazonAuroraInput_5_in.getObject(3) != null) {
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 4) {
							...
							if (rs_tAmazonAuroraInput_5_in.getObject(4) != null) {
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 5) {
							row_tAmazonAuroraInput_5_in.tradeDate = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getString(5) != null) {
								String dateString_tAmazonAuroraInput_5_in = rs_tAmazonAuroraInput_5_in
										.getString(5);
								if (!("0000-00-00")
										.equals(dateString_tAmazonAuroraInput_5_in)
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_5_in)) {
									row_tAmazonAuroraInput_5_in.tradeDate = rs_tAmazonAuroraInput_5_in
											.getTimestamp(5);
								} else {
									row_tAmazonAuroraInput_5_in.tradeDate = (java.util.Date) year0_tAmazonAuroraInput_5_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_5_in.tradeDate = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 6) {
							row_tAmazonAuroraInput_5_in.quantity = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(6) != null) {
								row_tAmazonAuroraInput_5_in.quantity = rs_tAmazonAuroraInput_5_in
										.getFloat(6);
							} else {
								row_tAmazonAuroraInput_5_in.quantity = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 7) {
							row_tAmazonAuroraInput_5_in.amount = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(7) != null) {
								row_tAmazonAuroraInput_5_in.amount = rs_tAmazonAuroraInput_5_in
										.getFloat(7);
							} else {
								row_tAmazonAuroraInput_5_in.amount = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 8) {
							row_tAmazonAuroraInput_5_in.type = null;
						} else {

							row_tAmazonAuroraInput_5_in.type = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 8,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 9) {
							row_tAmazonAuroraInput_5_in.tradeCost = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(9) != null) {
								row_tAmazonAuroraInput_5_in.tradeCost = rs_tAmazonAuroraInput_5_in
										.getFloat(9);
							} else {
								row_tAmazonAuroraInput_5_in.tradeCost = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 10) {
							row_tAmazonAuroraInput_5_in.action = null;
						} else {

							row_tAmazonAuroraInput_5_in.action = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 10,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 11) {
							row_tAmazonAuroraInput_5_in.isDeleted = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(11) != null) {
								row_tAmazonAuroraInput_5_in.isDeleted = rs_tAmazonAuroraInput_5_in
										.getBoolean(11);
							} else {
								row_tAmazonAuroraInput_5_in.isDeleted = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 12) {
							row_tAmazonAuroraInput_5_in.createdDate = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getString(12) != null) {
								String dateString_tAmazonAuroraInput_5_in = rs_tAmazonAuroraInput_5_in
										.getString(12);
								if (!("0000-00-00")
										.equals(dateString_tAmazonAuroraInput_5_in)
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_5_in)) {
									row_tAmazonAuroraInput_5_in.createdDate = rs_tAmazonAuroraInput_5_in
											.getTimestamp(12);
								} else {
									row_tAmazonAuroraInput_5_in.createdDate = (java.util.Date) year0_tAmazonAuroraInput_5_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_5_in.createdDate = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 13) {
							row_tAmazonAuroraInput_5_in.createdBy = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(13) != null) {
								row_tAmazonAuroraInput_5_in.createdBy = rs_tAmazonAuroraInput_5_in
										.getInt(13);
							} else {
								row_tAmazonAuroraInput_5_in.createdBy = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 14) {
							row_tAmazonAuroraInput_5_in.editedDate = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getString(14) != null) {
								String dateString_tAmazonAuroraInput_5_in = rs_tAmazonAuroraInput_5_in
										.getString(14);
								if (!("0000-00-00")
										.equals(dateString_tAmazonAuroraInput_5_in)
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_5_in)) {
									row_tAmazonAuroraInput_5_in.editedDate = rs_tAmazonAuroraInput_5_in
											.getTimestamp(14);
								} else {
									row_tAmazonAuroraInput_5_in.editedDate = (java.util.Date) year0_tAmazonAuroraInput_5_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_5_in.editedDate = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 15) {
							row_tAmazonAuroraInput_5_in.editedBy = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(15) != null) {
								row_tAmazonAuroraInput_5_in.editedBy = rs_tAmazonAuroraInput_5_in
										.getInt(15);
							} else {
								row_tAmazonAuroraInput_5_in.editedBy = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 16) {
							row_tAmazonAuroraInput_5_in.eclipseTradeOrderId = null;
						} else {

							if (rs_tAmazonAuroraInput_5_in.getObject(16) != null) {
								row_tAmazonAuroraInput_5_in.eclipseTradeOrderId = rs_tAmazonAuroraInput_5_in
										.getInt(16);
							} else {
								row_tAmazonAuroraInput_5_in.eclipseTradeOrderId = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 17) {
							row_tAmazonAuroraInput_5_in.status = null;
						} else {

							row_tAmazonAuroraInput_5_in.status = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 17,
											false);
						}
						...
						row5 = row_tAmazonAuroraInput_5_in;
						...
						{ // start of Var scope
							...
							firm_transaction_ouput = null;

							// # Output table : 'firm_transaction_ouput'
							firm_transaction_ouput_tmp.id = null;
							firm_transaction_ouput_tmp.accountId = row5.accountId;
							firm_transaction_ouput_tmp.securityId = row5.securityId;
							firm_transaction_ouput_tmp.orionFirmId = row5.orionFirmId;
							firm_transaction_ouput_tmp.externalId = row5.externalId;
							firm_transaction_ouput_tmp.orionEclipseFirmId = row8.orionEclipseFirmId;
							firm_transaction_ouput_tmp.tradeDate = row5.tradeDate;
							firm_transaction_ouput_tmp.quantity = row5.quantity;
							firm_transaction_ouput_tmp.amount = row5.amount;
							firm_transaction_ouput_tmp.type = row5.type;
							firm_transaction_ouput_tmp.tradeCost = row5.tradeCost;
							firm_transaction_ouput_tmp.action = row5.action;
							firm_transaction_ouput_tmp.isDeleted = row5.isDeleted;
							firm_transaction_ouput_tmp.createdDate = row5.createdDate;
							firm_transaction_ouput_tmp.createdBy = row5.createdBy;
							firm_transaction_ouput_tmp.editedDate = row5.editedDate;
							firm_transaction_ouput_tmp.editedBy = row5.editedBy;
							firm_transaction_ouput_tmp.EclipseTradeOrderId = row5.eclipseTradeOrderId;
							firm_transaction_ouput_tmp.Status = row5.status;
							firm_transaction_ouput = firm_transaction_ouput_tmp;
							// ###############################
						 ...
						 * [tMap_3 main ] stop
						 */
						// Start of branch "firm_transaction_ouput"
						if (firm_transaction_ouput != null) {
							...
							row_tAmazonAuroraOutput_2_in = firm_transaction_ouput;
							...
							if (row_tAmazonAuroraOutput_2_in.id == null) {
							...
							if (row_tAmazonAuroraOutput_2_in.tradeDate != null) {
								date_tAmazonAuroraOutput_2 = row_tAmazonAuroraOutput_2_in.tradeDate
										.getTime();
							...
							if (row_tAmazonAuroraOutput_2_in.quantity == null) {
								...
								pstmt_tAmazonAuroraOutput_2.setFloat(8,
										row_tAmazonAuroraOutput_2_in.quantity);
							}

							if (row_tAmazonAuroraOutput_2_in.amount == null) {
								pstmt_tAmazonAuroraOutput_2.setNull(9,
										java.sql.Types.FLOAT);
							} else {
								pstmt_tAmazonAuroraOutput_2.setFloat(9,
										row_tAmazonAuroraOutput_2_in.amount);
							}
							...
							if (row_tAmazonAuroraOutput_2_in.tradeCost == null) {
								pstmt_tAmazonAuroraOutput_2.setNull(11,
										java.sql.Types.FLOAT);
							} else {
								pstmt_tAmazonAuroraOutput_2.setFloat(11,
										row_tAmazonAuroraOutput_2_in.tradeCost);
							}

							if (row_tAmazonAuroraOutput_2_in.action == null) {
								pstmt_tAmazonAuroraOutput_2.setNull(12,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_2.setString(12,
										row_tAmazonAuroraOutput_2_in.action);
							}
							...
							if (row_tAmazonAuroraOutput_2_in.isDeleted == null) {
								...
								pstmt_tAmazonAuroraOutput_2.setBoolean(13,
							...
							if (row_tAmazonAuroraOutput_2_in.createdDate != null) {
								...
								if (date_tAmazonAuroraOutput_2 < year1_tAmazonAuroraOutput_2
										|| date_tAmazonAuroraOutput_2 >= year10000_tAmazonAuroraOutput_2) {
									pstmt_tAmazonAuroraOutput_2.setString(14,
											"0000-00-00 00:00:00");
								} else {
									pstmt_tAmazonAuroraOutput_2
											.setTimestamp(
							...
							if (row_tAmazonAuroraOutput_2_in.createdBy == null) {
								...
								pstmt_tAmazonAuroraOutput_2.setInt(15,
							...
							if (row_tAmazonAuroraOutput_2_in.EclipseTradeOrderId == null) {
								pstmt_tAmazonAuroraOutput_2.setNull(18,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tAmazonAuroraOutput_2
										.setInt(18,
												row_tAmazonAuroraOutput_2_in.EclipseTradeOrderId);
							}

							if (row_tAmazonAuroraOutput_2_in.Status == null) {
								pstmt_tAmazonAuroraOutput_2.setNull(19,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_2.setString(19,
										row_tAmazonAuroraOutput_2_in.Status);
							}
							...
							if (!whetherReject_tAmazonAuroraOutput_2) {
							}
						...
						} // End of branch "firm_transaction_ouput"
	...
	public void tAmazonAuroraInput_2_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_2_inStruct row8 = row_tAmazonAuroraInput_2_in;
				...
				// inputs:(row_tAmazonAuroraInput_2_in) outputs:(row8,row8) |
				// target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
				// linked node: tMap_3 - inputs:(row5,row8)
				// outputs:(firm_transaction_ouput)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_2_in.next()) {
						...
						row8 = row_tAmazonAuroraInput_2_in;
	...
	public void tAmazonAuroraInput_7_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_7_inStruct row10 = row_tAmazonAuroraInput_7_in;
				...
				// inputs:(row_tAmazonAuroraInput_7_in) outputs:(row10,row10) |
				// target node:tAdvancedHash_row10 - inputs:(row10) outputs:()
				// linked node: tMap_6 - inputs:(row9,row10) outputs:(s)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_7_in.next()) {
						...
						row10 = row_tAmazonAuroraInput_7_in;
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_2 - inputs:(mainout,row2,row1,row11)
	...
	public void tAmazonAuroraInput_3_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tAmazonAuroraInput_3_in = "select * from transaction_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_3_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 6) {
							row_tAmazonAuroraInput_3_in.tradeDate = null;
						} else {
							...
							if (rs_tAmazonAuroraInput_3_in.getString(6) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_3_in)) {
									row_tAmazonAuroraInput_3_in.tradeDate = rs_tAmazonAuroraInput_3_in
											.getTimestamp(6);
								} else {
									row_tAmazonAuroraInput_3_in.tradeDate = (java.util.Date) year0_tAmazonAuroraInput_3_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_3_in.tradeDate = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 8) {
							row_tAmazonAuroraInput_3_in.amount = null;
						} else {

							if (rs_tAmazonAuroraInput_3_in.getObject(8) != null) {
								row_tAmazonAuroraInput_3_in.amount = rs_tAmazonAuroraInput_3_in
										.getFloat(8);
							} else {
								row_tAmazonAuroraInput_3_in.amount = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 9) {
							row_tAmazonAuroraInput_3_in.type = null;
						} else {

							row_tAmazonAuroraInput_3_in.type = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 9,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_3_in < 10) {
							row_tAmazonAuroraInput_3_in.action = null;
						} else {

							row_tAmazonAuroraInput_3_in.action = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 10,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_3_in < 11) {
							row_tAmazonAuroraInput_3_in.tradeCost = null;
						} else {

							if (rs_tAmazonAuroraInput_3_in.getObject(11) != null) {
								row_tAmazonAuroraInput_3_in.tradeCost = rs_tAmazonAuroraInput_3_in
										.getFloat(11);
							} else {
								row_tAmazonAuroraInput_3_in.tradeCost = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 12) {
							row_tAmazonAuroraInput_3_in.EclipseTradeOrderId = null;
						} else {

							if (rs_tAmazonAuroraInput_3_in.getObject(12) != null) {
								row_tAmazonAuroraInput_3_in.EclipseTradeOrderId = rs_tAmazonAuroraInput_3_in
										.getInt(12);
							} else {
								row_tAmazonAuroraInput_3_in.EclipseTradeOrderId = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 13) {
							row_tAmazonAuroraInput_3_in.Status = null;
						} else {

							row_tAmazonAuroraInput_3_in.Status = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 13,
											false);
						}
	...
	public void tAmazonAuroraInput_8_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// inputs:(row_tAmazonAuroraInput_8_in) outputs:(row11,row11) |
				...
				String dbquery_tAmazonAuroraInput_8_in = "select id , accountId from account";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_8_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_8_in < 2) {
							row_tAmazonAuroraInput_8_in.accountId = null;
						} else {

							row_tAmazonAuroraInput_8_in.accountId = routines.system.JDBCUtil
	...
	public static void main(String[] args) {
		final FirmTransactionImport FirmTransactionImportClass = new FirmTransactionImport();

		int exitCode = FirmTransactionImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FirmTransactionImport.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/firmtransactionimport_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : FirmTransactionImport");
		}
...
/************************************************************************************************
 * 564691 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:29 PM IST
 ************************************************************************************************/
