...
package reliazedgainloss.firmsecurityimport_0_1;
...
/**
 * Job: FirmSecurityImport Purpose: Firm Security Import<br>
 * Description: Firm Security Import <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class FirmSecurityImport implements TalendJob {
	...
	private final String jobName = "FirmSecurityImport";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					FirmSecurityImport.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FirmSecurityImport.this, new Object[] { e,
	...
	public static class row_tAmazonAuroraOutput_3_inStruct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				for (StatCatcherUtils.StatCatcherMessage scm : tStatCatcher_1
					...
					row5.origin = (scm.getOrigin() == null
					...
					{ // start of Var scope
						...
						statCatcherOutput_tmp.moment = row5.moment;
						statCatcherOutput_tmp.project = row5.project;
						statCatcherOutput_tmp.job = row5.job;
						statCatcherOutput_tmp.job_version = row5.job_version;
						statCatcherOutput_tmp.context = row5.context;
						statCatcherOutput_tmp.message_type = row5.message_type;
						statCatcherOutput_tmp.message = row5.message;
						statCatcherOutput_tmp.duration = row5.duration;
	...
	public void tJavaRow_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// source node:tJavaRow_3 - inputs:(after_tAmazonAuroraInput_9)
				// outputs:(row14,row14) | target node:tAdvancedHash_row14 -
				// inputs:(row14) outputs:()
				// linked node: tMap_7 - inputs:(s,row14) outputs:(out1,mainout)
	...
	public void tJavaRow_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// source node:tJavaRow_5 - inputs:(after_tAmazonAuroraInput_12)
				// outputs:(row18,row18) | target node:tAdvancedHash_row18 -
				// inputs:(row18) outputs:()
				// linked node: tMap_9 - inputs:(copyOfs,row18)
	...
	public static class row_tAmazonAuroraOutput_1_inStruct implements
		...
		public String orionEclipseName;

		public String getOrionEclipseName() {
			return this.orionEclipseName;
		}

		public Float custodialCash;

		public Float getCustodialCash() {
			return this.custodialCash;
		}
		...
		public Integer assetClassId;

		public Integer getAssetClassId() {
			return this.assetClassId;
		}

		public Integer assetSubClassId;

		public Integer getAssetSubClassId() {
			return this.assetSubClassId;
		}
		...
		public void copyDataTo(row_tAmazonAuroraOutput_1_inStruct other) {
			...
			other.orionEclipseName = this.orionEclipseName;
			other.custodialCash = this.custodialCash;
			other.assetCategoryId = this.assetCategoryId;
			other.assetClassId = this.assetClassId;
			other.assetSubClassId = this.assetSubClassId;
			other.securityTypeId = this.securityTypeId;
			other.statusId = this.statusId;
			other.isCustodialCash = this.isCustodialCash;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport) {
				...
				try {
					...
					this.orionEclipseName = readString(dis);

					length = dis.readByte();
					if (length == -1) {
						this.custodialCash = null;
					} else {
						this.custodialCash = dis.readFloat();
					}

					this.assetCategoryId = readInteger(dis);

					this.assetClassId = readInteger(dis);

					this.assetSubClassId = readInteger(dis);

					this.securityTypeId = dis.readInt();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.orionEclipseName, dos);

				// Float

				if (this.custodialCash == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.custodialCash);
				}
				...
				writeInteger(this.assetClassId, dos);

				// Integer

				writeInteger(this.assetSubClassId, dos);

				// int

				dos.writeInt(this.securityTypeId);
		...
		public String toString() {
			...
			sb.append(",symbol=" + symbol);
			sb.append(",name=" + name);
			sb.append(",orionEclipseName=" + orionEclipseName);
			sb.append(",custodialCash=" + String.valueOf(custodialCash));
			sb.append(",assetCategoryId=" + String.valueOf(assetCategoryId));
			sb.append(",assetClassId=" + String.valueOf(assetClassId));
			sb.append(",assetSubClassId=" + String.valueOf(assetSubClassId));
			sb.append(",securityTypeId=" + String.valueOf(securityTypeId));
	...
	public static class firm_security_outputStruct implements
			routines.system.IPersistableRow<firm_security_outputStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final firm_security_outputStruct other = (firm_security_outputStruct) obj;
		...
		public void copyDataTo(firm_security_outputStruct other) {
		...
		public void copyKeysDataTo(firm_security_outputStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(firm_security_outputStruct other) {
	...
	public static class noDataFound_joinReject5Struct implements
			routines.system.IPersistableRow<noDataFound_joinReject5Struct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(noDataFound_joinReject5Struct other) {
	...
	public static class after_tAmazonAuroraInput_9Struct implements
			routines.system.IPersistableRow<after_tAmazonAuroraInput_9Struct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(after_tAmazonAuroraInput_9Struct other) {
	...
	public void tAmazonAuroraInput_9_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				ErrorRejectStruct row_tAmazonAuroraOutput_5_in = ErrorReject;
				firm_security_outputStruct firm_security_output = new firm_security_outputStruct();
				firm_security_outputStruct row_tAmazonAuroraOutput_1_in = firm_security_output;
				noDataFound_joinReject5Struct noDataFound_joinReject5 = new noDataFound_joinReject5Struct();
				noDataFound_joinReject5Struct row_tAmazonAuroraOutput_6_in = noDataFound_joinReject5;
				...
				String tableName_tAmazonAuroraOutput_5 = "importError_Security";
				...
				while (rsTable_tAmazonAuroraOutput_5.next()) {
					...
					if (table_tAmazonAuroraOutput_5
							.equalsIgnoreCase("importError_Security")) {
				...
				if (!whetherExist_tAmazonAuroraOutput_5) {
					...
					stmtCreate_tAmazonAuroraOutput_5
							.execute("CREATE TABLE `"
									...
									+ "`(`orionFirmId` INT(10)  ,`externalId` INT(10)  ,`symbol` VARCHAR(100)  ,`name` VARCHAR(255)  ,`price` FLOAT(22,2)  ,`securityType` VARCHAR(50)  ,`assetCategory` VARCHAR(100)  ,`assetClass` VARCHAR(100)  ,`subClass` VARCHAR(100)  ,`maturityDate` DATETIME ,`IsCustodialCash` BIT(0)  ,`errorMessage` VARCHAR(0)  ,`errorStackTrace` VARCHAR(0)  )");
					stmtCreate_tAmazonAuroraOutput_5.close();
				}

				String insert_tAmazonAuroraOutput_5 = "INSERT INTO `"
						+ "importError_Security"
						+ "` (`orionFirmId`,`externalId`,`symbol`,`name`,`price`,`securityType`,`assetCategory`,`assetClass`,`subClass`,`maturityDate`,`IsCustodialCash`,`errorMessage`,`errorStackTrace`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String tableName_tAmazonAuroraOutput_1 = "security";
				...
				String insert_tAmazonAuroraOutput_1 = "INSERT INTO `"
						+ "security"
						+ "` (`id`,`orionFirmID`,`orionConnectExternalId`,`orionEclipseFirmId`,`symbol`,`name`,`orionEclipseName`,`custodialCash`,`assetCategoryId`,`assetClassId`,`assetSubClassId`,`securityTypeId`,`statusId`,`isCustodialCash`,`createdDate`,`createdBy`,`editedDate`,`editedBy`,`isDeleted`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String tableName_tAmazonAuroraOutput_6 = "noDataFound_Security";
				...
				while (rsTable_tAmazonAuroraOutput_6.next()) {
					...
					if (table_tAmazonAuroraOutput_6
							.equalsIgnoreCase("noDataFound_Security")) {
				...
				if (!whetherExist_tAmazonAuroraOutput_6) {
					...
					stmtCreate_tAmazonAuroraOutput_6
							.execute("CREATE TABLE `"
									...
									+ "`(`orionFirmId` INT(10)  ,`externalId` INT(10)  ,`symbol` VARCHAR(100)  ,`name` VARCHAR(255)  ,`price` FLOAT(22,2)  ,`securityType` VARCHAR(50)  ,`assetCategory` VARCHAR(100)  ,`assetClass` VARCHAR(100)  ,`subClass` VARCHAR(100)  ,`maturityDate` DATETIME ,`IsCustodialCash` BIT(0)  )");
					stmtCreate_tAmazonAuroraOutput_6.close();
				}

				String insert_tAmazonAuroraOutput_6 = "INSERT INTO `"
						+ "noDataFound_Security"
						+ "` (`orionFirmId`,`externalId`,`symbol`,`name`,`price`,`securityType`,`assetCategory`,`assetClass`,`subClass`,`maturityDate`,`IsCustodialCash`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				firm_security_outputStruct firm_security_output_tmp = new firm_security_outputStruct();
				noDataFound_joinReject5Struct noDataFound_joinReject5_tmp = new noDataFound_joinReject5Struct();
				// ###############################
				...
				String dbquery_tAmazonAuroraInput_9_in = "select distinct OrionFirmId from security_"
				...
				try {
					...
					while (rs_tAmazonAuroraInput_9_in.next()) {
						...
						if (!rejectedInnerJoin_tMap_6) { // G_TM_M_020
							...
							row13HashKey.orionConnectFirmId = row12.OrionFirmId;
						...
						{ // start of Var scope
							...
							// # Output table : 's'
							s_tmp.OrionFirmId = row12.OrionFirmId;
							s_tmp.orionEclipseFirmName = row13.orionEclipseFirmName;
							s = s_tmp;
							// ###############################
						...
						if (s != null) {
							...
							if (!rejectedInnerJoin_tMap_7) { // G_TM_M_020
								...
								row14HashKey.firm = s.orionEclipseFirmName;
							...
							if (tHash_Lookup_row14 != null
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row14' and it contains more one result from keys :  row14.firm = '"
								// + row14HashKey.firm + "'");
							} // G 071
							...
							if (mainout != null) {
								...
								while ((tHash_Lookup_row1 != null && tHash_Lookup_row1
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row2HashKey.name = row1.assetCategory;
									...
									if (tHash_Lookup_row2 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.name = '"
										// + row2HashKey.name + "'");
									} // G 071
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row9HashKey.name = row1.assetClass;
									...
									if (tHash_Lookup_row9 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row9' and it contains more one result from keys :  row9.name = '"
										// + row9HashKey.name + "'");
									} // G 071
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row10HashKey.name = row1.subClass;
									...
									if (tHash_Lookup_row10 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row10' and it contains more one result from keys :  row10.name = '"
										// + row10HashKey.name + "'");
									} // G 071
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row11HashKey.orionConnectFirmId = row1.orionFirmId;
									...
									if (tHash_Lookup_row11 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row11' and it contains more one result from keys :  row11.orionConnectFirmId = '"
										// + row11HashKey.orionConnectFirmId +
										// "'");
									} // G 071
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row15HashKey.name = row1.securityType;
									...
									if (tHash_Lookup_row15 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row15' and it contains more one result from keys :  row15.name = '"
										// + row15HashKey.name + "'");
									} // G 071
									...
									try {
										...
										{ // start of Var scope
											...
											ErrorReject = null;
											firm_security_output = null;
											noDataFound_joinReject5 = null;

											if (!rejectedInnerJoin_tMap_2) {

												// # Output table :
												// 'firm_security_output'
												firm_security_output_tmp.id = null;
												firm_security_output_tmp.orionFirmID = row1.orionFirmId;
												firm_security_output_tmp.orionConnectExternalId = row1.externalId;
												firm_security_output_tmp.orionEclipseFirmId = row11.orionEclipseFirmId;
												firm_security_output_tmp.symbol = row1.symbol;
												firm_security_output_tmp.name = row1.name;
												firm_security_output_tmp.orionEclipseName = null;
												firm_security_output_tmp.custodialCash = null;
												firm_security_output_tmp.assetCategoryId = row2.id;
												firm_security_output_tmp.assetClassId = row9.id;
												firm_security_output_tmp.assetSubClassId = row10.id;
												firm_security_output_tmp.securityTypeId = row15.id;
												firm_security_output_tmp.statusId = 6;
												firm_security_output_tmp.isCustodialCash = row1.IsCustodialCash;
												firm_security_output_tmp.createdDate = TalendDate
														.getCurrentDate();
												firm_security_output_tmp.createdBy = 1;
												firm_security_output_tmp.editedDate = TalendDate
														.getCurrentDate();
												firm_security_output_tmp.editedBy = 1;
												firm_security_output_tmp.isDeleted = null;
												firm_security_output = firm_security_output_tmp;
											} // closing inner join bracket (1)
												// ###### START REJECTS #####

											// # Output reject table :
											// 'noDataFound_joinReject5'
											// # Filter conditions
											if (rejectedInnerJoin_tMap_2) {
												noDataFound_joinReject5_tmp.orionFirmId = row1.orionFirmId;
												noDataFound_joinReject5_tmp.externalId = row1.externalId;
												noDataFound_joinReject5_tmp.symbol = row1.symbol;
												noDataFound_joinReject5_tmp.name = row1.name;
												noDataFound_joinReject5_tmp.price = row1.price;
												noDataFound_joinReject5_tmp.securityType = row1.securityType;
												noDataFound_joinReject5_tmp.assetCategory = row1.assetCategory;
												noDataFound_joinReject5_tmp.assetClass = row1.assetClass;
												noDataFound_joinReject5_tmp.subClass = row1.subClass;
												noDataFound_joinReject5_tmp.maturityDate = row1.maturityDate;
												noDataFound_joinReject5_tmp.IsCustodialCash = row1.IsCustodialCash;
												noDataFound_joinReject5 = noDataFound_joinReject5_tmp;
											} // closing filter/reject
												// ###############################
										...
										try {// EE
											...
											ErrorReject_tmp.name = row1.name;
											ErrorReject_tmp.price = row1.price;
											ErrorReject_tmp.securityType = row1.securityType;
											ErrorReject_tmp.assetCategory = row1.assetCategory;
											ErrorReject_tmp.assetClass = row1.assetClass;
											ErrorReject_tmp.subClass = row1.subClass;
											ErrorReject_tmp.maturityDate = row1.maturityDate;
											ErrorReject_tmp.IsCustodialCash = row1.IsCustodialCash;
									...
									if (ErrorReject != null) {
										...
										row_tAmazonAuroraOutput_5_in = ErrorReject;
										...
										if (row_tAmazonAuroraOutput_5_in.price == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															5,
											...
											pstmt_tAmazonAuroraOutput_5
													.setFloat(
															5,
															row_tAmazonAuroraOutput_5_in.price);
										}

										if (row_tAmazonAuroraOutput_5_in.securityType == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															6,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_5
													.setString(
															6,
															row_tAmazonAuroraOutput_5_in.securityType);
										}

										if (row_tAmazonAuroraOutput_5_in.assetCategory == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															7,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_5
													.setString(
															7,
															row_tAmazonAuroraOutput_5_in.assetCategory);
										}

										if (row_tAmazonAuroraOutput_5_in.assetClass == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															8,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_5
													.setString(
															8,
															row_tAmazonAuroraOutput_5_in.assetClass);
										}

										if (row_tAmazonAuroraOutput_5_in.subClass == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															9,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_5
													.setString(
															9,
															row_tAmazonAuroraOutput_5_in.subClass);
										}

										if (row_tAmazonAuroraOutput_5_in.maturityDate != null) {
											date_tAmazonAuroraOutput_5 = row_tAmazonAuroraOutput_5_in.maturityDate
													.getTime();
										...
										if (row_tAmazonAuroraOutput_5_in.IsCustodialCash == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															11,
											...
											pstmt_tAmazonAuroraOutput_5
													.setBoolean(
															11,
															row_tAmazonAuroraOutput_5_in.IsCustodialCash);
										}

										if (row_tAmazonAuroraOutput_5_in.errorMessage == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															12,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_5
													.setString(
															12,
															row_tAmazonAuroraOutput_5_in.errorMessage);
										}

										if (row_tAmazonAuroraOutput_5_in.errorStackTrace == null) {
											pstmt_tAmazonAuroraOutput_5
													.setNull(
															13,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_5
													.setString(
															13,
															row_tAmazonAuroraOutput_5_in.errorStackTrace);
										}
									...
									// Start of branch "firm_security_output"
									if (firm_security_output != null) {
										...
										row_tAmazonAuroraOutput_1_in = firm_security_output;
										...
										if (row_tAmazonAuroraOutput_1_in.id == null) {
										...
										if (row_tAmazonAuroraOutput_1_in.orionConnectExternalId == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															3,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_1
													.setInt(3,
															row_tAmazonAuroraOutput_1_in.orionConnectExternalId);
										}

										if (row_tAmazonAuroraOutput_1_in.orionEclipseFirmId == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															4,
															java.sql.Types.INTEGER);
										...
										if (row_tAmazonAuroraOutput_1_in.orionEclipseName == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															7,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_1
													.setString(
															7,
															row_tAmazonAuroraOutput_1_in.orionEclipseName);
										}

										if (row_tAmazonAuroraOutput_1_in.custodialCash == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															8,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_1
													.setFloat(
															8,
															row_tAmazonAuroraOutput_1_in.custodialCash);
										}

										if (row_tAmazonAuroraOutput_1_in.assetCategoryId == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															9,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_1
													.setInt(9,
															row_tAmazonAuroraOutput_1_in.assetCategoryId);
										}

										if (row_tAmazonAuroraOutput_1_in.assetClassId == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															10,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_1
													.setInt(10,
															row_tAmazonAuroraOutput_1_in.assetClassId);
										}

										if (row_tAmazonAuroraOutput_1_in.assetSubClassId == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															11,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_1
													.setInt(11,
															row_tAmazonAuroraOutput_1_in.assetSubClassId);
										}

										pstmt_tAmazonAuroraOutput_1
												.setInt(12,
														row_tAmazonAuroraOutput_1_in.securityTypeId);

										if (row_tAmazonAuroraOutput_1_in.statusId == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															13,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_1
													.setInt(13,
															row_tAmazonAuroraOutput_1_in.statusId);
										}

										if (row_tAmazonAuroraOutput_1_in.isCustodialCash == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															14,
															java.sql.Types.BOOLEAN);
											...
											pstmt_tAmazonAuroraOutput_1
													.setBoolean(
															14,
															row_tAmazonAuroraOutput_1_in.isCustodialCash);
										}
									...
									} // End of branch "firm_security_output"

									// Start of branch "noDataFound_joinReject5"
									if (noDataFound_joinReject5 != null) {
										...
										row_tAmazonAuroraOutput_6_in = noDataFound_joinReject5;
										...
										if (row_tAmazonAuroraOutput_6_in.name == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															4,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															4,
															row_tAmazonAuroraOutput_6_in.name);
										}

										if (row_tAmazonAuroraOutput_6_in.price == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															5,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_6
													.setFloat(
															5,
															row_tAmazonAuroraOutput_6_in.price);
										}

										if (row_tAmazonAuroraOutput_6_in.securityType == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															6,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															6,
															row_tAmazonAuroraOutput_6_in.securityType);
										}

										if (row_tAmazonAuroraOutput_6_in.assetCategory == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															7,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															7,
															row_tAmazonAuroraOutput_6_in.assetCategory);
										}

										if (row_tAmazonAuroraOutput_6_in.assetClass == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															8,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															8,
															row_tAmazonAuroraOutput_6_in.assetClass);
										}

										if (row_tAmazonAuroraOutput_6_in.subClass == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															9,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_6
													.setString(
															9,
															row_tAmazonAuroraOutput_6_in.subClass);
										}

										if (row_tAmazonAuroraOutput_6_in.maturityDate != null) {
											date_tAmazonAuroraOutput_6 = row_tAmazonAuroraOutput_6_in.maturityDate
													.getTime();
										...
										if (row_tAmazonAuroraOutput_6_in.IsCustodialCash == null) {
											pstmt_tAmazonAuroraOutput_6
													.setNull(
															11,
															java.sql.Types.BOOLEAN);
											...
											pstmt_tAmazonAuroraOutput_6
													.setBoolean(
															11,
															row_tAmazonAuroraOutput_6_in.IsCustodialCash);
										}
									...
									} // End of branch "noDataFound_joinReject5"
	...
	public static class row_tAmazonAuroraOutput_2_inStruct implements
		...
		public java.util.Date priceDateTime;

		public java.util.Date getPriceDateTime() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport) {
				...
				try {
					...
					this.priceType = readString(dis);

					this.priceDateTime = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.priceType, dos);

				// java.util.Date

				writeDate(this.priceDateTime, dos);
		...
		public String toString() {
			...
			sb.append(",priceDateTime=" + String.valueOf(priceDateTime));
			sb.append(",isDeleted=" + String.valueOf(isDeleted));
			sb.append(",createdDate=" + String.valueOf(createdDate));
			sb.append(",createdBy=" + String.valueOf(createdBy));
			sb.append(",editedDate=" + String.valueOf(editedDate));
	...
	public static class firm_securityPrice_outputStruct implements
			routines.system.IPersistableRow<firm_securityPrice_outputStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmSecurityImport = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final firm_securityPrice_outputStruct other = (firm_securityPrice_outputStruct) obj;
		...
		public void copyDataTo(firm_securityPrice_outputStruct other) {
		...
		public void copyKeysDataTo(firm_securityPrice_outputStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(firm_securityPrice_outputStruct other) {
	...
	public void tAmazonAuroraInput_12_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				firm_securityPrice_outputStruct firm_securityPrice_output = new firm_securityPrice_outputStruct();
				firm_securityPrice_outputStruct row_tAmazonAuroraOutput_2_in = firm_securityPrice_output;
				...
				String tableName_tAmazonAuroraOutput_2 = "securityPrice";
				...
				String insert_tAmazonAuroraOutput_2 = "INSERT INTO `"
						+ "securityPrice"
						+ "` (`id`,`securityId`,`price`,`priceType`,`priceDateTime`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?,?)";
				...
				// ###############################
				// # Outputs initialization
				firm_securityPrice_outputStruct firm_securityPrice_output_tmp = new firm_securityPrice_outputStruct();
				// ###############################
				...
				String dbquery_tAmazonAuroraInput_12_in = "select distinct OrionFirmId from security_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_12_in.next()) {
						...
						if (!rejectedInnerJoin_tMap_8) { // G_TM_M_020
							...
							row17HashKey.orionConnectFirmId = row16.OrionFirmId;
						...
						{ // start of Var scope
							...
							copyOfs_tmp.OrionFirmId = row16.OrionFirmId;
							copyOfs_tmp.orionEclipseFirmName = row17.orionEclipseFirmName;
							copyOfs = copyOfs_tmp;
							// ###############################
						...
						if (copyOfs != null) {
							...
							if (!rejectedInnerJoin_tMap_9) { // G_TM_M_020
								...
								row18HashKey.firm = copyOfs.orionEclipseFirmName;
							...
							if (copyOfmainout != null) {
								...
								while ((tHash_Lookup_row6 != null && tHash_Lookup_row6
									...
									if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
										...
										row8HashKey.orionConnectExternalId = row6.externalId;
									...
									if (tHash_Lookup_row8 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.orionConnectExternalId = '"
										// + row8HashKey.orionConnectExternalId
										// + "'");
									} // G 071
									...
									{ // start of Var scope
										...
										firm_securityPrice_output = null;

										if (!rejectedInnerJoin_tMap_3) {

											// # Output table :
											// 'firm_securityPrice_output'
											firm_securityPrice_output_tmp.id = 0;
											firm_securityPrice_output_tmp.securityId = row8.id;
											firm_securityPrice_output_tmp.price = row6.price;
											firm_securityPrice_output_tmp.priceType = null;
											firm_securityPrice_output_tmp.priceDateTime = TalendDate
													.getCurrentDate();
											firm_securityPrice_output_tmp.isDeleted = null;
											firm_securityPrice_output_tmp.createdDate = TalendDate
													.getCurrentDate();
											firm_securityPrice_output_tmp.createdBy = 1;
											firm_securityPrice_output_tmp.editedDate = TalendDate
													.getCurrentDate();
											firm_securityPrice_output_tmp.editedBy = 1;
											firm_securityPrice_output = firm_securityPrice_output_tmp;
										} // closing inner join bracket (2)
											// ###############################
									...
									// Start of branch
									// "firm_securityPrice_output"
									if (firm_securityPrice_output != null) {
										...
										row_tAmazonAuroraOutput_2_in = firm_securityPrice_output;
										...
										if (row_tAmazonAuroraOutput_2_in.priceType == null) {
											pstmt_tAmazonAuroraOutput_2
													.setNull(
															4,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_2
													.setString(
															4,
															row_tAmazonAuroraOutput_2_in.priceType);
										}

										if (row_tAmazonAuroraOutput_2_in.priceDateTime != null) {
											date_tAmazonAuroraOutput_2 = row_tAmazonAuroraOutput_2_in.priceDateTime
													.getTime();
	...
	public void tAmazonAuroraInput_10_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_10_inStruct row13 = row_tAmazonAuroraInput_10_in;
				...
				// inputs:(row_tAmazonAuroraInput_10_in) outputs:(row13,row13) |
				// target node:tAdvancedHash_row13 - inputs:(row13) outputs:()
				// linked node: tMap_6 - inputs:(row12,row13) outputs:(s)
				...
				String dbquery_tAmazonAuroraInput_10_in = "select orionConnectFirmId , orionEclipseFirmName from firm";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_10_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_10_in < 1) {
							row_tAmazonAuroraInput_10_in.orionConnectFirmId = null;
						} else {

							if (rs_tAmazonAuroraInput_10_in.getObject(1) != null) {
								row_tAmazonAuroraInput_10_in.orionConnectFirmId = rs_tAmazonAuroraInput_10_in
										.getInt(1);
							} else {
								row_tAmazonAuroraInput_10_in.orionConnectFirmId = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_10_in < 2) {
							row_tAmazonAuroraInput_10_in.orionEclipseFirmName = null;
						} else {

							row_tAmazonAuroraInput_10_in.orionEclipseFirmName = routines.system.JDBCUtil
						...
						row13 = row_tAmazonAuroraInput_10_in;
						...
						row13_HashRow.orionEclipseFirmName = row13.orionEclipseFirmName;
	...
	public static class row_tAmazonAuroraInput_5_inStruct implements
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final row_tAmazonAuroraInput_5_inStruct other = (row_tAmazonAuroraInput_5_inStruct) obj;
		...
		public void copyDataTo(row_tAmazonAuroraInput_5_inStruct other) {
		...
		public void copyKeysDataTo(row_tAmazonAuroraInput_5_inStruct other) {
	...
	public void tAmazonAuroraInput_5_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_5_inStruct row2 = row_tAmazonAuroraInput_5_in;
				...
				// inputs:(row_tAmazonAuroraInput_5_in) outputs:(row2,row2) |
				// target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
				// linked node: tMap_2 -
				// inputs:(mainout,row2,row9,row10,row11,row1,row15)
				// outputs:(ErrorReject,firm_security_output,noDataFound_joinReject5)
				...
				String dbquery_tAmazonAuroraInput_5_in = "select id , name from assetCategory";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_5_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 1) {
							row_tAmazonAuroraInput_5_in.id = 0;
						} else {
						...
						row2 = row_tAmazonAuroraInput_5_in;
	...
	public static class row_tAmazonAuroraInput_7_inStruct implements
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final row_tAmazonAuroraInput_7_inStruct other = (row_tAmazonAuroraInput_7_inStruct) obj;
		...
		public void copyDataTo(row_tAmazonAuroraInput_7_inStruct other) {
		...
		public void copyKeysDataTo(row_tAmazonAuroraInput_7_inStruct other) {
	...
	public void tAmazonAuroraInput_7_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_7_inStruct row9 = row_tAmazonAuroraInput_7_in;
				...
				// inputs:(row_tAmazonAuroraInput_7_in) outputs:(row9,row9) |
				...
				String dbquery_tAmazonAuroraInput_7_in = "select id , name from assetClass";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_7_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_7_in < 1) {
							row_tAmazonAuroraInput_7_in.id = 0;
						} else {
						...
						row9 = row_tAmazonAuroraInput_7_in;
	...
	public void tAmazonAuroraInput_8_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_8_inStruct row10 = row_tAmazonAuroraInput_8_in;
				...
				// inputs:(row_tAmazonAuroraInput_8_in) outputs:(row10,row10) |
				...
				String dbquery_tAmazonAuroraInput_8_in = "select id , name from assetSubClass";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_8_in.next()) {
						...
						row10 = row_tAmazonAuroraInput_8_in;
	...
	public void tAmazonAuroraInput_2_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_2_inStruct row11 = row_tAmazonAuroraInput_2_in;
				...
				// inputs:(row_tAmazonAuroraInput_2_in) outputs:(row11,row11) |
				...
				try {
					...
					while (rs_tAmazonAuroraInput_2_in.next()) {
						...
						row11 = row_tAmazonAuroraInput_2_in;
						...
						row11_HashRow.orionConnectFirmId = row11.orionConnectFirmId;

						row11_HashRow.orionEclipseFirmId = row11.orionEclipseFirmId;
	...
	public void tAmazonAuroraInput_3_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tAmazonAuroraInput_3_in = "select * from security_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_3_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 5) {
							...
							if (rs_tAmazonAuroraInput_3_in.getObject(5) != null) {
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 6) {
							row_tAmazonAuroraInput_3_in.securityType = null;
						} else {

							row_tAmazonAuroraInput_3_in.securityType = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 6,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_3_in < 7) {
							row_tAmazonAuroraInput_3_in.assetCategory = null;
						} else {

							row_tAmazonAuroraInput_3_in.assetCategory = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 7,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_3_in < 8) {
							row_tAmazonAuroraInput_3_in.assetClass = null;
						} else {

							row_tAmazonAuroraInput_3_in.assetClass = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 8,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_3_in < 9) {
							row_tAmazonAuroraInput_3_in.subClass = null;
						} else {

							row_tAmazonAuroraInput_3_in.subClass = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_3_in, 9,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_3_in < 10) {
							row_tAmazonAuroraInput_3_in.maturityDate = null;
						} else {

							if (rs_tAmazonAuroraInput_3_in.getString(10) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_3_in)) {
									row_tAmazonAuroraInput_3_in.maturityDate = rs_tAmazonAuroraInput_3_in
											.getTimestamp(10);
								} else {
									row_tAmazonAuroraInput_3_in.maturityDate = (java.util.Date) year0_tAmazonAuroraInput_3_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_3_in.maturityDate = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_3_in < 11) {
							row_tAmazonAuroraInput_3_in.IsCustodialCash = null;
						} else {

							if (rs_tAmazonAuroraInput_3_in.getObject(11) != null) {
								row_tAmazonAuroraInput_3_in.IsCustodialCash = rs_tAmazonAuroraInput_3_in
										.getBoolean(11);
							} else {
								row_tAmazonAuroraInput_3_in.IsCustodialCash = null;
							}
						...
						row1_HashRow.securityType = row1.securityType;

						row1_HashRow.assetCategory = row1.assetCategory;

						row1_HashRow.assetClass = row1.assetClass;

						row1_HashRow.subClass = row1.subClass;

						row1_HashRow.maturityDate = row1.maturityDate;

						row1_HashRow.IsCustodialCash = row1.IsCustodialCash;
	...
	public void tAmazonAuroraInput_11_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_11_inStruct row15 = row_tAmazonAuroraInput_11_in;
				...
				// inputs:(row_tAmazonAuroraInput_11_in) outputs:(row15,row15) |
				...
				String dbquery_tAmazonAuroraInput_11_in = "select id , name from securityType";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_11_in.next()) {
						...
						row15 = row_tAmazonAuroraInput_11_in;
	...
	public void tAmazonAuroraInput_13_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_13_inStruct row17 = row_tAmazonAuroraInput_13_in;
				...
				// inputs:(row_tAmazonAuroraInput_13_in) outputs:(row17,row17) |
				// target node:tAdvancedHash_row17 - inputs:(row17) outputs:()
				// linked node: tMap_8 - inputs:(row16,row17) outputs:(copyOfs)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_13_in.next()) {
						...
						row17 = row_tAmazonAuroraInput_13_in;
	...
	public void tAmazonAuroraInput_6_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// inputs:(row_tAmazonAuroraInput_6_in) outputs:(row8,row8) |
				// target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
				// linked node: tMap_3 - inputs:(copyOfmainout,row8,row6)
				// outputs:(firm_securityPrice_output)
				...
				String dbquery_tAmazonAuroraInput_6_in = "select id,orionConnectExternalId  from security";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_6_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 2) {
							row_tAmazonAuroraInput_6_in.orionConnectExternalId = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(2) != null) {
								row_tAmazonAuroraInput_6_in.orionConnectExternalId = rs_tAmazonAuroraInput_6_in
										.getInt(2);
							} else {
								row_tAmazonAuroraInput_6_in.orionConnectExternalId = null;
							}
						...
						row8_HashRow.orionConnectExternalId = row8.orionConnectExternalId;
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tAmazonAuroraInput_4_in = "select OrionFirmId , externalId , price from security_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_4_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_4_in < 3) {
							row_tAmazonAuroraInput_4_in.price = null;
						} else {

							if (rs_tAmazonAuroraInput_4_in.getObject(3) != null) {
								row_tAmazonAuroraInput_4_in.price = rs_tAmazonAuroraInput_4_in
										.getFloat(3);
							} else {
								row_tAmazonAuroraInput_4_in.price = null;
							}
	...
	public static void main(String[] args) {
		final FirmSecurityImport FirmSecurityImportClass = new FirmSecurityImport();

		int exitCode = FirmSecurityImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FirmSecurityImport.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/firmsecurityimport_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : FirmSecurityImport");
		}
...
/************************************************************************************************
 * 668916 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:18 PM IST
 ************************************************************************************************/
