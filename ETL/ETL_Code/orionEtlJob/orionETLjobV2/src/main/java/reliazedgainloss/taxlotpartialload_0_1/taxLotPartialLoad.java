...
package reliazedgainloss.taxlotpartialload_0_1;
...
/**
 * Job: taxLotPartialLoad Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class taxLotPartialLoad implements TalendJob {
	...
	private final String jobName = "taxLotPartialLoad";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					taxLotPartialLoad.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(taxLotPartialLoad.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_taxLotPartialLoad = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_taxLotPartialLoad = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_taxLotPartialLoad.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_taxLotPartialLoad.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_taxLotPartialLoad = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_taxLotPartialLoad = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_taxLotPartialLoad, 0,
						length);
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_taxLotPartialLoad) {
	...
	public void tJavaRow_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// source node:tJavaRow_3 - inputs:(after_tAmazonAuroraInput_4)
				// outputs:(row9_0,row9_0) | target node:tAdvancedHash_row9_0 -
				// inputs:(row9_0) outputs:()
				// linked node: tMap_9 - inputs:(s,row9_0)
	...
	public static class firm_tax_lot_outputStruct implements
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final firm_tax_lot_outputStruct other = (firm_tax_lot_outputStruct) obj;
		...
		public void copyDataTo(firm_tax_lot_outputStruct other) {
		...
		public void copyKeysDataTo(firm_tax_lot_outputStruct other) {
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				firm_tax_lot_outputStruct row_tAmazonAuroraOutput_8_in = firm_tax_lot_output;
				noDataFound_TaxlotStruct noDataFound_Taxlot = new noDataFound_TaxlotStruct();
				noDataFound_TaxlotStruct row_tAmazonAuroraOutput_7_in = noDataFound_Taxlot;
				...
				String tableName_tAmazonAuroraOutput_5 = "importError_TaxLot";
				...
				int commitEvery_tAmazonAuroraOutput_5 = 100000;
				...
				int batchSize_tAmazonAuroraOutput_5 = 100000;
				...
				String tableName_tAmazonAuroraOutput_8 = "taxlot";
				...
				int commitEvery_tAmazonAuroraOutput_8 = 100000;
				int commitCounter_tAmazonAuroraOutput_8 = 0;

				int count_tAmazonAuroraOutput_8 = 0;

				String insertIgnore_tAmazonAuroraOutput_8 = "INSERT IGNORE INTO `"
						+ "taxlot"
						+ "` (`accountId`,`securityId`,`orionFirmId`,`externalId`,`orionEclipseFirmId`,`dateAcquired`,`quantity`,`costAmount`,`costPerShare`,`price`,`marketValue`,`priceDate`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `accountId` = ?,`securityId` = ?,`orionFirmId` = ?,`orionEclipseFirmId` = ?,`dateAcquired` = ?,`quantity` = ?,`costAmount` = ?,`costPerShare` = ?,`price` = ?,`marketValue` = ?,`priceDate` = ?,`isDeleted` = ?,`createdDate` = ?,`createdBy` = ?,`editedDate` = ?,`editedBy` = ?";
				java.sql.PreparedStatement pstmt_tAmazonAuroraOutput_8 = conn_tAmazonAuroraOutput_8
						.prepareStatement(insertIgnore_tAmazonAuroraOutput_8);
				...
				String tableName_tAmazonAuroraOutput_7 = "noDataFound_TaxLot";
				...
				int commitEvery_tAmazonAuroraOutput_7 = 100000;
				...
				int batchSize_tAmazonAuroraOutput_7 = 100000;
				...
				String dbquery_tAmazonAuroraInput_4_in = "select distinct OrionFirmId from taxLots_"
						...
						if (s != null) {
							...
							if (mainout != null) {
								...
								if (!rejectedInnerJoin_tMap_7) { // G_TM_M_020
									...
									row5HashKey.orionFirmId = mainout.firm;
								...
								while ((tHash_Lookup_row5 != null && tHash_Lookup_row5
									...
									if (!rejectedInnerJoin_tMap_7) { // G_TM_M_020
										...
										row13HashKey.symbol = row5.symbol;
									...
									while ((tHash_Lookup_row13 != null && tHash_Lookup_row13
										...
										if (!rejectedInnerJoin_tMap_7) { // G_TM_M_020
											...
											row8HashKey.accountId = row5.accountId;
										...
										while ((tHash_Lookup_row8 != null && tHash_Lookup_row8
											...
											if (!rejectedInnerJoin_tMap_7) { // G_TM_M_020
												...
												row3HashKey.orionConnectFirmId = row5.orionFirmId;
											...
											if (tHash_Lookup_row3 != null
												...
												// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.orionConnectFirmId = '"
												// +
												// row3HashKey.orionConnectFirmId
												// + "'");
											} // G 071
											...
											try {
												...
												{ // start of Var scope
													...
													if (!rejectedInnerJoin_tMap_7) {
														...
														// # Output table :
														// 'firm_tax_lot_output'
														firm_tax_lot_output_tmp.accountId = row8.id;
														firm_tax_lot_output_tmp.securityId = row13.id;
														firm_tax_lot_output_tmp.orionFirmId = row5.orionFirmId;
														firm_tax_lot_output_tmp.externalId = row5.externalId;
														firm_tax_lot_output_tmp.orionEclipseFirmId = row3.orionEclipseFirmId;
														firm_tax_lot_output_tmp.dateAcquired = row5.dateAcquired;
														firm_tax_lot_output_tmp.quantity = row5.quantity;
														firm_tax_lot_output_tmp.costAmount = row5.costAmount;
														firm_tax_lot_output_tmp.costPerShare = row5.costPerShare;
														firm_tax_lot_output_tmp.price = row5.price;
														firm_tax_lot_output_tmp.marketValue = row5.marketValue;
														firm_tax_lot_output_tmp.priceDate = row5.priceDate;
													...
													// # Filter conditions
													if (rejectedInnerJoin_tMap_7) {
														noDataFound_Taxlot_tmp.orionFirmId = row5.orionFirmId;
														noDataFound_Taxlot_tmp.externalId = row5.externalId;
														noDataFound_Taxlot_tmp.accountId = row5.accountId;
														noDataFound_Taxlot_tmp.symbol = row5.symbol;
														noDataFound_Taxlot_tmp.accountNumber = row5.accountNumber;
														noDataFound_Taxlot_tmp.dateAcquired = row5.dateAcquired;
														noDataFound_Taxlot_tmp.quantity = row5.quantity;
														noDataFound_Taxlot_tmp.costAmount = row5.costAmount;
														noDataFound_Taxlot_tmp.costPerShare = row5.costPerShare;
														noDataFound_Taxlot_tmp.price = row5.price;
														noDataFound_Taxlot_tmp.marketValue = row5.marketValue;
														noDataFound_Taxlot_tmp.priceDate = row5.priceDate;
												...
												try {// EE
													...
													ErrorReject_tmp.orionFirmId = row5.orionFirmId;
													ErrorReject_tmp.externalId = row5.externalId;
													ErrorReject_tmp.accountId = row5.accountId;
													ErrorReject_tmp.symbol = row5.symbol;
													ErrorReject_tmp.accountNumber = row5.accountNumber;
													ErrorReject_tmp.dateAcquired = row5.dateAcquired;
													ErrorReject_tmp.quantity = row5.quantity;
													ErrorReject_tmp.costAmount = row5.costAmount;
													ErrorReject_tmp.costPerShare = row5.costPerShare;
													ErrorReject_tmp.price = row5.price;
													ErrorReject_tmp.marketValue = row5.marketValue;
													ErrorReject_tmp.priceDate = row5.priceDate;
											...
											if (ErrorReject != null) {
												...
												if (row_tAmazonAuroraOutput_5_in.dateAcquired != null) {
													date_tAmazonAuroraOutput_5 = row_tAmazonAuroraOutput_5_in.dateAcquired
															.getTime();
												...
												if (row_tAmazonAuroraOutput_5_in.costPerShare == null) {
													pstmt_tAmazonAuroraOutput_5
															.setNull(
																	11,
																	java.sql.Types.FLOAT);
													...
													pstmt_tAmazonAuroraOutput_5
															.setFloat(
																	11,
																	row_tAmazonAuroraOutput_5_in.costPerShare);
												}
												...
												if (row_tAmazonAuroraOutput_5_in.marketValue == null) {
													pstmt_tAmazonAuroraOutput_5
															.setNull(
																	13,
																	java.sql.Types.FLOAT);
													...
													pstmt_tAmazonAuroraOutput_5
															.setFloat(
																	13,
																	row_tAmazonAuroraOutput_5_in.marketValue);
												}

												if (row_tAmazonAuroraOutput_5_in.priceDate != null) {
													date_tAmazonAuroraOutput_5 = row_tAmazonAuroraOutput_5_in.priceDate
															.getTime();
													if (date_tAmazonAuroraOutput_5 < year1_tAmazonAuroraOutput_5
															|| date_tAmazonAuroraOutput_5 >= year10000_tAmazonAuroraOutput_5) {
														pstmt_tAmazonAuroraOutput_5
											...
											if (firm_tax_lot_output != null) {
												...
												row_tAmazonAuroraOutput_8_in = firm_tax_lot_output;
												...
												if (row_tAmazonAuroraOutput_8_in.securityId == null) {
													pstmt_tAmazonAuroraOutput_8
															.setNull(
																	2,
																	java.sql.Types.INTEGER);
													...
													pstmt_tAmazonAuroraOutput_8
															.setInt(2,
																	row_tAmazonAuroraOutput_8_in.securityId);
												}

												if (row_tAmazonAuroraOutput_8_in.orionFirmId == null) {
													pstmt_tAmazonAuroraOutput_8
															.setNull(
																	3,
																	java.sql.Types.INTEGER);
													...
													pstmt_tAmazonAuroraOutput_8
															.setInt(3,
																	row_tAmazonAuroraOutput_8_in.orionFirmId);
												}

												pstmt_tAmazonAuroraOutput_8
														.setInt(4,
																row_tAmazonAuroraOutput_8_in.externalId);

												pstmt_tAmazonAuroraOutput_8
														.setInt(5,
																row_tAmazonAuroraOutput_8_in.orionEclipseFirmId);

												if (row_tAmazonAuroraOutput_8_in.dateAcquired != null) {
													date_tAmazonAuroraOutput_8 = row_tAmazonAuroraOutput_8_in.dateAcquired
															.getTime();
												...
												pstmt_tAmazonAuroraOutput_8
														.setFloat(
																7,
																row_tAmazonAuroraOutput_8_in.quantity);

												pstmt_tAmazonAuroraOutput_8
														.setFloat(
																8,
																row_tAmazonAuroraOutput_8_in.costAmount);

												pstmt_tAmazonAuroraOutput_8
														.setFloat(
																9,
																row_tAmazonAuroraOutput_8_in.costPerShare);

												pstmt_tAmazonAuroraOutput_8
														.setFloat(
																10,
																row_tAmazonAuroraOutput_8_in.price);

												pstmt_tAmazonAuroraOutput_8
														.setFloat(
																11,
																row_tAmazonAuroraOutput_8_in.marketValue);

												if (row_tAmazonAuroraOutput_8_in.priceDate != null) {
													date_tAmazonAuroraOutput_8 = row_tAmazonAuroraOutput_8_in.priceDate
															.getTime();
													if (date_tAmazonAuroraOutput_8 < year1_tAmazonAuroraOutput_8
															|| date_tAmazonAuroraOutput_8 >= year10000_tAmazonAuroraOutput_8) {
														pstmt_tAmazonAuroraOutput_8
												...
												int count_on_duplicate_key_tAmazonAuroraOutput_8 = 0;
												try {
													count_on_duplicate_key_tAmazonAuroraOutput_8 = pstmt_tAmazonAuroraOutput_8
															.executeUpdate();
												} catch (java.lang.Exception e) {
													whetherReject_tAmazonAuroraOutput_8 = true;
													System.err.print(e
															.getMessage());
												}
												if (count_on_duplicate_key_tAmazonAuroraOutput_8 == 1) {
													insertedCount_tAmazonAuroraOutput_8 += count_on_duplicate_key_tAmazonAuroraOutput_8;
												} else {
													insertedCount_tAmazonAuroraOutput_8 += 1;
													updatedCount_tAmazonAuroraOutput_8 += count_on_duplicate_key_tAmazonAuroraOutput_8 - 1;
												}
											...
											if (noDataFound_Taxlot != null) {
												...
												row_tAmazonAuroraOutput_7_in = noDataFound_Taxlot;
												...
												if (row_tAmazonAuroraOutput_7_in.dateAcquired != null) {
													date_tAmazonAuroraOutput_7 = row_tAmazonAuroraOutput_7_in.dateAcquired
															.getTime();
												...
												if (row_tAmazonAuroraOutput_7_in.costAmount == null) {
													pstmt_tAmazonAuroraOutput_7
															.setNull(
																	8,
																	java.sql.Types.FLOAT);
													...
													pstmt_tAmazonAuroraOutput_7
															.setFloat(
																	8,
																	row_tAmazonAuroraOutput_7_in.costAmount);
												}

												if (row_tAmazonAuroraOutput_7_in.costPerShare == null) {
													pstmt_tAmazonAuroraOutput_7
															.setNull(
																	9,
																	java.sql.Types.FLOAT);
													...
													pstmt_tAmazonAuroraOutput_7
															.setFloat(
																	9,
																	row_tAmazonAuroraOutput_7_in.costPerShare);
												}

												if (row_tAmazonAuroraOutput_7_in.price == null) {
													pstmt_tAmazonAuroraOutput_7
															.setNull(
																	10,
																	java.sql.Types.FLOAT);
													...
													pstmt_tAmazonAuroraOutput_7
															.setFloat(
																	10,
																	row_tAmazonAuroraOutput_7_in.price);
												}

												if (row_tAmazonAuroraOutput_7_in.marketValue == null) {
													pstmt_tAmazonAuroraOutput_7
															.setNull(
																	11,
																	java.sql.Types.FLOAT);
													...
													pstmt_tAmazonAuroraOutput_7
															.setFloat(
																	11,
																	row_tAmazonAuroraOutput_7_in.marketValue);
												}

												if (row_tAmazonAuroraOutput_7_in.priceDate != null) {
													date_tAmazonAuroraOutput_7 = row_tAmazonAuroraOutput_7_in.priceDate
															.getTime();
													if (date_tAmazonAuroraOutput_7 < year1_tAmazonAuroraOutput_7
															|| date_tAmazonAuroraOutput_7 >= year10000_tAmazonAuroraOutput_7) {
														pstmt_tAmazonAuroraOutput_7
	...
	public void tAmazonAuroraInput_6_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_6_inStruct row5 = row_tAmazonAuroraInput_6_in;
				...
				// inputs:(row_tAmazonAuroraInput_6_in) outputs:(row5,row5) |
				// target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
				// linked node: tMap_7 - inputs:(mainout,row5,row8,row13,row3)
				...
				String dbquery_tAmazonAuroraInput_6_in = "select OrionFirmId , ExternalId , AccountId , Symbol , AccountNumber , DateAcquired , Quantity , CostAmount , CostPerShare  , Price ,  MarketValue , PriceDate  from taxLots_"
						+ context.firmId
						+ "_"
						+ context.date
						+ " where id >= 1";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_6_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 4) {
							row_tAmazonAuroraInput_6_in.symbol = null;
						} else {

							row_tAmazonAuroraInput_6_in.symbol = routines.system.JDBCUtil
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 6) {
							row_tAmazonAuroraInput_6_in.dateAcquired = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getString(6) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_6_in)) {
									row_tAmazonAuroraInput_6_in.dateAcquired = rs_tAmazonAuroraInput_6_in
											.getTimestamp(6);
								} else {
									row_tAmazonAuroraInput_6_in.dateAcquired = (java.util.Date) year0_tAmazonAuroraInput_6_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_6_in.dateAcquired = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 7) {
							row_tAmazonAuroraInput_6_in.quantity = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(7) != null) {
								row_tAmazonAuroraInput_6_in.quantity = rs_tAmazonAuroraInput_6_in
										.getFloat(7);
							} else {
								row_tAmazonAuroraInput_6_in.quantity = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 8) {
							row_tAmazonAuroraInput_6_in.costAmount = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(8) != null) {
								row_tAmazonAuroraInput_6_in.costAmount = rs_tAmazonAuroraInput_6_in
										.getFloat(8);
							} else {
								row_tAmazonAuroraInput_6_in.costAmount = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 9) {
							row_tAmazonAuroraInput_6_in.costPerShare = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(9) != null) {
								row_tAmazonAuroraInput_6_in.costPerShare = rs_tAmazonAuroraInput_6_in
										.getFloat(9);
							} else {
								row_tAmazonAuroraInput_6_in.costPerShare = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 10) {
							row_tAmazonAuroraInput_6_in.price = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(10) != null) {
								row_tAmazonAuroraInput_6_in.price = rs_tAmazonAuroraInput_6_in
										.getFloat(10);
							} else {
								row_tAmazonAuroraInput_6_in.price = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 11) {
							row_tAmazonAuroraInput_6_in.marketValue = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(11) != null) {
								row_tAmazonAuroraInput_6_in.marketValue = rs_tAmazonAuroraInput_6_in
										.getFloat(11);
							} else {
								row_tAmazonAuroraInput_6_in.marketValue = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 12) {
							row_tAmazonAuroraInput_6_in.priceDate = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getString(12) != null) {
								String dateString_tAmazonAuroraInput_6_in = rs_tAmazonAuroraInput_6_in
										.getString(12);
								if (!("0000-00-00")
										.equals(dateString_tAmazonAuroraInput_6_in)
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_6_in)) {
									row_tAmazonAuroraInput_6_in.priceDate = rs_tAmazonAuroraInput_6_in
											.getTimestamp(12);
								} else {
									row_tAmazonAuroraInput_6_in.priceDate = (java.util.Date) year0_tAmazonAuroraInput_6_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_6_in.priceDate = null;
						...
						row5 = row_tAmazonAuroraInput_6_in;
						...
						row5_HashRow.dateAcquired = row5.dateAcquired;

						row5_HashRow.quantity = row5.quantity;

						row5_HashRow.costAmount = row5.costAmount;

						row5_HashRow.costPerShare = row5.costPerShare;
	...
	public void tAmazonAuroraInput_7_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_7_inStruct row8 = row_tAmazonAuroraInput_7_in;
				...
				// inputs:(row_tAmazonAuroraInput_7_in) outputs:(row8,row8) |
				...
				String dbquery_tAmazonAuroraInput_7_in = "select id , accountId from account";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_7_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_7_in < 2) {
							row_tAmazonAuroraInput_7_in.accountId = null;
						} else {

							row_tAmazonAuroraInput_7_in.accountId = routines.system.JDBCUtil
						...
						row8 = row_tAmazonAuroraInput_7_in;
	...
	public void tAmazonAuroraInput_8_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_8_inStruct row13 = row_tAmazonAuroraInput_8_in;
				...
				// inputs:(row_tAmazonAuroraInput_8_in) outputs:(row13,row13) |
				...
				String dbquery_tAmazonAuroraInput_8_in = "select  id , symbol from security";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_8_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_8_in < 2) {
							row_tAmazonAuroraInput_8_in.symbol = null;
						} else {

							row_tAmazonAuroraInput_8_in.symbol = routines.system.JDBCUtil
						...
						row13 = row_tAmazonAuroraInput_8_in;
						...
						row13_HashRow.symbol = row13.symbol;
	...
	public void tAmazonAuroraInput_2_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// inputs:(row_tAmazonAuroraInput_2_in) outputs:(row3,row3) |
				...
				try {
					...
					while (rs_tAmazonAuroraInput_2_in.next()) {
						...
						row3_HashRow.orionConnectFirmId = row3.orionConnectFirmId;

						row3_HashRow.orionEclipseFirmId = row3.orionEclipseFirmId;
	...
	public static void main(String[] args) {
		final taxLotPartialLoad taxLotPartialLoadClass = new taxLotPartialLoad();

		int exitCode = taxLotPartialLoadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = taxLotPartialLoad.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/taxlotpartialload_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : taxLotPartialLoad");
		}
...
/************************************************************************************************
 * 473520 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:35 PM IST
 ************************************************************************************************/
