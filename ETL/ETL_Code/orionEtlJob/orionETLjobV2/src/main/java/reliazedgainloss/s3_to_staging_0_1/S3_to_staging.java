...
package reliazedgainloss.s3_to_staging_0_1;
...
/**
 * Job: S3_to_staging Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class S3_to_staging implements TalendJob {
	...
	private final String jobName = "S3_to_staging";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					S3_to_staging.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(S3_to_staging.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.position_local_to_staging_0_1.Position_local_to_staging childJob_tRunJob_1 = new reliazedgainloss.position_local_to_staging_0_1.Position_local_to_staging();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.stgsecurityimport_0_1.StgSecurityImport childJob_tRunJob_2 = new reliazedgainloss.stgsecurityimport_0_1.StgSecurityImport();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.stgtaxlotsimport_0_1.StgTaxLotsImport childJob_tRunJob_3 = new reliazedgainloss.stgtaxlotsimport_0_1.StgTaxLotsImport();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.stgtransactionimport_0_1.StgTransactionImport childJob_tRunJob_4 = new reliazedgainloss.stgtransactionimport_0_1.StgTransactionImport();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.advisor_local_to_staging_0_1.Advisor_local_to_staging childJob_tRunJob_5 = new reliazedgainloss.advisor_local_to_staging_0_1.Advisor_local_to_staging();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.custodianfileimport_0_1.CustodianFileImport childJob_tRunJob_6 = new reliazedgainloss.custodianfileimport_0_1.CustodianFileImport();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.stgaccountimport_0_1.StgAccountImport childJob_tRunJob_7 = new reliazedgainloss.stgaccountimport_0_1.StgAccountImport();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.realizedgainlosslocaltostaging_0_1.RealizedGainLossLocaltoStaging childJob_tRunJob_8 = new reliazedgainloss.realizedgainlosslocaltostaging_0_1.RealizedGainLossLocaltoStaging();
				// pass DataSources
	...
	public static void main(String[] args) {
		final S3_to_staging S3_to_stagingClass = new S3_to_staging();

		int exitCode = S3_to_stagingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = S3_to_staging.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/s3_to_staging_0_1/contexts/"
		...
		new Thread() {
			public void run() {
				...
				} catch (java.lang.Error e_tRunJob_5) {
					globalMap.put("tRunJob_5_SUBPROCESS_STATE", -1);
		...
		new Thread() {
			public void run() {
				...
				} catch (java.lang.Error e_tRunJob_6) {
					globalMap.put("tRunJob_6_SUBPROCESS_STATE", -1);
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : S3_to_staging");
		}
...
/************************************************************************************************
 * 81533 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:33:59 PM IST
 ************************************************************************************************/
