...
package reliazedgainloss.reliazedgainlosspartialload_0_1;
...
/**
 * Job: reliazedgainLossPartialLoad Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class reliazedgainLossPartialLoad implements TalendJob {
	...
	private final String jobName = "reliazedgainLossPartialLoad";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					reliazedgainLossPartialLoad.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(reliazedgainLossPartialLoad.this,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad,
						0, length);
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_reliazedgainLossPartialLoad) {
	...
	public void tStatCatcher_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				statCatcherOutputStruct row_tAmazonAuroraOutput_5_in = statCatcherOutput;
				...
				String tableName_tAmazonAuroraOutput_5 = "statcatcher";
				...
				for (StatCatcherUtils.StatCatcherMessage scm : tStatCatcher_1
					...
					if (statCatcherOutput != null) {
						...
						row_tAmazonAuroraOutput_5_in = statCatcherOutput;
						...
						if (row_tAmazonAuroraOutput_5_in.job_version == null) {
							pstmt_tAmazonAuroraOutput_5.setNull(4,
									java.sql.Types.VARCHAR);
						} else {
							pstmt_tAmazonAuroraOutput_5.setString(4,
									row_tAmazonAuroraOutput_5_in.job_version);
						}
						...
						if (row_tAmazonAuroraOutput_5_in.context == null) {
							...
							pstmt_tAmazonAuroraOutput_5.setString(5,
									row_tAmazonAuroraOutput_5_in.context);
						}

						if (row_tAmazonAuroraOutput_5_in.message_type == null) {
							pstmt_tAmazonAuroraOutput_5.setNull(6,
									java.sql.Types.VARCHAR);
						} else {
							pstmt_tAmazonAuroraOutput_5.setString(6,
									row_tAmazonAuroraOutput_5_in.message_type);
						}
						...
						if (row_tAmazonAuroraOutput_5_in.duration == null) {
							pstmt_tAmazonAuroraOutput_5.setNull(8,
									java.sql.Types.INTEGER);
						} else {
							pstmt_tAmazonAuroraOutput_5.setLong(8,
									row_tAmazonAuroraOutput_5_in.duration);
						}
						...
						if (row_tAmazonAuroraOutput_5_in.firmName == null) {
							...
							pstmt_tAmazonAuroraOutput_5.setString(9,
	...
	public void tLogCatcher_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				logCatcherOutputStruct row_tAmazonAuroraOutput_6_in = logCatcherOutput;
				...
				String tableName_tAmazonAuroraOutput_6 = "logcatcher";
				...
				for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
					...
					if (logCatcherOutput != null) {
						...
						row_tAmazonAuroraOutput_6_in = logCatcherOutput;
						...
						if (row_tAmazonAuroraOutput_6_in.priority == null) {
							pstmt_tAmazonAuroraOutput_6.setNull(5,
									java.sql.Types.INTEGER);
						} else {
							pstmt_tAmazonAuroraOutput_6.setInt(5,
									row_tAmazonAuroraOutput_6_in.priority);
						}
						...
						if (row_tAmazonAuroraOutput_6_in.origin == null) {
							pstmt_tAmazonAuroraOutput_6.setNull(7,
									java.sql.Types.VARCHAR);
						} else {
							pstmt_tAmazonAuroraOutput_6.setString(7,
									row_tAmazonAuroraOutput_6_in.origin);
						}
						...
						if (row_tAmazonAuroraOutput_6_in.message == null) {
							...
							pstmt_tAmazonAuroraOutput_6.setString(8,
									row_tAmazonAuroraOutput_6_in.message);
						}

						if (row_tAmazonAuroraOutput_6_in.code == null) {
							pstmt_tAmazonAuroraOutput_6.setNull(9,
									java.sql.Types.INTEGER);
						} else {
							pstmt_tAmazonAuroraOutput_6.setInt(9,
									row_tAmazonAuroraOutput_6_in.code);
						}

						if (row_tAmazonAuroraOutput_6_in.firmName == null) {
							pstmt_tAmazonAuroraOutput_6.setNull(10,
									java.sql.Types.VARCHAR);
						} else {
							pstmt_tAmazonAuroraOutput_6.setString(10,
	...
	public static class firm_current_reliazedGainLoss_ouputStruct
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final firm_current_reliazedGainLoss_ouputStruct other = (firm_current_reliazedGainLoss_ouputStruct) obj;
		...
		public void copyDataTo(firm_current_reliazedGainLoss_ouputStruct other) {
		...
		public void copyKeysDataTo(
				firm_current_reliazedGainLoss_ouputStruct other) {
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				firm_current_reliazedGainLoss_ouputStruct row_tAmazonAuroraOutput_4_in = firm_current_reliazedGainLoss_ouput;
				JoinRejectStruct JoinReject = new JoinRejectStruct();
				JoinRejectStruct row_tAmazonAuroraOutput_3_in = JoinReject;
				...
				String tableName_tAmazonAuroraOutput_4 = "reliazedgainloss";
				...
				String insertIgnore_tAmazonAuroraOutput_4 = "INSERT IGNORE INTO `"
						+ "reliazedgainloss"
						+ "` (`accountId`,`securityId`,`orionFirmId`,`externalId`,`orionEclipseFirmId`,`grossProceeds`,`netProceeds`,`costAmount`,`dateAcquired`,`sellDate`,`quantity`,`longTerm`,`sellMethod`,`totalGains`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `accountId` = ?,`securityId` = ?,`orionFirmId` = ?,`orionEclipseFirmId` = ?,`grossProceeds` = ?,`netProceeds` = ?,`costAmount` = ?,`dateAcquired` = ?,`sellDate` = ?,`quantity` = ?,`longTerm` = ?,`sellMethod` = ?,`totalGains` = ?,`isDeleted` = ?,`createdDate` = ?,`createdBy` = ?,`editedDate` = ?,`editedBy` = ?";
				java.sql.PreparedStatement pstmt_tAmazonAuroraOutput_4 = conn_tAmazonAuroraOutput_4
						.prepareStatement(insertIgnore_tAmazonAuroraOutput_4);
				...
				String tableName_tAmazonAuroraOutput_3 = "noDataFound_ReliazedGainLoss";
							...
							if (mainout != null) {
								...
								while ((tHash_Lookup_row1 != null && tHash_Lookup_row1
									...
									if (!rejectedInnerJoin_tMap_5) { // G_TM_M_020
										...
										row12HashKey.orionConnectFirmId = row1.OrionFirmId;
									...
									try {
										...
										{ // start of Var scope
											...
											if (!rejectedInnerJoin_tMap_5) {
												...
												firm_current_reliazedGainLoss_ouput_tmp.orionEclipseFirmId = row12.orionEclipseFirmId;
									...
									if (firm_current_reliazedGainLoss_ouput != null) {
										...
										row_tAmazonAuroraOutput_4_in = firm_current_reliazedGainLoss_ouput;
										...
										if (row_tAmazonAuroraOutput_4_in.securityId == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															2,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_4
													.setInt(2,
															row_tAmazonAuroraOutput_4_in.securityId);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.grossProceeds == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															6,
															java.sql.Types.DOUBLE);
											...
											pstmt_tAmazonAuroraOutput_4
													.setDouble(
															6,
															row_tAmazonAuroraOutput_4_in.grossProceeds);
										}

										if (row_tAmazonAuroraOutput_4_in.netProceeds == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															7,
															java.sql.Types.DOUBLE);
											...
											pstmt_tAmazonAuroraOutput_4
													.setDouble(
															7,
															row_tAmazonAuroraOutput_4_in.netProceeds);
										}

										if (row_tAmazonAuroraOutput_4_in.costAmount == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															8,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_4
													.setFloat(
															8,
															row_tAmazonAuroraOutput_4_in.costAmount);
										}

										if (row_tAmazonAuroraOutput_4_in.dateAcquired != null) {
											date_tAmazonAuroraOutput_4 = row_tAmazonAuroraOutput_4_in.dateAcquired
													.getTime();
										...
										if (row_tAmazonAuroraOutput_4_in.sellDate != null) {
											date_tAmazonAuroraOutput_4 = row_tAmazonAuroraOutput_4_in.sellDate
													.getTime();
											if (date_tAmazonAuroraOutput_4 < year1_tAmazonAuroraOutput_4
													|| date_tAmazonAuroraOutput_4 >= year10000_tAmazonAuroraOutput_4) {
												pstmt_tAmazonAuroraOutput_4
										...
										if (row_tAmazonAuroraOutput_4_in.quantity == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															11,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_4
													.setFloat(
															11,
															row_tAmazonAuroraOutput_4_in.quantity);
										}

										if (row_tAmazonAuroraOutput_4_in.longTerm == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															12,
															java.sql.Types.BOOLEAN);
											...
											pstmt_tAmazonAuroraOutput_4
													.setBoolean(
															12,
															row_tAmazonAuroraOutput_4_in.longTerm);
										}

										if (row_tAmazonAuroraOutput_4_in.sellMethod == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															13,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															13,
															row_tAmazonAuroraOutput_4_in.sellMethod);
										}

										if (row_tAmazonAuroraOutput_4_in.totalGains == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															14,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_4
													.setFloat(
															14,
															row_tAmazonAuroraOutput_4_in.totalGains);
										}
										...
										int count_on_duplicate_key_tAmazonAuroraOutput_4 = 0;
										try {
											count_on_duplicate_key_tAmazonAuroraOutput_4 = pstmt_tAmazonAuroraOutput_4
													.executeUpdate();
										} catch (java.lang.Exception e) {
											whetherReject_tAmazonAuroraOutput_4 = true;
											System.err.print(e.getMessage());
										}
										if (count_on_duplicate_key_tAmazonAuroraOutput_4 == 1) {
											insertedCount_tAmazonAuroraOutput_4 += count_on_duplicate_key_tAmazonAuroraOutput_4;
										} else {
											insertedCount_tAmazonAuroraOutput_4 += 1;
											updatedCount_tAmazonAuroraOutput_4 += count_on_duplicate_key_tAmazonAuroraOutput_4 - 1;
										}
									...
									if (JoinReject != null) {
										...
										row_tAmazonAuroraOutput_3_in = JoinReject;
										...
										/**
										 * [tAmazonAuroraOutput_3_out main ]
										 * start
										 */
										...
										if (row_tAmazonAuroraOutput_3_in.GrossProceeds == null) {
											pstmt_tAmazonAuroraOutput_3
													.setNull(
															6,
															java.sql.Types.DOUBLE);
											...
											pstmt_tAmazonAuroraOutput_3
													.setDouble(
															6,
															row_tAmazonAuroraOutput_3_in.GrossProceeds);
										}

										if (row_tAmazonAuroraOutput_3_in.NetProceeds == null) {
											pstmt_tAmazonAuroraOutput_3
													.setNull(
															7,
															java.sql.Types.DOUBLE);
											...
											pstmt_tAmazonAuroraOutput_3
													.setDouble(
															7,
															row_tAmazonAuroraOutput_3_in.NetProceeds);
										}
										...
										if (row_tAmazonAuroraOutput_3_in.DateAquired != null) {
											date_tAmazonAuroraOutput_3 = row_tAmazonAuroraOutput_3_in.DateAquired
													.getTime();
										...
										if (row_tAmazonAuroraOutput_3_in.SellDate != null) {
											date_tAmazonAuroraOutput_3 = row_tAmazonAuroraOutput_3_in.SellDate
													.getTime();
											if (date_tAmazonAuroraOutput_3 < year1_tAmazonAuroraOutput_3
													|| date_tAmazonAuroraOutput_3 >= year10000_tAmazonAuroraOutput_3) {
												pstmt_tAmazonAuroraOutput_3
										...
										if (row_tAmazonAuroraOutput_3_in.LongTerm == null) {
											pstmt_tAmazonAuroraOutput_3
													.setNull(
															12,
															java.sql.Types.BOOLEAN);
											...
											pstmt_tAmazonAuroraOutput_3
													.setBoolean(
															12,
															row_tAmazonAuroraOutput_3_in.LongTerm);
										}

										if (row_tAmazonAuroraOutput_3_in.SellMethod == null) {
											pstmt_tAmazonAuroraOutput_3
													.setNull(
															13,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_3
													.setString(
															13,
															row_tAmazonAuroraOutput_3_in.SellMethod);
										}

										if (row_tAmazonAuroraOutput_3_in.TotalGains == null) {
											pstmt_tAmazonAuroraOutput_3
													.setNull(
															14,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_3
													.setFloat(
															14,
															row_tAmazonAuroraOutput_3_in.TotalGains);
										}
	...
	public void tAmazonAuroraInput_1_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_5 - inputs:(mainout,row1,row11,row2,row12)
	...
	public void tAmazonAuroraInput_8_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_8_inStruct row2 = row_tAmazonAuroraInput_8_in;
				...
				// inputs:(row_tAmazonAuroraInput_8_in) outputs:(row2,row2) |
				...
				try {
					...
					while (rs_tAmazonAuroraInput_8_in.next()) {
						...
						row2 = row_tAmazonAuroraInput_8_in;
	...
	public void tAmazonAuroraInput_9_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tAmazonAuroraInput_9_in = "select orionConnectFirmId , orionEclipseFirmId from firm";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_9_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_9_in < 2) {
							row_tAmazonAuroraInput_9_in.orionEclipseFirmId = null;
						} else {

							if (rs_tAmazonAuroraInput_9_in.getObject(2) != null) {
								row_tAmazonAuroraInput_9_in.orionEclipseFirmId = rs_tAmazonAuroraInput_9_in
										.getInt(2);
							} else {
								row_tAmazonAuroraInput_9_in.orionEclipseFirmId = null;
							}
						...
						row12_HashRow.orionEclipseFirmId = row12.orionEclipseFirmId;
	...
	public static void main(String[] args) {
		final reliazedgainLossPartialLoad reliazedgainLossPartialLoadClass = new reliazedgainLossPartialLoad();

		int exitCode = reliazedgainLossPartialLoadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = reliazedgainLossPartialLoad.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/reliazedgainlosspartialload_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : reliazedgainLossPartialLoad");
		}
...
/************************************************************************************************
 * 495211 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:37 PM IST
 ************************************************************************************************/
