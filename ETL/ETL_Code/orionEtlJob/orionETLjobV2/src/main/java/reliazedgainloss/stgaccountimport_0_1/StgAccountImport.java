...
package reliazedgainloss.stgaccountimport_0_1;
...
/**
 * Job: StgAccountImport Purpose: Staging Account File Import<br>
 * Description: Staging Account File Import <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class StgAccountImport implements TalendJob {
	...
	private final String jobName = "StgAccountImport";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					StgAccountImport.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(StgAccountImport.this, new Object[] { e,
	...
	public static class BulkOutStruct implements
			routines.system.IPersistableRow<BulkOutStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_StgAccountImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_StgAccountImport = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_StgAccountImport.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_StgAccountImport.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_StgAccountImport = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_StgAccountImport = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_StgAccountImport, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_StgAccountImport) {
		 ...
		 * Compare keys
		 */
		public int compareTo(BulkOutStruct other) {
	...
	public static class row1Struct implements
		...
		public String AccountYTDRealizedSTGL;

		public String getAccountYTDRealizedSTGL() {
			return this.AccountYTDRealizedSTGL;
		}

		public String AccountYTDRealizedLTGL;

		public String getAccountYTDRealizedLTGL() {
			return this.AccountYTDRealizedLTGL;
		}
		...
		public String SleeveTarget;

		public String getSleeveTarget() {
			return this.SleeveTarget;
		}

		public String SleeveContributionPercent;

		public String getSleeveContributionPercent() {
			return this.SleeveContributionPercent;
		}

		public String SleeveDistributionPercent;

		public String getSleeveDistributionPercent() {
			return this.SleeveDistributionPercent;
		}

		public String SleeveToleranceLower;

		public String getSleeveToleranceLower() {
			return this.SleeveToleranceLower;
		}

		public String SleeveToleranceUpper;

		public String getSleeveToleranceUpper() {
			return this.SleeveToleranceUpper;
		}
		...
		public String SystematicDate;

		public String getSystematicDate() {
			return this.SystematicDate;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_StgAccountImport) {
				...
				try {
					...
					this.AccountYTDRealizedSTGL = readString(dis);

					this.AccountYTDRealizedLTGL = readString(dis);
					...
					this.SleeveTarget = readString(dis);

					this.SleeveContributionPercent = readString(dis);

					this.SleeveDistributionPercent = readString(dis);

					this.SleeveToleranceLower = readString(dis);

					this.SleeveToleranceUpper = readString(dis);

					this.SMA = readString(dis);
					...
					this.SystematicDate = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.AccountYTDRealizedSTGL, dos);

				// String

				writeString(this.AccountYTDRealizedLTGL, dos);
				...
				writeString(this.SleeveTarget, dos);

				// String

				writeString(this.SleeveContributionPercent, dos);

				// String

				writeString(this.SleeveDistributionPercent, dos);

				// String

				writeString(this.SleeveToleranceLower, dos);

				// String

				writeString(this.SleeveToleranceUpper, dos);

				// String

				writeString(this.SMA, dos);
				...
				writeString(this.SystematicDate, dos);
		...
		public String toString() {
			...
			sb.append(",AccountType=" + AccountType);
			sb.append(",Taxable=" + String.valueOf(Taxable));
			sb.append(",AccountYTDRealizedSTGL=" + AccountYTDRealizedSTGL);
			sb.append(",AccountYTDRealizedLTGL=" + AccountYTDRealizedLTGL);
			sb.append(",SSN=" + SSN);
			sb.append(",SweepSymbol=" + SweepSymbol);
			sb.append(",Custodian=" + Custodian);
			sb.append(",CustodialAccountNumber=" + CustodialAccountNumber);
			...
			sb.append(",AdvisorExternalId=" + String.valueOf(AdvisorExternalId));
			sb.append(",SleeveType=" + SleeveType);
			sb.append(",SleeveTarget=" + SleeveTarget);
			sb.append(",SleeveContributionPercent=" + SleeveContributionPercent);
			sb.append(",SleeveDistributionPercent=" + SleeveDistributionPercent);
			sb.append(",SleeveToleranceLower=" + SleeveToleranceLower);
			sb.append(",SleeveToleranceUpper=" + SleeveToleranceUpper);
			sb.append(",SMA=" + SMA);
			sb.append(",SMATradeable=" + SMATradeable);
			sb.append(",BillingAccount=" + BillingAccount);
			sb.append(",SystematicAmount=" + SystematicAmount);
			sb.append(",SystematicDate=" + SystematicDate);
			sb.append(",HashedSSN=" + HashedSSN);
			sb.append(",sleeveContributionMethod=" + sleeveContributionMethod);
			sb.append(",sleeveStrategyName=" + sleeveStrategyName);
			sb.append(",sleeveDistributionMethod=" + sleeveDistributionMethod);
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				BulkOutStruct BulkOut = new BulkOutStruct();
				...
				java.io.File file_tMysqlOutputBulkExec_1_tMOB = new java.io.File(
						context.pathforlocal + "account_" + context.firmId
								+ "_" + context.date);
				...
				BulkOutStruct BulkOut_tmp = new BulkOutStruct();
				// ###############################
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.localpath + context.accountpath,
								"US-ASCII", "\t", "\n", false, 1, 0, -1, -1,
								false);
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.AccountId = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.AccountNumber = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.AccountName = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.PortfolioId = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.PortfolioName = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								row1.HouseholdId = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row1.HouseholdName = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							row1.AccountType = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.AccountYTDRealizedSTGL = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							row1.AccountYTDRealizedLTGL = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 13;

							row1.SSN = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 14;

							row1.SweepSymbol = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 15;

							row1.Custodian = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							row1.CustodialAccountNumber = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 17;

							row1.AdvisorName = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.AdvisorExternalId = ParserUtils
											.parseTo_Integer(temp);
								...
								row1.AdvisorExternalId = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 19;

							row1.SleeveType = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 20;

							row1.SleeveTarget = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 21;

							row1.SleeveContributionPercent = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 22;

							row1.SleeveDistributionPercent = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 23;

							row1.SleeveToleranceLower = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 24;

							row1.SleeveToleranceUpper = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 25;

							row1.SMA = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 26;

							row1.SMATradeable = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 27;

							row1.BillingAccount = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 28;

							row1.SystematicAmount = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 29;

							row1.SystematicDate = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 30;

							row1.HashedSSN = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 31;

							row1.sleeveContributionMethod = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 32;

							row1.sleeveStrategyName = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 33;

							row1.sleeveDistributionMethod = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.registrationId = ParserUtils
											.parseTo_Integer(temp);
							...
							row3.OrionFirmId = row1.OrionFirmId;

							row3.ExternalId = row1.ExternalId;

							row3.AccountId = row1.AccountId;

							row3.AccountNumber = row1.AccountNumber;

							row3.AccountName = row1.AccountName;

							row3.PortfolioId = row1.PortfolioId;

							row3.PortfolioName = row1.PortfolioName;

							row3.HouseholdId = row1.HouseholdId;

							row3.HouseholdName = row1.HouseholdName;

							row3.AccountType = row1.AccountType;

							row3.Taxable = row1.Taxable;

							row3.AccountYTDRealizedSTGL = row1.AccountYTDRealizedSTGL;

							row3.AccountYTDRealizedLTGL = row1.AccountYTDRealizedLTGL;

							row3.SSN = row1.SSN;

							row3.SweepSymbol = row1.SweepSymbol;

							row3.Custodian = row1.Custodian;

							row3.CustodialAccountNumber = row1.CustodialAccountNumber;

							row3.AdvisorName = row1.AdvisorName;

							row3.AdvisorExternalId = row1.AdvisorExternalId;

							row3.SleeveType = row1.SleeveType;

							row3.SleeveTarget = row1.SleeveTarget;

							row3.SleeveContributionPercent = row1.SleeveContributionPercent;

							row3.SleeveDistributionPercent = row1.SleeveDistributionPercent;

							row3.SleeveToleranceLower = row1.SleeveToleranceLower;

							row3.SleeveToleranceUpper = row1.SleeveToleranceUpper;

							row3.SMA = row1.SMA;

							row3.SMATradeable = row1.SMATradeable;

							row3.BillingAccount = row1.BillingAccount;

							row3.SystematicAmount = row1.SystematicAmount;

							row3.SystematicDate = row1.SystematicDate;

							row3.HashedSSN = row1.HashedSSN;

							row3.sleeveContributionMethod = row1.sleeveContributionMethod;

							row3.sleeveStrategyName = row1.sleeveStrategyName;

							row3.sleeveDistributionMethod = row1.sleeveDistributionMethod;

							row3.registrationId = row1.registrationId;
						...
						if (row1 != null) {
							...
							try {
								row2.OrionFirmId = TypeConvert
										.Integer2Integer(row1.OrionFirmId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row2.ExternalId = TypeConvert
										.Integer2Integer(row1.ExternalId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AccountId)) {
									row1.AccountId = null;
								}
								row2.AccountId = TypeConvert
										.String2String(row1.AccountId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AccountNumber)) {
									row1.AccountNumber = null;
								}
								row2.AccountNumber = TypeConvert
										.String2String(row1.AccountNumber);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AccountName)) {
									row1.AccountName = null;
								}
								row2.AccountName = TypeConvert
										.String2String(row1.AccountName);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.PortfolioId)) {
									row1.PortfolioId = null;
								}
								row2.PortfolioId = TypeConvert
										.String2String(row1.PortfolioId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.PortfolioName)) {
									row1.PortfolioName = null;
								}
								row2.PortfolioName = TypeConvert
										.String2String(row1.PortfolioName);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row2.HouseholdId = TypeConvert
										.Integer2Integer(row1.HouseholdId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.HouseholdName)) {
									row1.HouseholdName = null;
								}
								row2.HouseholdName = TypeConvert
										.String2String(row1.HouseholdName);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AccountType)) {
									row1.AccountType = null;
								}
								row2.AccountType = TypeConvert
										.String2String(row1.AccountType);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row2.Taxable = TypeConvert
										.Integer2Byte(row1.Taxable);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AccountYTDRealizedSTGL)) {
									row1.AccountYTDRealizedSTGL = null;
								}
								row2.AccountYTDRealizedSTGL = TypeConvert
										.String2Float(row1.AccountYTDRealizedSTGL);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AccountYTDRealizedLTGL)) {
									row1.AccountYTDRealizedLTGL = null;
								}
								row2.AccountYTDRealizedLTGL = TypeConvert
										.String2Float(row1.AccountYTDRealizedLTGL);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								...
								row2.SSN = TypeConvert.String2String(row1.SSN);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SweepSymbol)) {
									row1.SweepSymbol = null;
								}
								row2.SweepSymbol = TypeConvert
										.String2String(row1.SweepSymbol);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.Custodian)) {
									row1.Custodian = null;
								}
								row2.Custodian = TypeConvert
										.String2String(row1.Custodian);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.CustodialAccountNumber)) {
									row1.CustodialAccountNumber = null;
								}
								row2.CustodialAccountNumber = TypeConvert
										.String2String(row1.CustodialAccountNumber);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.AdvisorName)) {
									row1.AdvisorName = null;
								}
								row2.AdvisorName = TypeConvert
										.String2String(row1.AdvisorName);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row2.AdvisorExternalId = TypeConvert
										.Integer2Integer(row1.AdvisorExternalId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SleeveType)) {
									row1.SleeveType = null;
								}
								row2.SleeveType = TypeConvert
										.String2String(row1.SleeveType);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SleeveTarget)) {
									row1.SleeveTarget = null;
								}
								row2.SleeveTarget = TypeConvert
										.String2Float(row1.SleeveTarget);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SleeveContributionPercent)) {
									row1.SleeveContributionPercent = null;
								}
								row2.SleeveContributionPercent = TypeConvert
										.String2Float(row1.SleeveContributionPercent);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SleeveDistributionPercent)) {
									row1.SleeveDistributionPercent = null;
								}
								row2.SleeveDistributionPercent = TypeConvert
										.String2Float(row1.SleeveDistributionPercent);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SleeveToleranceLower)) {
									row1.SleeveToleranceLower = null;
								}
								row2.SleeveToleranceLower = TypeConvert
										.String2Float(row1.SleeveToleranceLower);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SleeveToleranceUpper)) {
									row1.SleeveToleranceUpper = null;
								}
								row2.SleeveToleranceUpper = TypeConvert
										.String2Float(row1.SleeveToleranceUpper);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								...
								row2.SMA = TypeConvert.String2Boolean(row1.SMA);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SMATradeable)) {
									row1.SMATradeable = null;
								}
								row2.SMATradeable = TypeConvert
										.String2String(row1.SMATradeable);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.BillingAccount)) {
									row1.BillingAccount = null;
								}
								row2.BillingAccount = TypeConvert
										.String2String(row1.BillingAccount);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SystematicAmount)) {
									row1.SystematicAmount = null;
								}
								row2.SystematicAmount = TypeConvert
										.String2String(row1.SystematicAmount);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.SystematicDate)) {
									row1.SystematicDate = null;
								}
								row2.SystematicDate = TypeConvert.String2Date(
										row1.SystematicDate, "dd-MM-yyyy");
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.HashedSSN)) {
									row1.HashedSSN = null;
								}
								row2.HashedSSN = TypeConvert
										.String2String(row1.HashedSSN);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.sleeveContributionMethod)) {
									row1.sleeveContributionMethod = null;
								}
								row2.sleeveContributionMethod = TypeConvert
										.String2String(row1.sleeveContributionMethod);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.sleeveStrategyName)) {
									row1.sleeveStrategyName = null;
								}
								row2.sleeveStrategyName = TypeConvert
										.String2String(row1.sleeveStrategyName);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								if ("".equals(row1.sleeveDistributionMethod)) {
									row1.sleeveDistributionMethod = null;
								}
								row2.sleeveDistributionMethod = TypeConvert
										.String2String(row1.sleeveDistributionMethod);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							try {
								row2.registrationId = TypeConvert
										.Integer2Integer(row1.registrationId);
							} catch (java.lang.Exception e) {
								bHasError_tConvertType_1 = true;
								System.err.println(e.getMessage());
							}
							...
							if (row2 != null) {
								...
								{ // start of Var scope
									...
									// # Output table : 'BulkOut'
									BulkOut_tmp.OrionFirmId = row2.OrionFirmId;
									BulkOut_tmp.ExternalId = row2.ExternalId;
									BulkOut_tmp.AccountId = row2.AccountId;
									BulkOut_tmp.AccountNumber = row2.AccountNumber;
									BulkOut_tmp.AccountName = row2.AccountName;
									BulkOut_tmp.PortfolioId = row2.PortfolioId;
									BulkOut_tmp.PortfolioName = row2.PortfolioName;
									BulkOut_tmp.HouseholdId = row2.HouseholdId;
									BulkOut_tmp.HouseholdName = row2.HouseholdName;
									BulkOut_tmp.AccountType = row2.AccountType;
									BulkOut_tmp.Taxable = row2.Taxable;
									BulkOut_tmp.AccountYTDRealizedSTGL = row2.AccountYTDRealizedSTGL;
									BulkOut_tmp.AccountYTDRealizedLTGL = row2.AccountYTDRealizedLTGL;
									BulkOut_tmp.SSN = row2.SSN;
									BulkOut_tmp.SweepSymbol = row2.SweepSymbol;
									BulkOut_tmp.Custodian = row2.Custodian;
									BulkOut_tmp.CustodialAccountNumber = row2.CustodialAccountNumber;
									BulkOut_tmp.AdvisorName = row2.AdvisorName;
									BulkOut_tmp.AdvisorExternalId = row2.AdvisorExternalId;
									BulkOut_tmp.SleeveType = row2.SleeveType;
									BulkOut_tmp.SleeveTarget = row2.SleeveTarget;
									BulkOut_tmp.SleeveContributionPercent = row2.SleeveContributionPercent;
									BulkOut_tmp.SleeveDistributionPercent = row2.SleeveDistributionPercent;
									BulkOut_tmp.SleeveToleranceLower = row2.SleeveToleranceLower;
									BulkOut_tmp.SleeveToleranceUpper = row2.SleeveToleranceUpper;
									BulkOut_tmp.SMA = row2.SMA;
									BulkOut_tmp.SMATradeable = row2.SMATradeable;
									BulkOut_tmp.BillingAccount = row2.BillingAccount;
									BulkOut_tmp.SystematicAmount = row2.SystematicAmount;
									BulkOut_tmp.SystematicDate = row2.SystematicDate;
									BulkOut_tmp.HashedSSN = row2.HashedSSN;
									BulkOut_tmp.sleeveContributionMethod = row2.sleeveContributionMethod;
									BulkOut_tmp.sleeveStrategyName = row2.sleeveStrategyName;
									BulkOut_tmp.sleeveDistributionMethod = row2.sleeveDistributionMethod;
									BulkOut_tmp.registrationId = row2.registrationId;
									BulkOut = BulkOut_tmp;
									// ###############################
								...
								if (BulkOut != null) {
									...
									if (BulkOut.OrionFirmId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[0] = String
												.valueOf(BulkOut.OrionFirmId);

									}

									if (BulkOut.ExternalId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[1] = String
												.valueOf(BulkOut.ExternalId);

									}

									if (BulkOut.AccountId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[2] = BulkOut.AccountId;

									}

									if (BulkOut.AccountNumber != null) {

										row_tMysqlOutputBulkExec_1_tMOB[3] = BulkOut.AccountNumber;

									}

									if (BulkOut.AccountName != null) {

										row_tMysqlOutputBulkExec_1_tMOB[4] = BulkOut.AccountName;

									}

									if (BulkOut.PortfolioId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[5] = BulkOut.PortfolioId;

									}

									if (BulkOut.PortfolioName != null) {

										row_tMysqlOutputBulkExec_1_tMOB[6] = BulkOut.PortfolioName;

									}

									if (BulkOut.HouseholdId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[7] = String
												.valueOf(BulkOut.HouseholdId);

									}

									if (BulkOut.HouseholdName != null) {

										row_tMysqlOutputBulkExec_1_tMOB[8] = BulkOut.HouseholdName;

									}

									if (BulkOut.AccountType != null) {

										row_tMysqlOutputBulkExec_1_tMOB[9] = BulkOut.AccountType;

									}

									if (BulkOut.Taxable != null) {

										row_tMysqlOutputBulkExec_1_tMOB[10] = String
												.valueOf(BulkOut.Taxable);

									}

									if (BulkOut.AccountYTDRealizedSTGL != null) {

										row_tMysqlOutputBulkExec_1_tMOB[11] = String
												.valueOf(BulkOut.AccountYTDRealizedSTGL);

									}

									if (BulkOut.AccountYTDRealizedLTGL != null) {

										row_tMysqlOutputBulkExec_1_tMOB[12] = String
												.valueOf(BulkOut.AccountYTDRealizedLTGL);

									}

									if (BulkOut.SSN != null) {

										row_tMysqlOutputBulkExec_1_tMOB[13] = BulkOut.SSN;

									}

									if (BulkOut.SweepSymbol != null) {

										row_tMysqlOutputBulkExec_1_tMOB[14] = BulkOut.SweepSymbol;

									}

									if (BulkOut.Custodian != null) {

										row_tMysqlOutputBulkExec_1_tMOB[15] = BulkOut.Custodian;

									}

									if (BulkOut.CustodialAccountNumber != null) {

										row_tMysqlOutputBulkExec_1_tMOB[16] = BulkOut.CustodialAccountNumber;

									}

									if (BulkOut.AdvisorName != null) {

										row_tMysqlOutputBulkExec_1_tMOB[17] = BulkOut.AdvisorName;

									}

									if (BulkOut.AdvisorExternalId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[18] = String
												.valueOf(BulkOut.AdvisorExternalId);

									}

									if (BulkOut.SleeveType != null) {

										row_tMysqlOutputBulkExec_1_tMOB[19] = BulkOut.SleeveType;

									}

									if (BulkOut.SleeveTarget != null) {

										row_tMysqlOutputBulkExec_1_tMOB[20] = String
												.valueOf(BulkOut.SleeveTarget);

									}

									if (BulkOut.SleeveContributionPercent != null) {

										row_tMysqlOutputBulkExec_1_tMOB[21] = String
												.valueOf(BulkOut.SleeveContributionPercent);

									}

									if (BulkOut.SleeveDistributionPercent != null) {

										row_tMysqlOutputBulkExec_1_tMOB[22] = String
												.valueOf(BulkOut.SleeveDistributionPercent);

									}

									if (BulkOut.SleeveToleranceLower != null) {

										row_tMysqlOutputBulkExec_1_tMOB[23] = String
												.valueOf(BulkOut.SleeveToleranceLower);

									}

									if (BulkOut.SleeveToleranceUpper != null) {

										row_tMysqlOutputBulkExec_1_tMOB[24] = String
												.valueOf(BulkOut.SleeveToleranceUpper);

									}

									if (BulkOut.SMA != null) {

										row_tMysqlOutputBulkExec_1_tMOB[25] = String
												.valueOf(true == BulkOut.SMA ? "1"
														: "0");

									}

									if (BulkOut.SMATradeable != null) {

										row_tMysqlOutputBulkExec_1_tMOB[26] = BulkOut.SMATradeable;

									}

									if (BulkOut.BillingAccount != null) {

										row_tMysqlOutputBulkExec_1_tMOB[27] = BulkOut.BillingAccount;

									}

									if (BulkOut.SystematicAmount != null) {

										row_tMysqlOutputBulkExec_1_tMOB[28] = BulkOut.SystematicAmount;

									}

									if (BulkOut.SystematicDate != null) {

										row_tMysqlOutputBulkExec_1_tMOB[29] = FormatterUtils
												.format_Date(
														BulkOut.SystematicDate,
														"dd-MM-yyyy");

									}

									if (BulkOut.HashedSSN != null) {

										row_tMysqlOutputBulkExec_1_tMOB[30] = BulkOut.HashedSSN;

									}

									if (BulkOut.sleeveContributionMethod != null) {

										row_tMysqlOutputBulkExec_1_tMOB[31] = BulkOut.sleeveContributionMethod;

									}

									if (BulkOut.sleeveStrategyName != null) {

										row_tMysqlOutputBulkExec_1_tMOB[32] = BulkOut.sleeveStrategyName;

									}

									if (BulkOut.sleeveDistributionMethod != null) {

										row_tMysqlOutputBulkExec_1_tMOB[33] = BulkOut.sleeveDistributionMethod;

									}

									if (BulkOut.registrationId != null) {

										row_tMysqlOutputBulkExec_1_tMOB[34] = String
												.valueOf(BulkOut.registrationId);
						...
						if (row3 != null) {
							...
							{ // start of Var scope
								...
								input_rejected_count_tmp.errorCode = row3.errorCode;
								input_rejected_count_tmp.errorMessage = row3.errorMessage;
								input_rejected_count_tmp.firmName = Var.firmname;
								input_rejected_count_tmp.fileName = "AccountFile  "
										+ (context.localpath + context.accountpath);
								input_rejected_count_tmp.component = "tinputfileDelimted";
								input_rejected_count_tmp.process = "Account Local to Staging";
					...
					if (!((Object) (context.localpath + context.accountpath) instanceof java.io.InputStream)) {
				...
				String tableName_tMysqlOutputBulkExec_1_tMBE = "account_"
				...
				while (rsTable_tMysqlOutputBulkExec_1_tMBE.next()) {
					...
					if (table_tMysqlOutputBulkExec_1_tMBE
							.equalsIgnoreCase("account_" + context.firmId + "_"
									+ context.date)) {
				...
				String file_tMysqlOutputBulkExec_1_tMBE = context.pathforlocal
						+ "account_" + context.firmId + "_" + context.date;
				...
				String bulkSQL_tMysqlOutputBulkExec_1_tMBE = "LOAD DATA LOCAL INFILE '"
						...
						+ lines_separator_tMysqlOutputBulkExec_1_tMBE
								.replaceAll("\\\\", "\\\\\\\\")
						+ "' (`OrionFirmId`,`ExternalId`,`AccountId`,`AccountNumber`,`AccountName`,`PortfolioId`,`PortfolioName`,`HouseholdId`,`HouseholdName`,`AccountType`,`Taxable`,`AccountYTDRealizedSTGL`,`AccountYTDRealizedLTGL`,`SSN`,`SweepSymbol`,`Custodian`,`CustodialAccountNumber`,`AdvisorName`,`AdvisorExternalId`,`SleeveType`,`SleeveTarget`,`SleeveContributionPercent`,`SleeveDistributionPercent`,`SleeveToleranceLower`,`SleeveToleranceUpper`,@tMysqlOutputBulkExec_1_tMBE_SMA,`SMATradeable`,`BillingAccount`,`SystematicAmount`,`SystematicDate`,`HashedSSN`,`sleeveContributionMethod`,`sleeveStrategyName`,`sleeveDistributionMethod`,`registrationId`)"
						+ " SET"
						+ " SMA=CAST(@tMysqlOutputBulkExec_1_tMBE_SMA AS UNSIGNED)";
	...
	public static void main(String[] args) {
		final StgAccountImport StgAccountImportClass = new StgAccountImport();

		int exitCode = StgAccountImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = StgAccountImport.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/stgaccountimport_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : StgAccountImport");
		}
...
/************************************************************************************************
 * 266305 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:33:57 PM IST
 ************************************************************************************************/
