...
package reliazedgainloss.taxlot_transaction_staging_to_firm_0_1;
...
/**
 * Job: TaxLot_transaction_staging_to_firm Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class TaxLot_transaction_staging_to_firm implements TalendJob {
	...
	private final String jobName = "TaxLot_transaction_staging_to_firm";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					TaxLot_transaction_staging_to_firm.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TaxLot_transaction_staging_to_firm.this,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.firmtaxlotsimport_0_1.FirmTaxLotsImport childJob_tRunJob_1 = new reliazedgainloss.firmtaxlotsimport_0_1.FirmTaxLotsImport();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				reliazedgainloss.firmtransactionimport_0_1.FirmTransactionImport childJob_tRunJob_2 = new reliazedgainloss.firmtransactionimport_0_1.FirmTransactionImport();
				// pass DataSources
	...
	public static void main(String[] args) {
		final TaxLot_transaction_staging_to_firm TaxLot_transaction_staging_to_firmClass = new TaxLot_transaction_staging_to_firm();

		int exitCode = TaxLot_transaction_staging_to_firmClass
				.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TaxLot_transaction_staging_to_firm.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/taxlot_transaction_staging_to_firm_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : TaxLot_transaction_staging_to_firm");
		}
...
/************************************************************************************************
 * 57442 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:30 PM IST
 ************************************************************************************************/
