...
package reliazedgainloss.firmcustodianimport_0_1;
...
/**
 * Job: FirmCustodianImport Purpose: Firm Custodian Import<br>
 * Description: Firm Custodian Import <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class FirmCustodianImport implements TalendJob {
	...
	private final String jobName = "FirmCustodianImport";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					FirmCustodianImport.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FirmCustodianImport.this, new Object[] {
	...
	public static class row_tAmazonAuroraOutput_2_inStruct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_FirmCustodianImport = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_FirmCustodianImport = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_FirmCustodianImport.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_FirmCustodianImport.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_FirmCustodianImport = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_FirmCustodianImport = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_FirmCustodianImport,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_FirmCustodianImport) {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				for (StatCatcherUtils.StatCatcherMessage scm : tStatCatcher_1
					...
					{ // start of Var scope
						...
						statCatcherOutput_tmp.moment = row2.moment;
						statCatcherOutput_tmp.project = row2.project;
						statCatcherOutput_tmp.job = row2.job;
						statCatcherOutput_tmp.job_version = row2.job_version;
						statCatcherOutput_tmp.context = row2.context;
						statCatcherOutput_tmp.message_type = row2.message_type;
						statCatcherOutput_tmp.message = row2.message;
						statCatcherOutput_tmp.duration = row2.duration;
	...
	public void tJavaRow_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// inputs:(row1) outputs:()
				// linked node: tMap_1 - inputs:(row3,row1)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_1_in.next()) {
						...
						if (tHash_Lookup_row1 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row1' and it contains more one result from keys :  row1.firm = '"
							// + row1HashKey.firm + "'");
						} // G 071
	...
	public static class row_tAmazonAuroraOutput_5_inStruct implements
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_FirmCustodianImport) {
				...
				try {
					...
					this.MasterAccountNumber = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.MasterAccountNumber, dos);
		...
		public String toString() {
			...
			sb.append(",Name=" + Name);
			sb.append(",Code=" + Code);
			sb.append(",MasterAccountNumber=" + MasterAccountNumber);
			sb.append("]");
	...
	public void tAmazonAuroraInput_3_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				errorRejectStruct row_tAmazonAuroraOutput_4_in = errorReject;
				custodian_firm_outputStruct custodian_firm_output = new custodian_firm_outputStruct();
				custodian_firm_outputStruct row_tAmazonAuroraOutput_1_in = custodian_firm_output;
				...
				String tableName_tAmazonAuroraOutput_4 = "importError_Custodian";
				...
				while (rsTable_tAmazonAuroraOutput_4.next()) {
					...
					if (table_tAmazonAuroraOutput_4
							.equalsIgnoreCase("importError_Custodian")) {
				...
				if (!whetherExist_tAmazonAuroraOutput_4) {
					...
					stmtCreate_tAmazonAuroraOutput_4
							.execute("CREATE TABLE `"
									...
									+ "`(`errorMessage` VARCHAR(2555)  ,`errorStackTrace` VARCHAR(2555)  ,`OrionFirmId` INT(10)  ,`ExternalId` INT(10)  ,`Name` VARCHAR(255)  ,`Code` VARCHAR(50)  ,`MasterAccountNumber` VARCHAR(50)  )");
					stmtCreate_tAmazonAuroraOutput_4.close();
				}

				String insert_tAmazonAuroraOutput_4 = "INSERT INTO `"
						+ "importError_Custodian"
						+ "` (`errorMessage`,`errorStackTrace`,`OrionFirmId`,`ExternalId`,`Name`,`Code`,`MasterAccountNumber`) VALUES (?,?,?,?,?,?,?)";
				...
				String tableName_tAmazonAuroraOutput_1 = "custodian";
				...
				String insert_tAmazonAuroraOutput_1 = "INSERT INTO `"
						+ "custodian"
						+ "` (`orionFirmId`,`externalId`,`orionEclipseFirmId`,`name`,`code`,`isDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`,`masterAccountNumber`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				String tableName_tAmazonAuroraOutput_5 = "noDataFound_Custodian";
				...
				while (rsTable_tAmazonAuroraOutput_5.next()) {
					...
					if (table_tAmazonAuroraOutput_5
							.equalsIgnoreCase("noDataFound_Custodian")) {
				...
				if (!whetherExist_tAmazonAuroraOutput_5) {
					...
					stmtCreate_tAmazonAuroraOutput_5
							.execute("CREATE TABLE `"
									...
									+ "`(`OrionFirmId` INT(10)  ,`ExternalId` INT(10)  ,`Name` VARCHAR(255)  ,`Code` VARCHAR(50)  ,`MasterAccountNumber` VARCHAR(50)  )");
					stmtCreate_tAmazonAuroraOutput_5.close();
				}

				String insert_tAmazonAuroraOutput_5 = "INSERT INTO `"
						+ "noDataFound_Custodian"
						+ "` (`OrionFirmId`,`ExternalId`,`Name`,`Code`,`MasterAccountNumber`) VALUES (?,?,?,?,?)";
				...
				String dbquery_tAmazonAuroraInput_3_in = "select distinct OrionFirmId from custodian_"
				...
				try {
					...
					while (rs_tAmazonAuroraInput_3_in.next()) {
						...
						if (!rejectedInnerJoin_tMap_5) { // G_TM_M_020
							...
							row8HashKey.orionConnectFirmId = row7.OrionFirmId;
						...
						{ // start of Var scope
							...
							// # Output table : 's'
							s_tmp.OrionFirmId = row7.OrionFirmId;
							s_tmp.orionEclipseFirmName = row8.orionEclipseFirmName;
							s = s_tmp;
							// ###############################
						...
						if (s != null) {
							...
							if (mainout != null) {
								...
								if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
									...
									row4HashKey.OrionFirmId = mainout.firm;
								...
								while ((tHash_Lookup_row4 != null && tHash_Lookup_row4
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row6HashKey.orionConnectFirmId = row4.OrionFirmId;
									...
									while ((tHash_Lookup_row6 != null && tHash_Lookup_row6
										...
										try {
											...
											{ // start of Var scope
												...
												if (!rejectedInnerJoin_tMap_2) {
													...
													custodian_firm_output_tmp.orionFirmId = row4.OrionFirmId;
													custodian_firm_output_tmp.externalId = row4.ExternalId;
													custodian_firm_output_tmp.orionEclipseFirmId = row6.orionEclipseFirmId;
													custodian_firm_output_tmp.name = row4.Name;
													custodian_firm_output_tmp.code = row4.Code;
													custodian_firm_output_tmp.isDeleted = false;
													custodian_firm_output_tmp.createdDate = TalendDate
															.getCurrentDate();
													custodian_firm_output_tmp.createdBy = 1;
													custodian_firm_output_tmp.editedDate = TalendDate
															.getCurrentDate();
													custodian_firm_output_tmp.editedBy = 1;
													custodian_firm_output_tmp.masterAccountNumber = row4.MasterAccountNumber;
												...
												// # Filter conditions
												if (rejectedInnerJoin_tMap_2) {
													noDataFound_joinReject_tmp.OrionFirmId = row4.OrionFirmId;
													noDataFound_joinReject_tmp.ExternalId = row4.ExternalId;
													noDataFound_joinReject_tmp.Name = row4.Name;
													noDataFound_joinReject_tmp.Code = row4.Code;
													noDataFound_joinReject_tmp.MasterAccountNumber = row4.MasterAccountNumber;
											...
											// if anohter java.lang.Exception
											// when processing an
											// java.lang.Exception
											...
											try {// EE
												...
												errorReject_tmp.OrionFirmId = row4.OrionFirmId;
												errorReject_tmp.ExternalId = row4.ExternalId;
												errorReject_tmp.Name = row4.Name;
												errorReject_tmp.Code = row4.Code;
												errorReject_tmp.MasterAccountNumber = row4.MasterAccountNumber;
										...
										if (errorReject != null) {
											...
											row_tAmazonAuroraOutput_4_in = errorReject;
											...
											if (row_tAmazonAuroraOutput_4_in.errorMessage == null) {
												...
												pstmt_tAmazonAuroraOutput_4
														.setString(
																1,
																row_tAmazonAuroraOutput_4_in.errorMessage);
											}

											if (row_tAmazonAuroraOutput_4_in.errorStackTrace == null) {
												pstmt_tAmazonAuroraOutput_4
														.setNull(
																2,
																java.sql.Types.VARCHAR);
												...
												pstmt_tAmazonAuroraOutput_4
														.setString(
																2,
																row_tAmazonAuroraOutput_4_in.errorStackTrace);
											}
											...
											if (row_tAmazonAuroraOutput_4_in.MasterAccountNumber == null) {
												pstmt_tAmazonAuroraOutput_4
														.setNull(
																7,
																java.sql.Types.VARCHAR);
												...
												pstmt_tAmazonAuroraOutput_4
														.setString(
																7,
																row_tAmazonAuroraOutput_4_in.MasterAccountNumber);
											}
										...
										if (custodian_firm_output != null) {
											...
											row_tAmazonAuroraOutput_1_in = custodian_firm_output;
											...
											if (row_tAmazonAuroraOutput_1_in.masterAccountNumber == null) {
												pstmt_tAmazonAuroraOutput_1
														.setNull(
																11,
																java.sql.Types.VARCHAR);
												...
												pstmt_tAmazonAuroraOutput_1
														.setString(
																11,
																row_tAmazonAuroraOutput_1_in.masterAccountNumber);
											}
										...
										if (noDataFound_joinReject != null) {
											...
											if (row_tAmazonAuroraOutput_5_in.MasterAccountNumber == null) {
												pstmt_tAmazonAuroraOutput_5
														.setNull(
																5,
																java.sql.Types.VARCHAR);
												...
												pstmt_tAmazonAuroraOutput_5
														.setString(
																5,
																row_tAmazonAuroraOutput_5_in.MasterAccountNumber);
											}
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_4_inStruct row8 = row_tAmazonAuroraInput_4_in;
				...
				// inputs:(row_tAmazonAuroraInput_4_in) outputs:(row8,row8) |
				// target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
				// linked node: tMap_5 - inputs:(row7,row8) outputs:(s)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_4_in.next()) {
						...
						row8 = row_tAmazonAuroraInput_4_in;
						...
						row8_HashRow.orionEclipseFirmName = row8.orionEclipseFirmName;
	...
	public void tAmazonAuroraInput_2_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_2_inStruct row6 = row_tAmazonAuroraInput_2_in;
				...
				// inputs:(row_tAmazonAuroraInput_2_in) outputs:(row6,row6) |
				// target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
				// linked node: tMap_2 - inputs:(mainout,row6,row4)
				// outputs:(errorReject,custodian_firm_output,noDataFound_joinReject)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_2_in.next()) {
						...
						row6 = row_tAmazonAuroraInput_2_in;
						...
						row6_HashRow.orionConnectFirmId = row6.orionConnectFirmId;

						row6_HashRow.orionEclipseFirmId = row6.orionEclipseFirmId;
	...
	public static class row4Struct implements
		...
		public void copyDataTo(row4Struct other) {
			...
			other.MasterAccountNumber = this.MasterAccountNumber;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.MasterAccountNumber = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.MasterAccountNumber, dos, oos);
	...
	public void tAmazonAuroraInput_5_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_5_inStruct row4 = row_tAmazonAuroraInput_5_in;
				...
				// inputs:(row_tAmazonAuroraInput_5_in) outputs:(row4,row4) |
				...
				String dbquery_tAmazonAuroraInput_5_in = "select  * from custodian_"
						+ context.firmId + "_" + context.date;
				...
				try {
					...
					while (rs_tAmazonAuroraInput_5_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_5_in < 4) {
							row_tAmazonAuroraInput_5_in.Code = null;
						} else {

							row_tAmazonAuroraInput_5_in.Code = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 4,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_5_in < 5) {
							row_tAmazonAuroraInput_5_in.MasterAccountNumber = null;
						} else {

							row_tAmazonAuroraInput_5_in.MasterAccountNumber = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_5_in, 5,
											false);
						}
						...
						row4 = row_tAmazonAuroraInput_5_in;
						...
						row4_HashRow.OrionFirmId = row4.OrionFirmId;

						row4_HashRow.ExternalId = row4.ExternalId;

						row4_HashRow.Name = row4.Name;

						row4_HashRow.Code = row4.Code;

						row4_HashRow.MasterAccountNumber = row4.MasterAccountNumber;
	...
	public static void main(String[] args) {
		final FirmCustodianImport FirmCustodianImportClass = new FirmCustodianImport();

		int exitCode = FirmCustodianImportClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FirmCustodianImport.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/firmcustodianimport_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : FirmCustodianImport");
		}
...
/************************************************************************************************
 * 379399 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:08 PM IST
 ************************************************************************************************/
