...
package reliazedgainloss.account_and_portfolio_creation_for_sleeve_0_1;
...
/**
 * Job: Account_AND_Portfolio_creation_for_sleeve Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class Account_AND_Portfolio_creation_for_sleeve implements TalendJob {
	...
	private final String jobName = "Account_AND_Portfolio_creation_for_sleeve";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Account_AND_Portfolio_creation_for_sleeve.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(
									Account_AND_Portfolio_creation_for_sleeve.this,
	...
	public void tAdvancedHash_portfolioId_lookup_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class row19Struct implements
		...
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve.length) {
					if (length < 1024
							&& commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve.length == 0) {
						commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[1024];
					} else {
						commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve,
						0, length);
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve) {
	...
	public void tJavaRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_2 - inputs:(s,row19) outputs:(out1,mainout)
	...
	public void tJavaRow_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// source node:tJavaRow_4 - inputs:(after_tAmazonAuroraInput_4)
				// outputs:(row22,row22) | target node:tAdvancedHash_row22 -
				// inputs:(row22) outputs:()
				// linked node: tMap_6 - inputs:(copyOfs,row22)
	...
	public static class row_tAmazonAuroraOutput_3_inStruct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.registrationId == null) ? 0
								: this.registrationId.hashCode());
		...
		public int compareTo(row_tAmazonAuroraOutput_3_inStruct other) {
			...
			returnValue = checkNullsAndCompare(this.registrationId,
	...
	public void tAmazonAuroraInput_1_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_1_inStruct row17 = row_tAmazonAuroraInput_1_in;
				...
				row1_ErrorRejectStruct row_tAmazonAuroraOutput_1_in = row1_ErrorReject;
				...
				portfolio_outputStruct row_tAmazonAuroraOutput_3_in = portfolio_output;
				noDataFound_joinReject3Struct noDataFound_joinReject3 = new noDataFound_joinReject3Struct();
				noDataFound_joinReject3Struct row_tAmazonAuroraOutput_2_in = noDataFound_joinReject3;
				...
				String tableName_tAmazonAuroraOutput_1 = "importError_Portfolio";
				...
				if (!whetherExist_tAmazonAuroraOutput_1) {
					...
					stmtCreate_tAmazonAuroraOutput_1
							.execute("CREATE TABLE `"
									...
									+ "`(`OrionFirmId` INT(10)  ,`ExternalId` INT(10)  ,`PortfolioName` VARCHAR(50)  ,`sleeveContributionMethod` VARCHAR(255)  ,`sleeveStrategyName` VARCHAR(255)  ,`sleeveDistributionMethod` VARCHAR(255)  ,`registrationId` INT(0)  ,`errorMessage` VARCHAR(0)  ,`errorStackTrace` VARCHAR(0)  )");
					stmtCreate_tAmazonAuroraOutput_1.close();
				}

				String insert_tAmazonAuroraOutput_1 = "INSERT INTO `"
						+ "importError_Portfolio"
						+ "` (`OrionFirmId`,`ExternalId`,`PortfolioName`,`sleeveContributionMethod`,`sleeveStrategyName`,`sleeveDistributionMethod`,`registrationId`,`errorMessage`,`errorStackTrace`) VALUES (?,?,?,?,?,?,?,?,?)";
				int batchSize_tAmazonAuroraOutput_1 = 1000;
				...
				class Comparablesort_portfoliosStruct extends
					...
					public int compareTo(Comparablesort_portfoliosStruct other) {
						...
						String thisSOrionFirmId = this.OrionFirmId == null ? "null"
								: String.valueOf(this.OrionFirmId);
						String otherSOrionFirmId = other.OrionFirmId == null ? "null"
								: String.valueOf(other.OrionFirmId);
						if (!thisSOrionFirmId.equals(otherSOrionFirmId)) {
							return thisSOrionFirmId
									.compareTo(otherSOrionFirmId);
				...
				String tableName_tAmazonAuroraOutput_2 = "noDataFound_Portfolio";
				...
				if (!whetherExist_tAmazonAuroraOutput_2) {
					...
					stmtCreate_tAmazonAuroraOutput_2
							.execute("CREATE TABLE `"
									...
									+ "`(`OrionFirmId` INT(10)  ,`ExternalId` INT(10)  ,`PortfolioName` VARCHAR(50)  ,`sleeveContributionMethod` VARCHAR(255)  ,`sleeveStrategyName` VARCHAR(255)  ,`sleeveDistributionMethod` VARCHAR(255)  ,`registrationId` INT(0)  )");
					stmtCreate_tAmazonAuroraOutput_2.close();
				}

				String insert_tAmazonAuroraOutput_2 = "INSERT INTO `"
						+ "noDataFound_Portfolio"
						+ "` (`OrionFirmId`,`ExternalId`,`PortfolioName`,`sleeveContributionMethod`,`sleeveStrategyName`,`sleeveDistributionMethod`,`registrationId`) VALUES (?,?,?,?,?,?,?)";
				...
				String dbquery_tAmazonAuroraInput_1_in = "select distinct OrionFirmId from account_"
						+ context.firmId
						+ "_"
						+ context.date
				...
				try {
					...
					while (rs_tAmazonAuroraInput_1_in.next()) {
						...
						row17 = row_tAmazonAuroraInput_1_in;
							...
							if (mainout != null) {
								...
								while ((tHash_Lookup_row7 != null && tHash_Lookup_row7
									...
									if (row1_ErrorReject != null) {
										...
										row_tAmazonAuroraOutput_1_in = row1_ErrorReject;
										...
										if (row_tAmazonAuroraOutput_1_in.PortfolioName == null) {
											pstmt_tAmazonAuroraOutput_1
													.setNull(
															3,
											...
											pstmt_tAmazonAuroraOutput_1
													.setString(
															3,
															row_tAmazonAuroraOutput_1_in.PortfolioName);
										}
									...
									if (noDataFound_joinReject3 != null) {
										...
										row_tAmazonAuroraOutput_2_in = noDataFound_joinReject3;
										...
										/**
										 * [tAmazonAuroraOutput_2_out main ]
										 * start
										 */
										...
										if (row_tAmazonAuroraOutput_2_in.PortfolioName == null) {
											pstmt_tAmazonAuroraOutput_2
													.setNull(
															3,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_2
													.setString(
															3,
															row_tAmazonAuroraOutput_2_in.PortfolioName);
										}
				...
				String tableName_tAmazonAuroraOutput_3 = "portfolio";
				...
				String insertIgnore_tAmazonAuroraOutput_3 = "INSERT IGNORE INTO `"
						+ "portfolio"
						+ "` (`id`,`name`,`modelId`,`tags`,`isDisabled`,`disabledReason`,`isSleevePortfolio`,`sleeveContributionMethod`,`sleeveStrategyName`,`sleeveDistributionMethod`,`registrationId`,`IsDeleted`,`createdDate`,`createdBy`,`editedDate`,`editedBy`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `id` = ?,`name` = ?,`modelId` = ?,`tags` = ?,`isDisabled` = ?,`disabledReason` = ?,`isSleevePortfolio` = ?,`sleeveContributionMethod` = ?,`sleeveStrategyName` = ?,`sleeveDistributionMethod` = ?,`IsDeleted` = ?,`createdDate` = ?,`createdBy` = ?,`editedDate` = ?,`editedBy` = ?";
				java.sql.PreparedStatement pstmt_tAmazonAuroraOutput_3 = conn_tAmazonAuroraOutput_3
						.prepareStatement(insertIgnore_tAmazonAuroraOutput_3);
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					row8 = null;
					finder_tUniqRow_1.registrationId = unique_portfolios.registrationId;
					finder_tUniqRow_1.hashCodeDirty = true;
					if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
						KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

						new_tUniqRow_1.registrationId = unique_portfolios.registrationId;
					...
					if (row8 != null) {
						...
						if (portfolio_output != null) {
							...
							row_tAmazonAuroraOutput_3_in = portfolio_output;
							...
							pstmt_tAmazonAuroraOutput_3.setInt(1,
							...
							if (row_tAmazonAuroraOutput_3_in.modelId == null) {
								...
								pstmt_tAmazonAuroraOutput_3.setInt(3,
										row_tAmazonAuroraOutput_3_in.modelId);
							}

							if (row_tAmazonAuroraOutput_3_in.tags == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3.setString(4,
										row_tAmazonAuroraOutput_3_in.tags);
							}

							pstmt_tAmazonAuroraOutput_3.setBoolean(5,
							...
							pstmt_tAmazonAuroraOutput_3
									.setBoolean(
											7,
											row_tAmazonAuroraOutput_3_in.isSleevePortfolio);

							if (row_tAmazonAuroraOutput_3_in.sleeveContributionMethod == null) {
								...
								pstmt_tAmazonAuroraOutput_3
										.setString(
												8,
												row_tAmazonAuroraOutput_3_in.sleeveContributionMethod);
							}

							if (row_tAmazonAuroraOutput_3_in.sleeveStrategyName == null) {
								...
								pstmt_tAmazonAuroraOutput_3
										.setString(
												9,
												row_tAmazonAuroraOutput_3_in.sleeveStrategyName);
							}

							if (row_tAmazonAuroraOutput_3_in.sleeveDistributionMethod == null) {
								...
								pstmt_tAmazonAuroraOutput_3
										.setString(
												10,
												row_tAmazonAuroraOutput_3_in.sleeveDistributionMethod);
							}

							if (row_tAmazonAuroraOutput_3_in.registrationId == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(11,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tAmazonAuroraOutput_3
										.setInt(11,
												row_tAmazonAuroraOutput_3_in.registrationId);
							}

							pstmt_tAmazonAuroraOutput_3.setBoolean(12,
							...
							if (row_tAmazonAuroraOutput_3_in.createdDate != null) {
								...
								if (date_tAmazonAuroraOutput_3 < year1_tAmazonAuroraOutput_3
									...
									pstmt_tAmazonAuroraOutput_3.setString(13,
											"0000-00-00 00:00:00");
								} else {
									pstmt_tAmazonAuroraOutput_3
											.setTimestamp(
								...
								pstmt_tAmazonAuroraOutput_3.setNull(13,
										java.sql.Types.DATE);
							}

							pstmt_tAmazonAuroraOutput_3.setInt(14,
							...
							if (row_tAmazonAuroraOutput_3_in.editedDate != null) {
								...
								if (date_tAmazonAuroraOutput_3 < year1_tAmazonAuroraOutput_3
										|| date_tAmazonAuroraOutput_3 >= year10000_tAmazonAuroraOutput_3) {
									pstmt_tAmazonAuroraOutput_3.setString(15,
											"0000-00-00 00:00:00");
								} else {
									pstmt_tAmazonAuroraOutput_3
											.setTimestamp(
								...
								pstmt_tAmazonAuroraOutput_3.setNull(15,
										java.sql.Types.DATE);
							}

							pstmt_tAmazonAuroraOutput_3.setInt(16,
									row_tAmazonAuroraOutput_3_in.editedBy);

							pstmt_tAmazonAuroraOutput_3.setInt(17,
									row_tAmazonAuroraOutput_3_in.id);

							if (row_tAmazonAuroraOutput_3_in.name == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(18,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3.setString(18,
										row_tAmazonAuroraOutput_3_in.name);
							}

							if (row_tAmazonAuroraOutput_3_in.modelId == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(19,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tAmazonAuroraOutput_3.setInt(19,
										row_tAmazonAuroraOutput_3_in.modelId);
							}

							if (row_tAmazonAuroraOutput_3_in.tags == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(20,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3.setString(20,
										row_tAmazonAuroraOutput_3_in.tags);
							}

							pstmt_tAmazonAuroraOutput_3.setBoolean(21,
									row_tAmazonAuroraOutput_3_in.isDisabled);

							if (row_tAmazonAuroraOutput_3_in.disabledReason == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(22,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3
										.setString(
							...
							if (row_tAmazonAuroraOutput_3_in.sleeveContributionMethod == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(24,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3
										.setString(
							...
							if (row_tAmazonAuroraOutput_3_in.sleeveStrategyName == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(25,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3
										.setString(
							...
							if (row_tAmazonAuroraOutput_3_in.sleeveDistributionMethod == null) {
								pstmt_tAmazonAuroraOutput_3.setNull(26,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tAmazonAuroraOutput_3
										.setString(
							...
							pstmt_tAmazonAuroraOutput_3.setBoolean(27,
									row_tAmazonAuroraOutput_3_in.IsDeleted);
							...
							if (row_tAmazonAuroraOutput_3_in.createdDate != null) {
								...
								if (date_tAmazonAuroraOutput_3 < year1_tAmazonAuroraOutput_3
										|| date_tAmazonAuroraOutput_3 >= year10000_tAmazonAuroraOutput_3) {
									pstmt_tAmazonAuroraOutput_3.setString(28,
											"0000-00-00 00:00:00");
								} else {
									pstmt_tAmazonAuroraOutput_3
											.setTimestamp(
								...
								pstmt_tAmazonAuroraOutput_3.setNull(28,
										java.sql.Types.DATE);
							}

							pstmt_tAmazonAuroraOutput_3.setInt(29,
									row_tAmazonAuroraOutput_3_in.createdBy);
							...
							if (row_tAmazonAuroraOutput_3_in.editedDate != null) {
								...
								if (date_tAmazonAuroraOutput_3 < year1_tAmazonAuroraOutput_3
										|| date_tAmazonAuroraOutput_3 >= year10000_tAmazonAuroraOutput_3) {
									pstmt_tAmazonAuroraOutput_3.setString(30,
											"0000-00-00 00:00:00");
								} else {
									pstmt_tAmazonAuroraOutput_3
											.setTimestamp(
								...
								pstmt_tAmazonAuroraOutput_3.setNull(30,
										java.sql.Types.DATE);
							}

							pstmt_tAmazonAuroraOutput_3.setInt(31,
									row_tAmazonAuroraOutput_3_in.editedBy);

							int count_on_duplicate_key_tAmazonAuroraOutput_3 = 0;
							try {
								count_on_duplicate_key_tAmazonAuroraOutput_3 = pstmt_tAmazonAuroraOutput_3
										.executeUpdate();
							} catch (java.lang.Exception e) {
								whetherReject_tAmazonAuroraOutput_3 = true;
								System.err.print(e.getMessage());
							}
							if (count_on_duplicate_key_tAmazonAuroraOutput_3 == 1) {
								insertedCount_tAmazonAuroraOutput_3 += count_on_duplicate_key_tAmazonAuroraOutput_3;
							} else {
								insertedCount_tAmazonAuroraOutput_3 += 1;
								updatedCount_tAmazonAuroraOutput_3 += count_on_duplicate_key_tAmazonAuroraOutput_3 - 1;
							}
							if (!whetherReject_tAmazonAuroraOutput_3) {
							}
	...
	public static class row_tAmazonAuroraOutput_5_inStruct implements
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final row_tAmazonAuroraOutput_5_inStruct other = (row_tAmazonAuroraOutput_5_inStruct) obj;
		...
		public void copyDataTo(row_tAmazonAuroraOutput_5_inStruct other) {
		...
		public void copyKeysDataTo(row_tAmazonAuroraOutput_5_inStruct other) {
	...
	public static class new__accountsStruct implements
			routines.system.IPersistableRow<new__accountsStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(new__accountsStruct other) {
	...
	public void tAmazonAuroraInput_4_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_4_inStruct row20 = row_tAmazonAuroraInput_4_in;
				...
				new__accountsStruct new__accounts = new new__accountsStruct();
				new__accountsStruct row_tAmazonAuroraOutput_7_in = new__accounts;
				NoDataFound_joinReject2Struct NoDataFound_joinReject2 = new NoDataFound_joinReject2Struct();
				NoDataFound_joinReject2Struct row_tAmazonAuroraOutput_6_in = NoDataFound_joinReject2;
				row5Struct row5 = new row5Struct();
				update_old_accountsStruct update_old_accounts = new update_old_accountsStruct();
				update_old_accountsStruct row_tAmazonAuroraOutput_5_in = update_old_accounts;
				noDataFount_joinRejectStruct noDataFount_joinReject = new noDataFount_joinRejectStruct();
				noDataFount_joinRejectStruct row_tAmazonAuroraOutput_4_in = noDataFount_joinReject;
				...
				String tableName_tAmazonAuroraOutput_7 = "account";
				...
				if (dbProperties_tAmazonAuroraOutput_7 == null
					...
					url_tAmazonAuroraOutput_7 = "jdbc:mysql://"
							+ context.serverIp + ":" + context.port + "/"
							+ context.database + "?"
							+ "rewriteBatchedStatements=true";
				} else {
				...
				int batchSize_tAmazonAuroraOutput_7 = 1000;
				...
				String tableName_tAmazonAuroraOutput_6 = "noDataFound_Account";
				...
				int batchSize_tAmazonAuroraOutput_6 = 1000;
				...
				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<portfolioId_lookupStruct> tHash_Lookup_portfolioId_lookup = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<portfolioId_lookupStruct>) ((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<portfolioId_lookupStruct>) globalMap
						.get("tHash_Lookup_portfolioId_lookup"));

				portfolioId_lookupStruct portfolioId_lookupHashKey = new portfolioId_lookupStruct();
				portfolioId_lookupStruct portfolioId_lookupDefault = new portfolioId_lookupStruct();
				...
				// ###############################
				// # Outputs initialization
				new__accountsStruct new__accounts_tmp = new new__accountsStruct();
				...
				int updateKeyCount_tAmazonAuroraOutput_5 = 1;
				if (updateKeyCount_tAmazonAuroraOutput_5 < 1) {
				...
				int batchSize_tAmazonAuroraOutput_5 = 10000;
				int batchSizeCounter_tAmazonAuroraOutput_5 = 0;

				int count_tAmazonAuroraOutput_5 = 0;

				String update_tAmazonAuroraOutput_5 = "UPDATE `"
						+ "account"
				...
				java.sql.PreparedStatement pstmt_tAmazonAuroraOutput_5 = conn_tAmazonAuroraOutput_5
						.prepareStatement(update_tAmazonAuroraOutput_5);
				...
				String tableName_tAmazonAuroraOutput_4 = "noDataFound_Account";
				...
				java.sql.DatabaseMetaData dbMetaData_tAmazonAuroraOutput_4 = conn_tAmazonAuroraOutput_4
						.getMetaData();
				java.sql.ResultSet rsTable_tAmazonAuroraOutput_4 = dbMetaData_tAmazonAuroraOutput_4
						.getTables(null, null, null, new String[] { "TABLE" });
				boolean whetherExist_tAmazonAuroraOutput_4 = false;
				while (rsTable_tAmazonAuroraOutput_4.next()) {
					String table_tAmazonAuroraOutput_4 = rsTable_tAmazonAuroraOutput_4
							.getString("TABLE_NAME");
					if (table_tAmazonAuroraOutput_4
							.equalsIgnoreCase("noDataFound_Account")) {
						whetherExist_tAmazonAuroraOutput_4 = true;
						break;
					}
				}
				rsTable_tAmazonAuroraOutput_4.close();
				if (!whetherExist_tAmazonAuroraOutput_4) {
					java.sql.Statement stmtCreate_tAmazonAuroraOutput_4 = conn_tAmazonAuroraOutput_4
							.createStatement();
					stmtCreate_tAmazonAuroraOutput_4
							.execute("CREATE TABLE `"
									+ tableName_tAmazonAuroraOutput_4
					...
					stmtCreate_tAmazonAuroraOutput_4.close();
				}
				...
				int batchSize_tAmazonAuroraOutput_4 = 1000;
				...
				String dbquery_tAmazonAuroraInput_4_in = "select distinct OrionFirmId from account_"
						+ context.firmId
						+ "_"
						+ context.date
						+ " where SleeveType !='None'";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_4_in.next()) {
						...
						row20 = row_tAmazonAuroraInput_4_in;
							...
							if (copyOfmainout != null) {
								...
								while ((tHash_Lookup_row1 != null && tHash_Lookup_row1
									...
									if (account_filter != null) {
										...
										if (row2 != null) {
											...
											{ // start of Var scope
												...
												// # Output table : 'out'
												out_tmp.orionConnectExternalId = row2.ExternalId;
												out_tmp.orionConnectFirmID = row2.OrionFirmId;
												out_tmp.accountId = row2.AccountId;
												out_tmp.accountNumber = row2.AccountNumber;
												out_tmp.name = row2.AccountName;
												out_tmp.portfolioId = row2.PortfolioId;
												out_tmp.accountTypeId = row2.accountTypeId;
												out_tmp.YTDRealizedSTGL = row2.AccountYTDRealizedSTGL;
												out_tmp.YTDRealizedLTGL = row2.AccountYTDRealizedLTGL;
												out_tmp.SSN = row2.SSN;
												out_tmp.sweepSymbol = row2.SweepSymbol;
												out_tmp.custodianId = row2.custodianId;
												out_tmp.custodialAccountNumber = null;
												out_tmp.sleeveType = row2.SleeveType;
												out_tmp.householdName = row2.HouseholdName;
												out_tmp.createdDate = TalendDate
														.getCurrentDate();
												out_tmp.createdBy = 1;
												out_tmp.editedDate = TalendDate
														.getCurrentDate();
												out_tmp.editedBy = 1;
												out_tmp.isDeleted = null;
												out_tmp.advisorId = row2.advisorId;
												out_tmp.sweepSecurityId = null;
												out_tmp.systematicAmount = row2.SystematicAmount;
												out_tmp.systematicDate = row2.SystematicDate;
												out_tmp.SMA = row2.SMA;
												out_tmp.SMATradeable = row2.SMATradeable;
												out_tmp.BillingAccount = row2.BillingAccount;
												out_tmp.sleeveTarget = row2.SleeveTarget;
												out_tmp.sleeveContributionPercent = row2.SleeveContributionPercent;
												out_tmp.sleeveDistributionPercent = row2.SleeveDistributionPercent;
												out_tmp.sleeveToleranceLower = row2.SleeveToleranceLower;
												out_tmp.sleeveToleranceUpper = row2.SleeveToleranceUpper;
												out_tmp.modelId = null;
												out_tmp.isDisabled = null;
												out_tmp.disabledReason = null;
												out_tmp.inputPortfolioName = row2.PortfolioName;
												out_tmp.HashedSSN = row2.HashedSSN;
												out = out_tmp;
												// ###############################
											...
											if (out != null) {
												...
												boolean forceLoopportfolioId_lookup = false;

												portfolioId_lookupStruct portfolioId_lookupObjectFromLookup = null;

												if (!rejectedInnerJoin_tMap_10) { // G_TM_M_020

													hasCasePrimitiveKeyWithNull_tMap_10 = false;

													portfolioId_lookupHashKey.name = out.inputPortfolioName;

													portfolioId_lookupHashKey.hashCodeDirty = true;

													tHash_Lookup_portfolioId_lookup
															.lookup(portfolioId_lookupHashKey);

												} // G_TM_M_020

												if (tHash_Lookup_portfolioId_lookup != null
														&& tHash_Lookup_portfolioId_lookup
																.getCount(portfolioId_lookupHashKey) > 1) { // G
																											// 071

													// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'portfolioId_lookup' and it contains more one result from keys :  portfolioId_lookup.name = '"
													// +
													// portfolioId_lookupHashKey.name
													// + "'");
												} // G 071

												portfolioId_lookupStruct portfolioId_lookup = null;

												portfolioId_lookupStruct fromLookup_portfolioId_lookup = null;
												portfolioId_lookup = portfolioId_lookupDefault;
												...
												if (tHash_Lookup_portfolioId_lookup != null
													...
													fromLookup_portfolioId_lookup = tHash_Lookup_portfolioId_lookup
															.next();

												} // G 099

												if (fromLookup_portfolioId_lookup != null) {
													portfolioId_lookup = fromLookup_portfolioId_lookup;
												}
												...
												if (!rejectedInnerJoin_tMap_10) { // G_TM_M_020
													...
													row13HashKey.orionConnectFirmId = out.orionConnectFirmID;
												...
												{ // start of Var scope
													...
													// # Output table :
													// 'new__accounts'
													new__accounts_tmp.id = null;
													new__accounts_tmp.orionConnectExternalId = out.orionConnectExternalId;
													new__accounts_tmp.orionConnectFirmID = out.orionConnectFirmID;
													new__accounts_tmp.orionEclipseFirmId = row13.orionEclipseFirmId;
													new__accounts_tmp.accountId = out.accountId;
													new__accounts_tmp.accountNumber = out.accountNumber;
													new__accounts_tmp.name = out.name;
													new__accounts_tmp.portfolioId = portfolioId_lookup.id;
													new__accounts_tmp.householdId = null;
													new__accounts_tmp.YTDRealizedSTGL = out.YTDRealizedSTGL;
													new__accounts_tmp.YTDRealizedLTGL = out.YTDRealizedLTGL;
													new__accounts_tmp.SSN = out.SSN;
													new__accounts_tmp.sweepSymbol = out.sweepSymbol;
													new__accounts_tmp.custodianId = out.custodianId;
													new__accounts_tmp.custodialAccountNumber = out.custodialAccountNumber;
													new__accounts_tmp.sleeveType = out.sleeveType;
													new__accounts_tmp.createdDate = out.createdDate;
													new__accounts_tmp.householdName = out.householdName;
													new__accounts_tmp.accountTypeId = out.accountTypeId;
													new__accounts_tmp.createdBy = out.createdBy;
													new__accounts_tmp.editedDate = out.editedDate;
													new__accounts_tmp.editedBy = out.editedBy;
													new__accounts_tmp.isDeleted = out.isDeleted;
													new__accounts_tmp.advisorId = out.advisorId;
													new__accounts_tmp.sweepSecurityId = out.sweepSecurityId;
													new__accounts_tmp.systematicAmount = out.systematicAmount;
													new__accounts_tmp.systematicDate = out.systematicDate;
													new__accounts_tmp.SMA = out.SMA;
													new__accounts_tmp.SMATradeable = out.SMATradeable;
													new__accounts_tmp.BillingAccount = out.BillingAccount;
													new__accounts_tmp.sleeveTarget = out.sleeveTarget;
													new__accounts_tmp.sleeveContributionPercent = out.sleeveContributionPercent;
													new__accounts_tmp.sleeveDistributionPercent = out.sleeveDistributionPercent;
													new__accounts_tmp.sleeveToleranceLower = out.sleeveToleranceLower;
													new__accounts_tmp.sleeveToleranceUpper = out.sleeveToleranceUpper;
													new__accounts_tmp.modelId = out.modelId;
													new__accounts_tmp.isDisabled = out.isDisabled;
													new__accounts_tmp.disabledReason = out.disabledReason;
													new__accounts_tmp.hashedSsn = out.HashedSSN;
													new__accounts = new__accounts_tmp;
													// ###### START REJECTS
													// #####
													// ###############################
												...
												// Start of branch
												// "new__accounts"
												if (new__accounts != null) {

													/**
													 * [tAmazonAuroraOutput_7_in
													 * main ] start
													 */
													...
													row_tAmazonAuroraOutput_7_in = new__accounts;
													...
													if (row_tAmazonAuroraOutput_7_in.id == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		1,
																		java.sql.Types.INTEGER);
													} else {
														pstmt_tAmazonAuroraOutput_7
																.setInt(1,
																		row_tAmazonAuroraOutput_7_in.id);
													}

													if (row_tAmazonAuroraOutput_7_in.orionConnectExternalId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		2,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(2,
																		row_tAmazonAuroraOutput_7_in.orionConnectExternalId);
													}

													if (row_tAmazonAuroraOutput_7_in.orionConnectFirmID == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		3,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(3,
																		row_tAmazonAuroraOutput_7_in.orionConnectFirmID);
													}

													if (row_tAmazonAuroraOutput_7_in.orionEclipseFirmId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		4,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(4,
																		row_tAmazonAuroraOutput_7_in.orionEclipseFirmId);
													}

													if (row_tAmazonAuroraOutput_7_in.accountId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		5,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		5,
																		row_tAmazonAuroraOutput_7_in.accountId);
													}

													if (row_tAmazonAuroraOutput_7_in.accountNumber == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		6,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		6,
																		row_tAmazonAuroraOutput_7_in.accountNumber);
													}

													if (row_tAmazonAuroraOutput_7_in.name == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		7,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		7,
																		row_tAmazonAuroraOutput_7_in.name);
													}

													if (row_tAmazonAuroraOutput_7_in.portfolioId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		8,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(8,
																		row_tAmazonAuroraOutput_7_in.portfolioId);
													}

													if (row_tAmazonAuroraOutput_7_in.householdId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		9,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(9,
																		row_tAmazonAuroraOutput_7_in.householdId);
													}

													if (row_tAmazonAuroraOutput_7_in.YTDRealizedSTGL == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		10,
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		10,
																		row_tAmazonAuroraOutput_7_in.YTDRealizedSTGL);
													}

													if (row_tAmazonAuroraOutput_7_in.YTDRealizedLTGL == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		11,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		11,
																		row_tAmazonAuroraOutput_7_in.YTDRealizedLTGL);
													}

													if (row_tAmazonAuroraOutput_7_in.SSN == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		12,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		12,
																		row_tAmazonAuroraOutput_7_in.SSN);
													}

													if (row_tAmazonAuroraOutput_7_in.sweepSymbol == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		13,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		13,
																		row_tAmazonAuroraOutput_7_in.sweepSymbol);
													}

													if (row_tAmazonAuroraOutput_7_in.custodianId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		14,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(14,
																		row_tAmazonAuroraOutput_7_in.custodianId);
													}

													if (row_tAmazonAuroraOutput_7_in.custodialAccountNumber == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		15,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		15,
																		row_tAmazonAuroraOutput_7_in.custodialAccountNumber);
													}

													if (row_tAmazonAuroraOutput_7_in.sleeveType == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		16,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		16,
																		row_tAmazonAuroraOutput_7_in.sleeveType);
													}

													if (row_tAmazonAuroraOutput_7_in.createdDate != null) {
														date_tAmazonAuroraOutput_7 = row_tAmazonAuroraOutput_7_in.createdDate
																.getTime();
													...
													if (row_tAmazonAuroraOutput_7_in.householdName == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		18,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		18,
																		row_tAmazonAuroraOutput_7_in.householdName);
													}

													if (row_tAmazonAuroraOutput_7_in.accountTypeId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		19,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(19,
																		row_tAmazonAuroraOutput_7_in.accountTypeId);
													}

													if (row_tAmazonAuroraOutput_7_in.createdBy == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		20,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(20,
																		row_tAmazonAuroraOutput_7_in.createdBy);
													}

													if (row_tAmazonAuroraOutput_7_in.editedDate != null) {
														date_tAmazonAuroraOutput_7 = row_tAmazonAuroraOutput_7_in.editedDate
																.getTime();
														if (date_tAmazonAuroraOutput_7 < year1_tAmazonAuroraOutput_7
																|| date_tAmazonAuroraOutput_7 >= year10000_tAmazonAuroraOutput_7) {
															pstmt_tAmazonAuroraOutput_7
													...
													if (row_tAmazonAuroraOutput_7_in.editedBy == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		22,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(22,
																		row_tAmazonAuroraOutput_7_in.editedBy);
													}

													if (row_tAmazonAuroraOutput_7_in.isDeleted == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		23,
														...
														pstmt_tAmazonAuroraOutput_7
																.setBoolean(
																		23,
																		row_tAmazonAuroraOutput_7_in.isDeleted);
													}

													if (row_tAmazonAuroraOutput_7_in.advisorId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		24,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(24,
																		row_tAmazonAuroraOutput_7_in.advisorId);
													}

													if (row_tAmazonAuroraOutput_7_in.sweepSecurityId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		25,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(25,
																		row_tAmazonAuroraOutput_7_in.sweepSecurityId);
													}

													if (row_tAmazonAuroraOutput_7_in.systematicAmount == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		26,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		26,
																		row_tAmazonAuroraOutput_7_in.systematicAmount);
													}

													if (row_tAmazonAuroraOutput_7_in.systematicDate != null) {
														date_tAmazonAuroraOutput_7 = row_tAmazonAuroraOutput_7_in.systematicDate
																.getTime();
														if (date_tAmazonAuroraOutput_7 < year1_tAmazonAuroraOutput_7
																|| date_tAmazonAuroraOutput_7 >= year10000_tAmazonAuroraOutput_7) {
															pstmt_tAmazonAuroraOutput_7
													...
													if (row_tAmazonAuroraOutput_7_in.SMA == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		28,
																		java.sql.Types.BOOLEAN);
														...
														pstmt_tAmazonAuroraOutput_7
																.setBoolean(
																		28,
																		row_tAmazonAuroraOutput_7_in.SMA);
													}

													if (row_tAmazonAuroraOutput_7_in.SMATradeable == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		29,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		29,
																		row_tAmazonAuroraOutput_7_in.SMATradeable);
													}

													if (row_tAmazonAuroraOutput_7_in.BillingAccount == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		30,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		30,
																		row_tAmazonAuroraOutput_7_in.BillingAccount);
													}

													if (row_tAmazonAuroraOutput_7_in.sleeveTarget == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		31,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		31,
																		row_tAmazonAuroraOutput_7_in.sleeveTarget);
													}

													if (row_tAmazonAuroraOutput_7_in.sleeveContributionPercent == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		32,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		32,
																		row_tAmazonAuroraOutput_7_in.sleeveContributionPercent);
													}

													if (row_tAmazonAuroraOutput_7_in.sleeveDistributionPercent == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		33,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		33,
																		row_tAmazonAuroraOutput_7_in.sleeveDistributionPercent);
													}

													if (row_tAmazonAuroraOutput_7_in.sleeveToleranceLower == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		34,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		34,
																		row_tAmazonAuroraOutput_7_in.sleeveToleranceLower);
													}

													if (row_tAmazonAuroraOutput_7_in.sleeveToleranceUpper == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		35,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_7
																.setFloat(
																		35,
																		row_tAmazonAuroraOutput_7_in.sleeveToleranceUpper);
													}

													if (row_tAmazonAuroraOutput_7_in.modelId == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		36,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_7
																.setInt(36,
																		row_tAmazonAuroraOutput_7_in.modelId);
													}

													if (row_tAmazonAuroraOutput_7_in.isDisabled == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		37,
																		java.sql.Types.BOOLEAN);
														...
														pstmt_tAmazonAuroraOutput_7
																.setBoolean(
																		37,
																		row_tAmazonAuroraOutput_7_in.isDisabled);
													}

													if (row_tAmazonAuroraOutput_7_in.disabledReason == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		38,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		38,
																		row_tAmazonAuroraOutput_7_in.disabledReason);
													}

													if (row_tAmazonAuroraOutput_7_in.hashedSsn == null) {
														pstmt_tAmazonAuroraOutput_7
																.setNull(
																		39,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_7
																.setString(
																		39,
																		row_tAmazonAuroraOutput_7_in.hashedSsn);
													}
												...
												if (NoDataFound_joinReject2 != null) {
													...
													row_tAmazonAuroraOutput_6_in = NoDataFound_joinReject2;
													...
													if (row_tAmazonAuroraOutput_6_in.AccountNumber == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		4,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		4,
																		row_tAmazonAuroraOutput_6_in.AccountNumber);
													}

													if (row_tAmazonAuroraOutput_6_in.AccountName == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		5,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		5,
																		row_tAmazonAuroraOutput_6_in.AccountName);
													}

													if (row_tAmazonAuroraOutput_6_in.PortfolioId == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		6,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		6,
																		row_tAmazonAuroraOutput_6_in.PortfolioId);
													}

													if (row_tAmazonAuroraOutput_6_in.PortfolioName == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		7,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		7,
																		row_tAmazonAuroraOutput_6_in.PortfolioName);
													}

													if (row_tAmazonAuroraOutput_6_in.HouseholdId == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		8,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_6
																.setInt(8,
																		row_tAmazonAuroraOutput_6_in.HouseholdId);
													}

													if (row_tAmazonAuroraOutput_6_in.HouseholdName == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		9,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		9,
																		row_tAmazonAuroraOutput_6_in.HouseholdName);
													}

													if (row_tAmazonAuroraOutput_6_in.AccountType == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		10,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		10,
																		row_tAmazonAuroraOutput_6_in.AccountType);
													}

													if (row_tAmazonAuroraOutput_6_in.Taxable == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		11,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_6
																.setByte(
																		11,
																		row_tAmazonAuroraOutput_6_in.Taxable);
													}

													if (row_tAmazonAuroraOutput_6_in.AccountYTDRealizedSTGL == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		12,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		12,
																		row_tAmazonAuroraOutput_6_in.AccountYTDRealizedSTGL);
													}

													if (row_tAmazonAuroraOutput_6_in.AccountYTDRealizedLTGL == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		13,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		13,
																		row_tAmazonAuroraOutput_6_in.AccountYTDRealizedLTGL);
													}

													if (row_tAmazonAuroraOutput_6_in.SSN == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		14,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		14,
																		row_tAmazonAuroraOutput_6_in.SSN);
													}

													if (row_tAmazonAuroraOutput_6_in.SweepSymbol == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		15,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		15,
																		row_tAmazonAuroraOutput_6_in.SweepSymbol);
													}

													if (row_tAmazonAuroraOutput_6_in.Custodian == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		16,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		16,
																		row_tAmazonAuroraOutput_6_in.Custodian);
													}

													if (row_tAmazonAuroraOutput_6_in.CustodialAccountNumber == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		17,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		17,
																		row_tAmazonAuroraOutput_6_in.CustodialAccountNumber);
													}

													if (row_tAmazonAuroraOutput_6_in.AdvisorName == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		18,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		18,
																		row_tAmazonAuroraOutput_6_in.AdvisorName);
													}

													if (row_tAmazonAuroraOutput_6_in.AdvisorExternalId == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		19,
																		java.sql.Types.INTEGER);
														...
														pstmt_tAmazonAuroraOutput_6
																.setInt(19,
																		row_tAmazonAuroraOutput_6_in.AdvisorExternalId);
													}

													if (row_tAmazonAuroraOutput_6_in.SleeveType == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		20,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		20,
																		row_tAmazonAuroraOutput_6_in.SleeveType);
													}

													if (row_tAmazonAuroraOutput_6_in.SleeveTarget == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		21,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		21,
																		row_tAmazonAuroraOutput_6_in.SleeveTarget);
													}

													if (row_tAmazonAuroraOutput_6_in.SleeveContributionPercent == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		22,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		22,
																		row_tAmazonAuroraOutput_6_in.SleeveContributionPercent);
													}

													if (row_tAmazonAuroraOutput_6_in.SleeveDistributionPercent == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		23,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		23,
																		row_tAmazonAuroraOutput_6_in.SleeveDistributionPercent);
													}

													if (row_tAmazonAuroraOutput_6_in.SleeveToleranceLower == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		24,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		24,
																		row_tAmazonAuroraOutput_6_in.SleeveToleranceLower);
													}

													if (row_tAmazonAuroraOutput_6_in.SleeveToleranceUpper == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		25,
																		java.sql.Types.FLOAT);
														...
														pstmt_tAmazonAuroraOutput_6
																.setFloat(
																		25,
																		row_tAmazonAuroraOutput_6_in.SleeveToleranceUpper);
													}

													if (row_tAmazonAuroraOutput_6_in.SMA == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		26,
																		java.sql.Types.BOOLEAN);
														...
														pstmt_tAmazonAuroraOutput_6
																.setBoolean(
																		26,
																		row_tAmazonAuroraOutput_6_in.SMA);
													}

													if (row_tAmazonAuroraOutput_6_in.SMATradeable == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		27,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		27,
																		row_tAmazonAuroraOutput_6_in.SMATradeable);
													}

													if (row_tAmazonAuroraOutput_6_in.BillingAccount == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		28,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		28,
																		row_tAmazonAuroraOutput_6_in.BillingAccount);
													}

													if (row_tAmazonAuroraOutput_6_in.SystematicAmount == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		29,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		29,
																		row_tAmazonAuroraOutput_6_in.SystematicAmount);
													}

													if (row_tAmazonAuroraOutput_6_in.SystematicDate != null) {
														date_tAmazonAuroraOutput_6 = row_tAmazonAuroraOutput_6_in.SystematicDate
																.getTime();
													...
													if (row_tAmazonAuroraOutput_6_in.hashedSsn == null) {
														pstmt_tAmazonAuroraOutput_6
																.setNull(
																		31,
																		java.sql.Types.VARCHAR);
														...
														pstmt_tAmazonAuroraOutput_6
																.setString(
																		31,
																		row_tAmazonAuroraOutput_6_in.hashedSsn);
													}
										...
										if (row5 != null) {
											...
											{ // start of Var scope
												...
												update_old_accounts_tmp.editedDate = TalendDate
														.getCurrentDate();
											...
											if (update_old_accounts != null) {
												...
												row_tAmazonAuroraOutput_5_in = update_old_accounts;
												...
												if (row_tAmazonAuroraOutput_5_in.orionConnectExternalId == null) {
													pstmt_tAmazonAuroraOutput_5
															.setNull(
																	39 + count_tAmazonAuroraOutput_5,
																	java.sql.Types.INTEGER);
												} else {
													pstmt_tAmazonAuroraOutput_5
															.setInt(39 + count_tAmazonAuroraOutput_5,
												...
												if (batchSize_tAmazonAuroraOutput_5 <= batchSizeCounter_tAmazonAuroraOutput_5) {
													try {
														...
														updatedCount_tAmazonAuroraOutput_5 += countSum_tAmazonAuroraOutput_5;
									...
									if (noDataFount_joinReject != null) {
										...
										row_tAmazonAuroraOutput_4_in = noDataFount_joinReject;
										...
										/**
										 * [tAmazonAuroraOutput_4_out main ]
										 * start
										 */
										...
										if (row_tAmazonAuroraOutput_4_in.OrionFirmId == null) {
											...
											pstmt_tAmazonAuroraOutput_4
													.setInt(1,
															row_tAmazonAuroraOutput_4_in.OrionFirmId);
										}

										if (row_tAmazonAuroraOutput_4_in.ExternalId == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															2,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_4
													.setInt(2,
															row_tAmazonAuroraOutput_4_in.ExternalId);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.AccountName == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															5,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															5,
															row_tAmazonAuroraOutput_4_in.AccountName);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.PortfolioName == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															7,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															7,
															row_tAmazonAuroraOutput_4_in.PortfolioName);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.AccountType == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															10,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															10,
															row_tAmazonAuroraOutput_4_in.AccountType);
										}

										if (row_tAmazonAuroraOutput_4_in.Taxable == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															11,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_4
													.setByte(
															11,
															row_tAmazonAuroraOutput_4_in.Taxable);
										}

										if (row_tAmazonAuroraOutput_4_in.AccountYTDRealizedSTGL == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															12,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_4
													.setFloat(
															12,
															row_tAmazonAuroraOutput_4_in.AccountYTDRealizedSTGL);
										}

										if (row_tAmazonAuroraOutput_4_in.AccountYTDRealizedLTGL == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															13,
															java.sql.Types.FLOAT);
											...
											pstmt_tAmazonAuroraOutput_4
													.setFloat(
															13,
															row_tAmazonAuroraOutput_4_in.AccountYTDRealizedLTGL);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.Custodian == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															16,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															16,
															row_tAmazonAuroraOutput_4_in.Custodian);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.AdvisorName == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															18,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															18,
															row_tAmazonAuroraOutput_4_in.AdvisorName);
										}

										if (row_tAmazonAuroraOutput_4_in.AdvisorExternalId == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															19,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_4
													.setInt(19,
															row_tAmazonAuroraOutput_4_in.AdvisorExternalId);
										}
										...
										if (row_tAmazonAuroraOutput_4_in.sleeveContributionMethod == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															32,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															32,
															row_tAmazonAuroraOutput_4_in.sleeveContributionMethod);
										}

										if (row_tAmazonAuroraOutput_4_in.sleeveStrategyName == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															33,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															33,
															row_tAmazonAuroraOutput_4_in.sleeveStrategyName);
										}

										if (row_tAmazonAuroraOutput_4_in.sleeveDistributionMethod == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															34,
															java.sql.Types.VARCHAR);
											...
											pstmt_tAmazonAuroraOutput_4
													.setString(
															34,
															row_tAmazonAuroraOutput_4_in.sleeveDistributionMethod);
										}

										if (row_tAmazonAuroraOutput_4_in.registrationId == null) {
											pstmt_tAmazonAuroraOutput_4
													.setNull(
															35,
															java.sql.Types.INTEGER);
											...
											pstmt_tAmazonAuroraOutput_4
													.setInt(35,
															row_tAmazonAuroraOutput_4_in.registrationId);
										}
				...
				// # Lookup hashes releasing
				if (tHash_Lookup_portfolioId_lookup != null) {
					tHash_Lookup_portfolioId_lookup.endGet();
				}
				globalMap.remove("tHash_Lookup_portfolioId_lookup");
	...
	public void tAmazonAuroraInput_2_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_2_inStruct row18 = row_tAmazonAuroraInput_2_in;
				...
				// inputs:(row_tAmazonAuroraInput_2_in) outputs:(row18,row18) |
				// target node:tAdvancedHash_row18 - inputs:(row18) outputs:()
				// linked node: tMap_1 - inputs:(row17,row18) outputs:(s)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_2_in.next()) {
						...
						row18 = row_tAmazonAuroraInput_2_in;
	...
	public void tAmazonAuroraInput_3_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_3_inStruct row7 = row_tAmazonAuroraInput_3_in;
				...
				// inputs:(row_tAmazonAuroraInput_3_in) outputs:(row7,row7) |
				// target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
				// linked node: tMap_3 - inputs:(mainout,row7)
				...
				String dbquery_tAmazonAuroraInput_3_in = "select distinct OrionFirmId , externalID ,  portfolioName , SleeveContributionMethod ,\nSleeveStrategyName ,\nSleeveDistributionMethod ,\nRegistrationId  from account_"
						+ context.firmId
						+ "_"
						+ context.date
						+ " where SleeveType !='None'";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_3_in.next()) {
						...
						row7 = row_tAmazonAuroraInput_3_in;
	...
	public void tAmazonAuroraInput_5_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_5_inStruct row21 = row_tAmazonAuroraInput_5_in;
				...
				// inputs:(row_tAmazonAuroraInput_5_in) outputs:(row21,row21) |
				// target node:tAdvancedHash_row21 - inputs:(row21) outputs:()
				// linked node: tMap_5 - inputs:(row20,row21) outputs:(copyOfs)
				...
				try {
					...
					while (rs_tAmazonAuroraInput_5_in.next()) {
						...
						row21 = row_tAmazonAuroraInput_5_in;
	...
	public void tAmazonAuroraInput_6_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_6_inStruct row1 = row_tAmazonAuroraInput_6_in;
				...
				// inputs:(row_tAmazonAuroraInput_6_in) outputs:(row1,row1) |
				// target node:tAdvancedHash_row1 - inputs:(row1) outputs:()
				// linked node: tMap_7 -
				// inputs:(copyOfmainout,row1,custodian_lookup,advisor_lookup,account_lookup,account_type_lookup)
				...
				String dbquery_tAmazonAuroraInput_6_in = "select * from account_"
						+ context.firmId
						+ "_"
						+ context.date
						+ " where SleeveType !='None'";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_6_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 2) {
							row_tAmazonAuroraInput_6_in.ExternalId = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(2) != null) {
								row_tAmazonAuroraInput_6_in.ExternalId = rs_tAmazonAuroraInput_6_in
										.getInt(2);
							} else {
								row_tAmazonAuroraInput_6_in.ExternalId = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 3) {
							row_tAmazonAuroraInput_6_in.AccountId = null;
						} else {

							row_tAmazonAuroraInput_6_in.AccountId = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 3,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 4) {
							row_tAmazonAuroraInput_6_in.AccountNumber = null;
						} else {

							row_tAmazonAuroraInput_6_in.AccountNumber = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 4,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 5) {
							row_tAmazonAuroraInput_6_in.AccountName = null;
						} else {

							row_tAmazonAuroraInput_6_in.AccountName = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 5,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 6) {
							row_tAmazonAuroraInput_6_in.PortfolioId = null;
						} else {

							row_tAmazonAuroraInput_6_in.PortfolioId = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 6,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 7) {
							row_tAmazonAuroraInput_6_in.PortfolioName = null;
						} else {

							row_tAmazonAuroraInput_6_in.PortfolioName = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 7,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 8) {
							row_tAmazonAuroraInput_6_in.HouseholdId = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(8) != null) {
								row_tAmazonAuroraInput_6_in.HouseholdId = rs_tAmazonAuroraInput_6_in
										.getInt(8);
							} else {
								row_tAmazonAuroraInput_6_in.HouseholdId = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 9) {
							row_tAmazonAuroraInput_6_in.HouseholdName = null;
						} else {

							row_tAmazonAuroraInput_6_in.HouseholdName = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 9,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 10) {
							row_tAmazonAuroraInput_6_in.AccountType = null;
						} else {

							row_tAmazonAuroraInput_6_in.AccountType = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 10,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 11) {
							row_tAmazonAuroraInput_6_in.Taxable = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(11) != null) {
								row_tAmazonAuroraInput_6_in.Taxable = rs_tAmazonAuroraInput_6_in
										.getByte(11);
							} else {
								row_tAmazonAuroraInput_6_in.Taxable = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 12) {
							row_tAmazonAuroraInput_6_in.AccountYTDRealizedSTGL = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(12) != null) {
								row_tAmazonAuroraInput_6_in.AccountYTDRealizedSTGL = rs_tAmazonAuroraInput_6_in
										.getFloat(12);
							} else {
								row_tAmazonAuroraInput_6_in.AccountYTDRealizedSTGL = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 13) {
							row_tAmazonAuroraInput_6_in.AccountYTDRealizedLTGL = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(13) != null) {
								row_tAmazonAuroraInput_6_in.AccountYTDRealizedLTGL = rs_tAmazonAuroraInput_6_in
										.getFloat(13);
							} else {
								row_tAmazonAuroraInput_6_in.AccountYTDRealizedLTGL = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 14) {
							row_tAmazonAuroraInput_6_in.SSN = null;
						} else {

							row_tAmazonAuroraInput_6_in.SSN = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 14,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 15) {
							row_tAmazonAuroraInput_6_in.SweepSymbol = null;
						} else {

							row_tAmazonAuroraInput_6_in.SweepSymbol = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 15,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 16) {
							row_tAmazonAuroraInput_6_in.Custodian = null;
						} else {

							row_tAmazonAuroraInput_6_in.Custodian = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 16,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 17) {
							row_tAmazonAuroraInput_6_in.CustodialAccountNumber = null;
						} else {

							row_tAmazonAuroraInput_6_in.CustodialAccountNumber = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 17,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 18) {
							row_tAmazonAuroraInput_6_in.AdvisorName = null;
						} else {

							row_tAmazonAuroraInput_6_in.AdvisorName = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 18,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 19) {
							row_tAmazonAuroraInput_6_in.AdvisorExternalId = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(19) != null) {
								row_tAmazonAuroraInput_6_in.AdvisorExternalId = rs_tAmazonAuroraInput_6_in
										.getInt(19);
							} else {
								row_tAmazonAuroraInput_6_in.AdvisorExternalId = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 20) {
							row_tAmazonAuroraInput_6_in.SleeveType = null;
						} else {

							row_tAmazonAuroraInput_6_in.SleeveType = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 20,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 21) {
							row_tAmazonAuroraInput_6_in.SleeveTarget = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(21) != null) {
								row_tAmazonAuroraInput_6_in.SleeveTarget = rs_tAmazonAuroraInput_6_in
										.getFloat(21);
							} else {
								row_tAmazonAuroraInput_6_in.SleeveTarget = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 22) {
							row_tAmazonAuroraInput_6_in.SleeveContributionPercent = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(22) != null) {
								row_tAmazonAuroraInput_6_in.SleeveContributionPercent = rs_tAmazonAuroraInput_6_in
										.getFloat(22);
							} else {
								row_tAmazonAuroraInput_6_in.SleeveContributionPercent = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 23) {
							row_tAmazonAuroraInput_6_in.SleeveDistributionPercent = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(23) != null) {
								row_tAmazonAuroraInput_6_in.SleeveDistributionPercent = rs_tAmazonAuroraInput_6_in
										.getFloat(23);
							} else {
								row_tAmazonAuroraInput_6_in.SleeveDistributionPercent = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 24) {
							row_tAmazonAuroraInput_6_in.SleeveToleranceLower = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(24) != null) {
								row_tAmazonAuroraInput_6_in.SleeveToleranceLower = rs_tAmazonAuroraInput_6_in
										.getFloat(24);
							} else {
								row_tAmazonAuroraInput_6_in.SleeveToleranceLower = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 25) {
							row_tAmazonAuroraInput_6_in.SleeveToleranceUpper = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(25) != null) {
								row_tAmazonAuroraInput_6_in.SleeveToleranceUpper = rs_tAmazonAuroraInput_6_in
										.getFloat(25);
							} else {
								row_tAmazonAuroraInput_6_in.SleeveToleranceUpper = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 26) {
							row_tAmazonAuroraInput_6_in.SMA = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(26) != null) {
								row_tAmazonAuroraInput_6_in.SMA = rs_tAmazonAuroraInput_6_in
										.getBoolean(26);
							} else {
								row_tAmazonAuroraInput_6_in.SMA = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 27) {
							row_tAmazonAuroraInput_6_in.SMATradeable = null;
						} else {

							row_tAmazonAuroraInput_6_in.SMATradeable = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 27,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 28) {
							row_tAmazonAuroraInput_6_in.BillingAccount = null;
						} else {

							row_tAmazonAuroraInput_6_in.BillingAccount = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 28,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 29) {
							row_tAmazonAuroraInput_6_in.SystematicAmount = null;
						} else {

							row_tAmazonAuroraInput_6_in.SystematicAmount = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 29,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 30) {
							row_tAmazonAuroraInput_6_in.SystematicDate = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getString(30) != null) {
								String dateString_tAmazonAuroraInput_6_in = rs_tAmazonAuroraInput_6_in
										.getString(30);
								if (!("0000-00-00")
										.equals(dateString_tAmazonAuroraInput_6_in)
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tAmazonAuroraInput_6_in)) {
									row_tAmazonAuroraInput_6_in.SystematicDate = rs_tAmazonAuroraInput_6_in
											.getTimestamp(30);
								} else {
									row_tAmazonAuroraInput_6_in.SystematicDate = (java.util.Date) year0_tAmazonAuroraInput_6_in
											.clone();
								}
							} else {
								row_tAmazonAuroraInput_6_in.SystematicDate = null;
						...
						if (colQtyInRs_tAmazonAuroraInput_6_in < 31) {
							row_tAmazonAuroraInput_6_in.HashedSSN = null;
						} else {

							row_tAmazonAuroraInput_6_in.HashedSSN = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 31,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 32) {
							row_tAmazonAuroraInput_6_in.sleeveContributionMethod = null;
						} else {

							row_tAmazonAuroraInput_6_in.sleeveContributionMethod = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 32,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 33) {
							row_tAmazonAuroraInput_6_in.sleeveStrategyName = null;
						} else {

							row_tAmazonAuroraInput_6_in.sleeveStrategyName = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 33,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 34) {
							row_tAmazonAuroraInput_6_in.sleeveDistributionMethod = null;
						} else {

							row_tAmazonAuroraInput_6_in.sleeveDistributionMethod = routines.system.JDBCUtil
									.getString(rs_tAmazonAuroraInput_6_in, 34,
											false);
						}
						if (colQtyInRs_tAmazonAuroraInput_6_in < 35) {
							row_tAmazonAuroraInput_6_in.registrationId = null;
						} else {

							if (rs_tAmazonAuroraInput_6_in.getObject(35) != null) {
								row_tAmazonAuroraInput_6_in.registrationId = rs_tAmazonAuroraInput_6_in
										.getInt(35);
							} else {
								row_tAmazonAuroraInput_6_in.registrationId = null;
							}
						...
						row1 = row_tAmazonAuroraInput_6_in;
	...
	public void tAmazonAuroraInput_7_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_7_inStruct custodian_lookup = row_tAmazonAuroraInput_7_in;
				...
				String dbquery_tAmazonAuroraInput_7_in = "select id , name from custodian";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_7_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_7_in < 2) {
							row_tAmazonAuroraInput_7_in.name = null;
						} else {

							row_tAmazonAuroraInput_7_in.name = routines.system.JDBCUtil
						...
						custodian_lookup = row_tAmazonAuroraInput_7_in;
	...
	public void tAmazonAuroraInput_8_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_8_inStruct advisor_lookup = row_tAmazonAuroraInput_8_in;
				...
				String dbquery_tAmazonAuroraInput_8_in = "select id , name from advisor";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_8_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_8_in < 1) {
							row_tAmazonAuroraInput_8_in.id = null;
						} else {
						...
						advisor_lookup = row_tAmazonAuroraInput_8_in;
	...
	public void tAmazonAuroraInput_9_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_9_inStruct account_lookup = row_tAmazonAuroraInput_9_in;
				...
				// inputs:(row_tAmazonAuroraInput_9_in)
				...
				String dbquery_tAmazonAuroraInput_9_in = "select orionConnectExternalId , accountNumber , portfolioId from account";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_9_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_9_in < 1) {
							row_tAmazonAuroraInput_9_in.orionConnectExternalId = null;
						} else {

							if (rs_tAmazonAuroraInput_9_in.getObject(1) != null) {
								row_tAmazonAuroraInput_9_in.orionConnectExternalId = rs_tAmazonAuroraInput_9_in
										.getInt(1);
							} else {
								row_tAmazonAuroraInput_9_in.orionConnectExternalId = null;
							}
						...
						if (colQtyInRs_tAmazonAuroraInput_9_in < 2) {
							row_tAmazonAuroraInput_9_in.accountNumber = null;
						} else {

							row_tAmazonAuroraInput_9_in.accountNumber = routines.system.JDBCUtil
						...
						if (colQtyInRs_tAmazonAuroraInput_9_in < 3) {
							...
							if (rs_tAmazonAuroraInput_9_in.getObject(3) != null) {
								row_tAmazonAuroraInput_9_in.portfolioId = rs_tAmazonAuroraInput_9_in
										.getInt(3);
							} else {
								row_tAmazonAuroraInput_9_in.portfolioId = null;
							}
						...
						account_lookup = row_tAmazonAuroraInput_9_in;
	...
	public static class row_tAmazonAuroraInput_10_inStruct implements
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final row_tAmazonAuroraInput_10_inStruct other = (row_tAmazonAuroraInput_10_inStruct) obj;
		...
		public void copyDataTo(row_tAmazonAuroraInput_10_inStruct other) {
		...
		public void copyKeysDataTo(row_tAmazonAuroraInput_10_inStruct other) {
	...
	public void tAmazonAuroraInput_10_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_10_inStruct account_type_lookup = row_tAmazonAuroraInput_10_in;
				...
				String dbquery_tAmazonAuroraInput_10_in = "select id , name from accountType";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_10_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_10_in < 1) {
							row_tAmazonAuroraInput_10_in.id = 0;
						} else {

							if (rs_tAmazonAuroraInput_10_in.getObject(1) != null) {
								row_tAmazonAuroraInput_10_in.id = rs_tAmazonAuroraInput_10_in
										.getInt(1);
							} else {
								throw new RuntimeException(
						...
						account_type_lookup = row_tAmazonAuroraInput_10_in;
	...
	public static class portfolioId_lookupStruct
			implements
			routines.system.IPersistableComparableLookupRow<portfolioId_lookupStruct> {
		final static byte[] commonByteArrayLock_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[0];
		static byte[] commonByteArray_RELIAZEDGAINLOSS_Account_AND_Portfolio_creation_for_sleeve = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final portfolioId_lookupStruct other = (portfolioId_lookupStruct) obj;
		...
		public void copyDataTo(portfolioId_lookupStruct other) {
		...
		public void copyKeysDataTo(portfolioId_lookupStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(portfolioId_lookupStruct other) {
	...
	public void tAmazonAuroraInput_11_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_11_inStruct portfolioId_lookup = row_tAmazonAuroraInput_11_in;

				/**
				 * [tAdvancedHash_portfolioId_lookup begin ] start
				 */

				ok_Hash.put("tAdvancedHash_portfolioId_lookup", false);
				start_Hash.put("tAdvancedHash_portfolioId_lookup",
						System.currentTimeMillis());

				currentComponent = "tAdvancedHash_portfolioId_lookup";

				int tos_count_tAdvancedHash_portfolioId_lookup = 0;

				// connection name:portfolioId_lookup
				// source node:tAmazonAuroraInput_11_out -
				// inputs:(row_tAmazonAuroraInput_11_in)
				// outputs:(portfolioId_lookup,portfolioId_lookup) | target
				// node:tAdvancedHash_portfolioId_lookup -
				// inputs:(portfolioId_lookup) outputs:()
				// linked node: tMap_10 - inputs:(out,portfolioId_lookup,row13)
				// outputs:(new__accounts,NoDataFound_joinReject2)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_portfolioId_lookup = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;

				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<portfolioId_lookupStruct> tHash_Lookup_portfolioId_lookup = org.talend.designer.components.lookup.memory.AdvancedMemoryLookup
						.<portfolioId_lookupStruct> getLookup(matchingModeEnum_portfolioId_lookup);

				globalMap.put("tHash_Lookup_portfolioId_lookup",
						tHash_Lookup_portfolioId_lookup);

				/**
				 * [tAdvancedHash_portfolioId_lookup begin ] stop
				 */
				...
				try {
					...
					while (rs_tAmazonAuroraInput_11_in.next()) {
						...
						portfolioId_lookup = row_tAmazonAuroraInput_11_in;
						...
						/**
						 * [tAdvancedHash_portfolioId_lookup main ] start
						 */

						currentComponent = "tAdvancedHash_portfolioId_lookup";

						portfolioId_lookupStruct portfolioId_lookup_HashRow = new portfolioId_lookupStruct();

						portfolioId_lookup_HashRow.id = portfolioId_lookup.id;

						portfolioId_lookup_HashRow.name = portfolioId_lookup.name;

						tHash_Lookup_portfolioId_lookup
								.put(portfolioId_lookup_HashRow);

						tos_count_tAdvancedHash_portfolioId_lookup++;

						/**
						 * [tAdvancedHash_portfolioId_lookup main ] stop
						 */
				...
				/**
				 * [tAdvancedHash_portfolioId_lookup end ] start
				 */

				currentComponent = "tAdvancedHash_portfolioId_lookup";

				tHash_Lookup_portfolioId_lookup.endPut();

				ok_Hash.put("tAdvancedHash_portfolioId_lookup", true);
				end_Hash.put("tAdvancedHash_portfolioId_lookup",
						System.currentTimeMillis());

				/**
				 * [tAdvancedHash_portfolioId_lookup end ] stop
				 */
			...
			try {
				...
				/**
				 * [tAdvancedHash_portfolioId_lookup finally ] start
				 */

				currentComponent = "tAdvancedHash_portfolioId_lookup";

				/**
				 * [tAdvancedHash_portfolioId_lookup finally ] stop
				 */
	...
	public void tAmazonAuroraInput_12_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_12_inStruct row16 = row_tAmazonAuroraInput_12_in;
				...
				// source node:tAmazonAuroraInput_12_out -
				// inputs:(row_tAmazonAuroraInput_12_in) outputs:(row16,row16) |
				// target node:tAdvancedHash_row16 - inputs:(row16) outputs:()
				// linked node: tMap_8 - inputs:(row5,row16)
				...
				String dbquery_tAmazonAuroraInput_12_in = "select orionConnectFirmId , orionEclipseFirmId from firm";
				...
				try {
					...
					while (rs_tAmazonAuroraInput_12_in.next()) {
						...
						if (colQtyInRs_tAmazonAuroraInput_12_in < 1) {
							row_tAmazonAuroraInput_12_in.orionConnectFirmId = null;
						} else {

							if (rs_tAmazonAuroraInput_12_in.getObject(1) != null) {
								row_tAmazonAuroraInput_12_in.orionConnectFirmId = rs_tAmazonAuroraInput_12_in
										.getInt(1);
							} else {
								row_tAmazonAuroraInput_12_in.orionConnectFirmId = null;
							}
						}
						if (colQtyInRs_tAmazonAuroraInput_12_in < 2) {
							row_tAmazonAuroraInput_12_in.orionEclipseFirmId = null;
						} else {

							if (rs_tAmazonAuroraInput_12_in.getObject(2) != null) {
								row_tAmazonAuroraInput_12_in.orionEclipseFirmId = rs_tAmazonAuroraInput_12_in
										.getInt(2);
							} else {
								row_tAmazonAuroraInput_12_in.orionEclipseFirmId = null;
							}
						...
						row16 = row_tAmazonAuroraInput_12_in;
	...
	public void tAmazonAuroraInput_13_inProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				row_tAmazonAuroraInput_13_inStruct row13 = row_tAmazonAuroraInput_13_in;
				...
				// inputs:(row_tAmazonAuroraInput_13_in) outputs:(row13,row13) |
				...
				try {
					...
					while (rs_tAmazonAuroraInput_13_in.next()) {
						...
						row13 = row_tAmazonAuroraInput_13_in;
	...
	public static void main(String[] args) {
		final Account_AND_Portfolio_creation_for_sleeve Account_AND_Portfolio_creation_for_sleeveClass = new Account_AND_Portfolio_creation_for_sleeve();

		int exitCode = Account_AND_Portfolio_creation_for_sleeveClass
				.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Account_AND_Portfolio_creation_for_sleeve.class
					.getClassLoader().getResourceAsStream(
							"reliazedgainloss/account_and_portfolio_creation_for_sleeve_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Account_AND_Portfolio_creation_for_sleeve");
		}
...
/************************************************************************************************
 * 961163 characters generated by Talend Open Studio for Data Integration on the
 * October 24, 2016 5:34:13 PM IST
 ************************************************************************************************/
