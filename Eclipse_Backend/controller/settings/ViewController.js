 ...
 * @apiSuccess {String}     createdBy           Id of user who created the View details into the system.
 * @apiSuccess {Date}       createdOn           View created date into application.
 * @apiSuccess {String}     editedBy            Id of user who edited the View details into the system.
 ...
 *     }
 */
/** @api {get} /settings/views?name={viewName}&type={viewTypeId} Get View by name
 * @apiName GetAllViewByNameAndType
 * @apiVersion 1.0.0
 * @apiGroup Views
 * @apiPermission appuser
 *
 * @apiDescription This API gets View by name and View Type. 
 *
 * @apiHeader {String} JWTToken The JWT auth token.
 *
 * @apiHeaderExample Header-Example:
 ...
 * @apiSuccess (Success 201) {String}     createdBy               Id of user who created the View details into the system.
 * @apiSuccess (Success 201) {Date}       editedOn                View edited date into application.
 * @apiSuccess (Success 201) {String}     editedBy                Id of user who edited the View details into the system.
 * 
 * @apiSuccessExample {json} Success-Response:
 *    HTTP/1.1 201 OK
        {
 ...
 * @apiParam {String}     name                Name of the View.
 * @apiParam {Number}     viewTypeId          View type id.
 * @apiParam {String}     viewType            Name of the View type.
 * @apiParam {Boolean}    isDefault           True/False – Whether View is default View.
 * @apiParam {Boolean}    isPublic            True/False – Whether View is public View.
 * @apiParam {String}     filter              Filter used in View.
 * @apiParam {JSON}       gridColumnDefs      All columns Details needed to display View.
...
/** @api {delete} /settings/views/:id Delete View
 * @apiName DeleteView
 * @apiVersion 1.0.0
 * @apiGroup Views
 * @apiPermission appuser
