...
/**
 * @api {post} /admin/users/profile Add User Profile logo
 * @apiName Add User Profile Logo
 * @apiVersion 1.0.0
 * @apiGroup Users
 * @apiPermission appuser
 *
 * @apiDescription This API adds Profile logo to logged in user. 
 *
 * @apiHeader {String} JWTToken The JWT auth token.
 *
 * @apiHeaderExample Header-Example:
 ...
 *     }
 * 
 * @apiParam {File}     logo          Logo file for logged in user.
 * 
 ...
 * @apiSuccess {String}    imagePath            Path of user profile image.
 ...
 *
 */
app.post('/profile', s3.fileServeMiddleware("USER_LOGO",s3Properties.imageRoot), s3.upload.single('logo'), function (req, res) {
    logger.debug("upload user logo service call started");
    ...
    s3.getUrl(filePath, function (err, status, data) {
        ...
        userService.saveProfile(inputData,function (err, status, result) {
...
/**
 * @api {get} /admin/users/profile Get User Profile
 * @apiName Get User Profile
 * @apiVersion 1.0.0
 * @apiGroup Users
 * @apiPermission appuser
 *
 * @apiDescription This API get Profile of logged in user. 
 *
 * @apiHeader {String} JWTToken The JWT auth token.
 *
 * @apiHeaderExample Header-Example:
...
app.get('/profile',function(req,res){
    ...
    var data = req.data;
    userService.getProfile(data, function (err, status, result) {
        return response(err, status, result, res);
    });
});
