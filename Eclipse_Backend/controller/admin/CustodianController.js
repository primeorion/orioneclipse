 ...
 */
 ...
 app.get('/', function (req, res) {
    ...
    var data = req.data;
    var model = custodianConverter.getRequestToModel(data);
    custodianService.getCustodianList(model, function (err, status, data) {
 ...
 */
 app.get('/:id/accounts', validate({ params: custodianIdSchema }), function (req, res) {
    ...
    var model = custodianConverter.getRequestToModel(data);
    custodianService.getCustodianAccounts(model, function (err, status, data) {
        return response(err, status, data, res);
    });
});
/**
 * @apiIgnore api not in use
 ...
 */
 /*app.post('/', validate({ body: custodianBodySchema }), function (req, res) {
    ...
    var model = custodianConverter.getRequestToModel(req.data);

    custodianService.addCustodian(model, function (err, status, data) {
        return response(err, status, data, res);
    });
});*/
/**
 ...
 */
 app.put('/:id',validate({ params: custodianIdSchema }),validate({ body: custodianPutSchema }), function (req, res) {
    ...
    custodianService.updateCustodian(model, function (err, status, data) {
        return response(err, status, data, res);
    });
});
/**
 ...
 */
 app.delete('/:id', validate({ params: custodianIdSchema }), function (req, res) {
    ...
    custodianService.deleteCustodian(model, function (err, status, data) {
        return response(err, status, data, res);
    });
});
 ...
 */
 app.get('/:id', validate({ params: custodianIdSchema }), function (req, res) {
    ...
    data.id = req.params.id;
    var model = custodianConverter.getRequestToModel(data);
    custodianService.getCustodianDetail(model, function (err, status, data) {
        return response(err, status, data, res);
    });
});
