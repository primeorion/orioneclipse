...
var ModelModel = require("model/model_temp/CompleteModel.js"); 
var ModelEntity = require("entity/model_temp/Model.js");
var ModelDetail = require("entity/model_temp/ModelDetail.js");
var ModelElementEntity = require("entity/model_temp/ModelElement.js");
var ModelNode = require("model/model_temp/Node.js");
...
ModelConverter.prototype.getCompleteModelModelFromModelRequest = function(data){
	...
	model.isSubstitutedForPortfolio = data.isSubstitutedForPortfolio;
...
ModelConverter.prototype.getModelEntityFromModelModel = function(data){
	...
	model.id = data.id;
	model.name = data.name;
	model.statusId = data.status ? data.status : 1;
	model.communityModelId = data.communityModelled;
	model.description = data.description;
...
ModelConverter.prototype.getModelElementEntity = function(data){
	...
	if(data.level == 0) {
		modelElementEntity.relatedType = 'ROOT';
	}
	else if(data.relatedTypeId != undefined && data.relatedTypeId != null && data.relatedTypeId != 0) {
		modelElementEntity.relatedTypeId = data.relatedTypeId;
		modelElementEntity.relatedType = 'SECURITYSET';
	}	
	else {
		modelElementEntity.relatedType = 'ELEMENT';
	}
