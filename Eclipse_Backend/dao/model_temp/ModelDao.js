...
ModelDao.prototype.getCompleteModelById = function (data, cb) {
    ...
    var query = [];
	query.push(" SELECT "); 
	query.push("  m.id, m.name, m.statusId, m.description as description, m.ownerUserId, m.dynamicModel, m.isDeleted ");
	...
	query.push(" ,md.upperModelTolerancePercent AS upperModelTolerancePercent, md.toleranceType AS toleranceType ");
...
ModelDao.prototype.createAndUpdateModelDetail = function (data, cb) {
    ...
    */
    modelQuery.push(" INSERT INTO " + tableNames[1] + " (modelId, modelElementId, leftValue, rightValue, rank, level, isDeleted, targetPercent, toleranceType, lowerModelTolerancePercent ");
    ...
    modelQuery.push(" ,targetPercent=VALUES(targetPercent), toleranceType=VALUES(toleranceType), lowerModelTolerancePercent=VALUES(lowerModelTolerancePercent), upperModelTolerancePercent=VALUES(upperModelTolerancePercent) ");
