...
describe("**** Inherited Preference Test Cases ****", function () {
    describe("**** START ****", function () {
        updatePreferenceData.forEach(function (inheritedInput) {
            ...
            describe("UPDATE PORTFOLIO PREFERENCE TEST CASE # 2", function () {
                util.putInvalidToken(preference + '/updateAll', inheritedInput);
                util.putWithoutToken(preference + '/updateAll', inheritedInput);
            });
            ...
            describe("UPDATE MODEL PREFERENCE TEST CASE # 2", function () {
                util.putInvalidToken(preference + '/updateAll', parentPreferenceData);
                util.putWithoutToken(preference + '/updateAll', parentPreferenceData);
            });
