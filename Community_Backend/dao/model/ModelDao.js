...
ModelDao.prototype.getCompleteModelById = function (data, cb) {
	...
	query.push(" ,me.name AS meName, md.targetPercent AS targetPercent, md.lowerModelTolerancePercent AS lowerModelTolerancePercent ");
...
ModelDao.prototype.createAndUpdateModelDetail = function (data, cb) {
    ...
    */
    ...
    modelQuery.push(" ,upperModelTolerancePercent, lowerModelToleranceAmount, upperModelToleranceAmount, lowerTradeTolerancePercent, upperTradeTolerancePercent) VALUES ?");
