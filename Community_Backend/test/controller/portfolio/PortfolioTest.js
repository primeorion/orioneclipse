...
describe("**** Portfolios Test Cases ****", function () {
    describe("**** START ****", function () {
        ...
        describe("GET LIST OF ALL ACCOUNTS OF PORTFOLIO TEST CASE # 2", function () {
            ...
            portfolioAccounts = portfolios + '/9999999999999999999' + '/accounts';
            util.getNotFound(portfolioAccounts);
        });
        ...
        //                 });
        //             });
        //             describe("ASSIGN PORTFOLIO TO ACCOUNTS TEST CASE # 5 (Bad Request)", function () {
        //                 it("Should Return 400", function (done) {
        //                     this.timeout(timeout);
        //                     chai.request(baseurl)
        //                         .post(portfolios + '/' + portfolioId + '/accounts')
