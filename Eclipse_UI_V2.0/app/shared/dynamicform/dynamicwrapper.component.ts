...
export class DynamicWrapperComponent {
    ...
    @Input() RedemptionFeePrefResultWrapper: ISecurityPreferencesGet; /** TODO: CHANGE IT TO REDEMPTION GET */
    ...
    setFormData(preferenceVM: IPreferenceDataVM) {
        ...
        this.RedemptionFeePrefResultWrapper = preferenceVM.preferenceSecurityData; /** TODO: ADD REDEMPTION FEE GET IN VM ALSO */
