...
export class DynamicControlComponent {
    ...
    @Input() RedemptionFeePrefResult: ISecurityPreferencesGet; /** TODO: CHANGE IT TO REDEMPTIONGET */
        ...
        if (this.dynamicControlData.componentType == "custom") {
            ...
            if (this.dynamicControlData.valueType == "SortedList") {
                if (this.dynamicControlData.inheritedSelectedOptions.length > 0 && this.dynamicControlData.isInherited) {
                    this.dynamicControlData.selectedOptions = [];
                    this.dynamicControlData.selectedOptions = (<any>Object).values(this.dynamicControlData.inheritedSelectedOptions);
                }
                else {
                ...
                this.SecurityPrefResult.securityPreferences = (this.dynamicControlData.isInherited) ? (<any>Object).values(this.SecurityPrefResult.inheritedSecurityPreferences) : null;
                ...
                this.RedemptionFeePrefResult.securityPreferences = (this.dynamicControlData.isInherited) ? (<any>Object).values(this.SecurityPrefResult.inheritedSecurityPreferences) : null;
                this.redemptionfeeComponent.bindSecurityData(this.SecurityPrefResult);
            }
            else if (this.dynamicControlData.componentName == "LocationOptimizationDataGrid") {
                if (Object.keys(this.LocationOptimizations.inheritedSubClasses).length > 0 && this.dynamicControlData.isInherited) {
                    this.LocationOptimizations.subClasses = (<any>Object).values(this.LocationOptimizations.inheritedSubClasses);
                }
                else {
            ...
            if (this.dynamicControlData.componentName == "Dropdown") {
                ...
                if (this.dynamicControlData.inheritedIndicatorValue != null)
                    ...
                    this.dynamicControlData.indicatorValue = this.dynamicControlData.indicatorValue;
