...
export class PreferenceService {
    ...
    getRedemptionFeePreferences(levelName: string,
        ...
        if (recordId != null) {
            return this._httpClient.getData(this._prefsForLevelEndPoint + "/" +
                ...
                .map((response: Response) => <IRedemptionFeePreferencesGet>response.json());
        }
        else {            
            return this._httpClient.getData(this._prefsForLevelEndPoint + "/" +
                levelName + "/" +
    ...
    updatePreference(preference: ILevelPreferenceSave) {
        ...
        /** Update on 17/10/16 As per Api service changes*/
    ...
    updateMassPreferences(preference: ILevelPreferenceSave) {
        ...
        /** Update on 17/10/16 As per Api service changes*/
        return this._httpClient.updateData(this._prefsForLevelEndPoint + "/" +
            "Action" + "/" +
            "massUpdateAll", preference);
    }
