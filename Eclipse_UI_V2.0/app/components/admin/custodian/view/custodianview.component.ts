...
import { IAdminLeftMenu } from '../../../../shared/leftnavigation/admin.leftnav';
import { ITabNav } from '../shared/custodian.tabnav.component';
...
export class CustodianViewComponent extends BaseComponent {
    ...
    onCustodianSelect(params: any) {
        this._router.navigate(['/eclipse/admin/custodian/filter', params.id]);
    }
