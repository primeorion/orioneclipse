...
export class UserListComponent extends BaseComponent {
    ...
    constructor(private _router: Router, private _userService: UserService, private activateRoute: ActivatedRoute) {
        ...
        console.log("User List Permissions", this.permission);
    }
    ...
    private createColumnDefs() {
        this.columnDefs = [
            ...
            <ColDef>{ headerName: "Created On", filter:'text', field: "createdOn", cellRenderer: this.dateRenderer, width: 125, cellClass: 'text-center' },
            <ColDef>{ headerName: "Team", field: "teams", width: 110, cellClass: 'text-center', valueGetter: this.teamNamesValueGetter, filter:'text' },
