...
export class RoleListComponent extends BaseComponent {
    ...
    private createColumnDefs() {
        this.columnDefs = [
            <ColDef>{ headerName: "Role ID", field: "id", width: 75, cellClass: 'text-center', filter: 'number' },
            <ColDef>{ headerName: "Role Name", field: "name", width: 125, filter: 'text' },
            <ColDef>{ headerName: "Role Type", field: "roleType", width: 125, filter: 'text' },
            ...
            <ColDef>{ headerName: "Status", field: "status", width: 110, cellRenderer: this.statusRenderer, cellClass: 'text-center', floatCell: true, filterParams: { cellRenderer: this.statusFilterRenderer }, suppressMenu: true }
        ];
    }
    ...
    private onRowClicked($event) {
        ...
        console.log("Users count: ", this.tabsModel.count);
    }
