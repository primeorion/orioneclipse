...
export class TLHComponent extends BaseComponent {
    ...
    ngOnInit(){
     ...
     private createTlhGrid(){
        ...
        let self = this;
        this.tlhColumnDefs = [
            <ColDef>{headerName: "Priority" , width: 100, headerTooltip: 'Priority', suppressMenu: !self.isDetailEditMode,field: 'priority', filter:'text',
                     cellRenderer:function(params){
                         return self.tlhRankEditor(params , self);
                     }, cellClass: 'text-center'
                    },
            <ColDef>{headerName: "Security Name" , width: 214, headerTooltip: 'Security Name', suppressMenu: !self.isDetailEditMode,field: 'name', filter:'text'},
            <ColDef>{headerName: "Symbol" , width: 150, headerTooltip: 'Symbol', suppressMenu: !self.isDetailEditMode,field: 'symbol', filter:'text'},
            <ColDef>{headerName: "Type" , width: 100, headerTooltip: 'Type', suppressMenu: !self.isDetailEditMode,field: 'securityType', filter:'text'},
