...
const styleUrls: string[] = ['app/shared/colorPicker/color-picker/color-picker.css'];
const templateUrl: string = 'app/shared/colorPicker/color-picker/color-picker.html';
