        ...
        if (Object.keys(sortedLists).length > 0) {
            sortedLists.forEach(element => {
                ...
                if ((Object.keys(element.selectedOptions).length != Object.keys(element.options).length)) {
                    element.selectedOptions = Object.values(element.options);
                }
                else if ((Object.keys(element.selectedOptions).length > 0)) {
                    element.selectedOptions = Object.values(element.selectedOptions);
                }
                else {
                    element.selectedOptions = Object.values(element.options)
                }
                    ...
                    switch (elementpref.componentName.toLowerCase()) {
                        case prefEnums.Dropdown.toLowerCase():
                            if (elementpref.inheritedSelectedOptions.length > 0) {
                                ...
                                elementpref.selectedOptions = [{ id: InheritValue, order: 0 }];
                            }
                            else {
                                elementpref.value = "";
                    ...
                    switch (elementpref.componentName.toLowerCase()) {
                        ...
                        case prefEnums.TaxLotDepletionMethodSortedlist.toLowerCase():
                            if (elementpref.inheritedSelectedOptions.length > 0) {
                                ...
                                elementpref.selectedOptions = Object.values(elementpref.inheritedSelectedOptions);
                            }
                            else {
                                elementpref.selectedOptions = Object.values(elementpref.options);
                            }
                        ...
                        case prefEnums.LocationOptimizationDataGrid.toLowerCase():
                            if (elementpref.isInherited) {
                                ...
                                if (Object.keys(prefrenceVM.preferenceLocationOptimization.inheritedSubClasses).length > 0) {
                                    prefrenceVM.preferenceLocationOptimization.subClasses = Object.values(prefrenceVM.preferenceLocationOptimization.inheritedSubClasses);
                                }
                                else {
                        ...
                        case prefEnums.SecurityDataGrid.toLowerCase():
                            if (elementpref.isInherited) {
                                prefrenceVM.preferenceSecurityData.securityPreferences = Object.values(prefrenceVM.preferenceSecurityData.inheritedSecurityPreferences);
                            }
                            else {
