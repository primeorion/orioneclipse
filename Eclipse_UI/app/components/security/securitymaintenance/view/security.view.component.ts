...
@Component({
    ...
    directives: [AgGridNg2, ColorPickerDirective, FORM_DIRECTIVES, Dialog, Button, AutoComplete]
})
    ...
    private createColumnDefs() {
        ...
        this.columnDefs = [
            ...
            <ColDef>{
                ...
                children: [
                         <ColDef>{headerName: "Name", field: "name", width: 90, cellClass: 'text-center', headerTooltip: 'Name', 
                         },
                         <ColDef>{headerName: "Id", field: "id", width: 90, cellClass: 'text-center', headerTooltip: 'Id',
                         },
                         <ColDef>{headerName: "Type", field: "securityType", width: 90, cellClass: 'text-center', headerTooltip: 'Type',
                         },
                         <ColDef>{headerName: "Symbol", field: "symbol", width: 90, cellClass: 'text-center', headerTooltip: 'Symbol',
                                 editable: true, 
            ...
            <ColDef>{
                ...
                children: [
                          <ColDef>{headerName: "Category", field: "assetCategory", width: 90, cellClass: 'text-center', headerTooltip: 'Category', 
                                   cellRenderer: function(params) {
                                      return self.classificationEditor(params, self);
                                  }
                         },
                         <ColDef>{headerName: "Class", field: "assetClass", width: 90, cellClass: 'text-center', headerTooltip: 'Class',
                                 cellRenderer: function(params) {
                                      return self.classificationEditor(params, self);
                                  }
                          },
                         <ColDef>{headerName: "Sub-Class", field: "assetSubClass", width: 90, cellClass: 'text-center', headerTooltip: 'Sub-Class',
                                 cellRenderer: function(params) {
                                      return self.classificationEditor(params, self);
                                  }
                         },
                         <ColDef>{headerName: "Sub-Class Id", field: "assetSubClassId", width: 90, cellClass: 'text-center', headerTooltip: 'Sub-Class Id',
                                 suppressMenu: true,suppressSorting: true, hide: true
                         },
                         <ColDef>{headerName: "Class Id", field: "assetClassId", width: 90, cellClass: 'text-center', headerTooltip: 'Class Id',
                                 suppressMenu: true,suppressSorting: true, hide: true
                         },
                         <ColDef>{headerName: "Category Id", field: "assetCategoryId", width: 90, cellClass: 'text-center', headerTooltip: 'Category Id',
                                 suppressMenu: true,suppressSorting: true, hide: true
                         }
                ]
           },
           <ColDef>{
                ...
                children: [
                          <ColDef>{headerName: "Status", field: "status", width: 90, cellClass: 'text-center', headerTooltip: 'Status', 
                                   cellRenderer: function(params) {
            ...
            <ColDef>{
                ...
                children: [
                          <ColDef>{headerName: "Price", field: "price", width: 90, cellClass: 'text-center', headerTooltip: 'Price', 
                                   cellRenderer: function(params){
            ...
            <ColDef>{
                ...
                children: [
                         <ColDef>{headerName: "Custodial Cash", field: "custodialCash", width: 90, cellClass: 'text-center', headerTooltip: 'Custodial Cash', 
                                   cellRenderer: function(params) {
            ...
            <ColDef>{
                headerName: "Creation Date",cellStyle:{ text : 'center'}, hide: true, sort: 'desc', field:'createdOn' 
    ...
    public onClick(targetElement) {
        if (targetElement.id != "") {
            ...
            if (targetElement.innerText === "View Details") {
                    this.selectedSecurityId = Number(targetElement.outerHTML.split("<hidden id=")[1].split(">")[0].split(" ")[0].replace(/['"]+/g, '').toString());
                    this.viewSecurityDetail.emit({id : this.selectedSecurityId , isEdit : false});
            }
            
            if (targetElement.innerText === "Edit") {
                    this.selectedSecurityId = Number(targetElement.outerHTML.split("<hidden id=")[1].split(">")[0].split(" ")[0].replace(/['"]+/g, '').toString());
                    this.viewSecurityDetail.emit({id : this.selectedSecurityId , isEdit : true});
            }
        }
