...
@Component({
    ...
    directives: [AgGridNg2, FORM_DIRECTIVES, Dialog, Button, AutoComplete, TLHComponent , EquivalenceComponent, AlternativeComponent]
})
export class SecuritySetDetailComponent extends BaseComponent {
    ...
    private buyPriorityList: string[] = [];
    private sellPriorityList: string[] = [];
    ...
    private securitySetForm: ControlGroup;
    ...
    constructor(private _securityService: SecurityService , private _securitySetService: SecuritySetService,
        ...
        this.createSecuritySetFormControl();
    ...
    private createSecuritySetFormControl(){
        
        this.securitySetForm = this.builder.group({
           name: new Control(this.securitySet.name , CustomValidator.validateString)
   ...
   private handleSelectedSecuritySet(securitySet){
    ...
    changeToleranceType(toleranceType){
        this.securitySet.toleranceType = toleranceType;
    ...
    private saveSecuritySet(){
        this.securitySetSubmitted = true;
        if(this.securitySetForm.valid){
    ...
    createSecurityColumnDef(){
        ...
        this.securityColumnDefs = [
            <ColDef>{headerName: "Security ID" , width: 100, headerTooltip: 'Security ID', suppressMenu: !self.isDetailEditMode,field: 'id',
                     cellRenderer:  'group', 
                     cellRendererParams: {
            ...
            <ColDef>{headerName: "Security Name" , width: 150, headerTooltip: 'Security Name', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'name'},
            <ColDef>{headerName: "Symbol" , width: 100, headerTooltip: 'Symbol', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'symbol'},
            <ColDef>{headerName: "Type" , width: 100, headerTooltip: 'Type', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'securityType'},
            <ColDef>{headerName: "Rank" , width: 150, headerTooltip: 'Rank', suppressMenu: !self.isDetailEditMode,sort: 'asc',
            ...
            <ColDef>{headerName: "T" , width: 50, headerTooltip: 'T', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'taxableSecurity',
                     cellRenderer:function(params){
                         return self.alternativeCellRenderer(params);
                     }
                    },
            <ColDef>{headerName: "TD" , width: 50, headerTooltip: 'TD', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'taxDeferredSecurity',
                     cellRenderer:function(params){
                         return self.alternativeCellRenderer(params);
                     } 
                    },
            <ColDef>{headerName: "TE" , width: 50, headerTooltip: 'TE', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'taxExemptSecurity',
                     cellRenderer:function(params){
                         return self.alternativeCellRenderer(params);
                     }
                    },
            ...
            <ColDef>{headerName: "Allocation %" , width: 150, headerTooltip: 'Allocation %', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'targetPercent',
                     cellRenderer:function(params){
                         return self.percentageEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Lower Tol.(%)" , width: 150, headerTooltip: 'Lower Tol.(%)', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'lowerModelTolerancePercent',
                     cellRenderer:function(params){
                         return self.percentageEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Upper Tol.(%)" , width: 150, headerTooltip: 'Upper Tol.(%)', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'upperModelTolerancePercent',
                     cellRenderer:function(params){
                         return self.percentageEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Lower Tol.($)" , width: 150, headerTooltip: 'Lower Tol.($)', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'lowerModelToleranceAmount',
                     cellRenderer:function(params){
                         return self.toleranceAmtEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Upper Tol.($)" , width: 150, headerTooltip: 'Upper Tol.($)', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'upperModelToleranceAmount',
                     cellRenderer:function(params){
                         return self.toleranceAmtEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Min Trade Amt" , width: 150, headerTooltip: 'Min Trade Amt', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'minTradeAmount',
                     cellRenderer:function(params){
                         return self.numberEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Min Initial Buy $" , width: 150, headerTooltip: 'Min Initial Buy $', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'minInitialBuyDollar',
                     cellRenderer:function(params){
                         return self.numberEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Buy Priority" , width: 150, headerTooltip: 'Buy Priority', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'buyPriority',
                     cellRenderer:function(params){
                         return self.sellBuyPriorityEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "Sell Priority" , width: 150, headerTooltip: 'Sell Priority', suppressMenu: !self.isDetailEditMode,suppressSorting: true,field: 'sellPriority',
                     cellRenderer:function(params){
                         return self.sellBuyPriorityEditor(params , self);
                     }
                    },
            <ColDef>{headerName: "TLH" , width: 50, headerTooltip: 'TLH', suppressMenu: true,suppressSorting: true,
