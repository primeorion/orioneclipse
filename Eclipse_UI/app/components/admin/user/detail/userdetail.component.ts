...
@Component({
    ...
    directives: [AutoComplete, MultiSelect, Calendar, AdminLeftNavComponent, UserTabNavComponent],
...
export class UserDetailComponent extends BaseComponent {
    ...
    onSave() {
        ...
        if (this.errorMsgTeam == true || this.errorMsgStartDate == true || this.errorMsgRole == true || this.errorExpireDate == true) return;
