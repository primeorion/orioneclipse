...
@Component({
    ...
    directives: [AutoComplete, AgGridNg2, Dialog, HoldingTabNavComponent, HoldingFilterComponent],
...
export class HoldingViewComponent extends BaseComponent {
    ...
    holdingsSearch(event) {
        Util.responseToObjects<IHoldingDetails>(this._holdingService.searchHoldings(event.query.toLowerCase()))
            .subscribe(model => {
